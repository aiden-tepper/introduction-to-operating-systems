...
80100046:	e8 56 3d 00 00       	call   80103da1 <acquire>
...
8010007c:	e8 85 3d 00 00       	call   80103e06 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 01 3b 00 00       	call   80103b8d <acquiresleep>
      return b;
...
801000ca:	e8 37 3d 00 00       	call   80103e06 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 b3 3a 00 00       	call   80103b8d <acquiresleep>
      return b;
...
80100105:	e8 5b 3b 00 00       	call   80103c65 <initlock>
...
80100143:	e8 12 3a 00 00       	call   80103b5a <initsleeplock>
...
801001a8:	e8 6a 3a 00 00       	call   80103c17 <holdingsleep>
...
801001e4:	e8 2e 3a 00 00       	call   80103c17 <holdingsleep>
...
801001f4:	e8 e3 39 00 00       	call   80103bdc <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 20 a5 10 80 	movl   $0x8010a520,(%esp)
80100200:	e8 9c 3b 00 00       	call   80103da1 <acquire>
  b->refcnt--;
...
8010024c:	e8 b5 3b 00 00       	call   80103e06 <release>
}
...
8010028a:	e8 12 3b 00 00       	call   80103da1 <acquire>
  while(n > 0){
...
801002bf:	e8 0c 35 00 00       	call   801037d0 <sleep>
801002c4:	83 c4 10             	add    $0x10,%esp
801002c7:	eb d1                	jmp    8010029a <consoleread+0x32>
        release(&cons.lock);
801002c9:	83 ec 0c             	sub    $0xc,%esp
801002cc:	68 20 ef 10 80       	push   $0x8010ef20
801002d1:	e8 30 3b 00 00       	call   80103e06 <release>
        ilock(ip);
...
80100331:	e8 d0 3a 00 00       	call   80103e06 <release>
  ilock(ip);
...
80100373:	e8 8f 02 00 00       	call   80100607 <cprintf>
  cprintf("\n");
80100378:	c7 04 24 67 71 10 80 	movl   $0x80107167,(%esp)
...
8010038f:	e8 ec 38 00 00       	call   80103c80 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100492:	68 45 68 10 80       	push   $0x80106845
...
801004ae:	e8 12 3a 00 00       	call   80103ec5 <memmove>
    pos -= 80;
...
801004cd:	e8 7b 39 00 00       	call   80103e4d <memset>
...
801004fa:	e8 8c 4d 00 00       	call   8010528b <uartputc>
...
80100513:	e8 73 4d 00 00       	call   8010528b <uartputc>
80100518:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010051f:	e8 67 4d 00 00       	call   8010528b <uartputc>
80100524:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052b:	e8 5b 4d 00 00       	call   8010528b <uartputc>
...
80100568:	0f b6 92 70 68 10 80 	movzbl -0x7fef9790(%edx),%edx
...
801005c6:	e8 d6 37 00 00       	call   80103da1 <acquire>
  for(i = 0; i < n; i++)
...
801005ed:	e8 14 38 00 00       	call   80103e06 <release>
  ilock(ip);
...
801006cb:	75 12                	jne    801006df <cprintf+0xd8>
        s = "(null)";
801006cd:	bb 58 68 10 80       	mov    $0x80106858,%ebx
...
80100729:	e8 d8 36 00 00       	call   80103e06 <release>
...
80100744:	e8 58 36 00 00       	call   80103da1 <acquire>
  while((c = getc()) >= 0){
...
801007f2:	e8 56 31 00 00       	call   8010394d <wakeup>
...
8010086f:	e8 92 35 00 00       	call   80103e06 <release>
  if(doprocdump) {
...
80100883:	e8 64 31 00 00       	call   801039ec <procdump>
}
...
80100890:	68 68 68 10 80       	push   $0x80106868
80100895:	68 20 ef 10 80       	push   $0x8010ef20
8010089a:	e8 c6 33 00 00       	call   80103c65 <initlock>
...
8010095a:	68 81 68 10 80       	push   $0x80106881
...
8010096c:	eb dc                	jmp    8010094a <exec+0x7c>
  if((pgdir = setupkvm()) == 0)
8010096e:	e8 40 5c 00 00       	call   801065b3 <setupkvm>
...
80100a02:	e8 52 5a 00 00       	call   80106459 <allocuvm>
...
80100a34:	e8 f3 58 00 00       	call   8010632c <loaduvm>
...
80100a71:	e8 e3 59 00 00       	call   80106459 <allocuvm>
...
80100a9c:	e8 a2 5a 00 00       	call   80106543 <freevm>
...
80100ab4:	e8 7f 5b 00 00       	call   80106638 <clearpteu>
...
80100ae6:	e8 0b 35 00 00       	call   80103ff6 <strlen>
...
80100af8:	e8 f9 34 00 00       	call   80103ff6 <strlen>
...
80100b0a:	e8 77 5c 00 00       	call   80106786 <copyout>
...
80100b6a:	e8 17 5c 00 00       	call   80106786 <copyout>
...
80100ba7:	e8 0d 34 00 00       	call   80103fb9 <safestrcpy>
...
80100bd5:	e8 89 55 00 00       	call   80106163 <switchuvm>
  freevm(oldpgdir);
80100bda:	89 1c 24             	mov    %ebx,(%esp)
80100bdd:	e8 61 59 00 00       	call   80106543 <freevm>
  return 0;
...
80100c09:	68 8d 68 10 80       	push   $0x8010688d
80100c0e:	68 60 ef 10 80       	push   $0x8010ef60
80100c13:	e8 4d 30 00 00       	call   80103c65 <initlock>
}
...
80100c29:	e8 73 31 00 00       	call   80103da1 <acquire>
...
80100c58:	e8 a9 31 00 00       	call   80103e06 <release>
      return f;
...
80100c6f:	e8 92 31 00 00       	call   80103e06 <release>
  return 0;
...
80100c8d:	e8 0f 31 00 00       	call   80103da1 <acquire>
  if(f->ref < 1)
...
80100caa:	e8 57 31 00 00       	call   80103e06 <release>
  return f;
}
...
80100cb9:	68 94 68 10 80       	push   $0x80106894
...
80100cd2:	e8 ca 30 00 00       	call   80103da1 <acquire>
  if(f->ref < 1)
...
80100d23:	e8 de 30 00 00       	call   80103e06 <release>
...
80100e44:	68 a6 68 10 80       	push   $0x801068a6
...
80100f0a:	68 af 68 10 80       	push   $0x801068af
...
80100f31:	68 b5 68 10 80       	push   $0x801068b5
...
80100f81:	e8 3f 2f 00 00       	call   80103ec5 <memmove>
...
80100f91:	e8 2f 2f 00 00       	call   80103ec5 <memmove>
    name[len] = 0;
...
80100fd6:	e8 72 2e 00 00       	call   80103e4d <memset>
  log_write(bp);
...
8010105f:	68 bf 68 10 80       	push   $0x801068bf
...
80101116:	68 d2 68 10 80       	push   $0x801068d2
...
801011ed:	68 e8 68 10 80       	push   $0x801068e8
...
8010120a:	e8 92 2b 00 00       	call   80103da1 <acquire>
...
80101251:	e8 b0 2b 00 00       	call   80103e06 <release>
      return ip;
...
80101287:	e8 7a 2b 00 00       	call   80103e06 <release>
  return ip;
...
8010129c:	68 fb 68 10 80       	push   $0x801068fb
...
801012c5:	e8 fb 2b 00 00       	call   80103ec5 <memmove>
  brelse(bp);
...
801012e1:	68 0b 69 10 80       	push   $0x8010690b
801012e6:	68 60 f9 10 80       	push   $0x8010f960
801012eb:	e8 75 29 00 00       	call   80103c65 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801012fd:	68 12 69 10 80       	push   $0x80106912
...
80101310:	e8 45 28 00 00       	call   80103b5a <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010135a:	68 78 69 10 80       	push   $0x80106978
...
801013cd:	68 18 69 10 80       	push   $0x80106918
...
801013df:	e8 69 2a 00 00       	call   80103e4d <memset>
      dip->type = type;
...
8010146e:	e8 52 2a 00 00       	call   80103ec5 <memmove>
  log_write(bp);
...
8010154e:	e8 4e 28 00 00       	call   80103da1 <acquire>
  ip->ref++;
...
80101563:	e8 9e 28 00 00       	call   80103e06 <release>
}
...
80101588:	e8 00 26 00 00       	call   80103b8d <acquiresleep>
  if(ip->valid == 0){
...
801015a0:	68 2a 69 10 80       	push   $0x8010692a
...
80101602:	e8 be 28 00 00       	call   80103ec5 <memmove>
    brelse(bp);
...
80101627:	68 30 69 10 80       	push   $0x80106930
...
80101644:	e8 ce 25 00 00       	call   80103c17 <holdingsleep>
...
8010165a:	e8 7d 25 00 00       	call   80103bdc <releasesleep>
}
...
8010166c:	68 3f 69 10 80       	push   $0x8010693f
...
80101686:	e8 02 25 00 00       	call   80103b8d <acquiresleep>
...
8010169f:	e8 38 25 00 00       	call   80103bdc <releasesleep>
  acquire(&icache.lock);
801016a4:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801016ab:	e8 f1 26 00 00       	call   80103da1 <acquire>
  ip->ref--;
...
801016c0:	e8 41 27 00 00       	call   80103e06 <release>
}
...
801016d8:	e8 c4 26 00 00       	call   80103da1 <acquire>
    int r = ip->ref;
801016dd:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016e0:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801016e7:	e8 1a 27 00 00       	call   80103e06 <release>
    if(r == 1){
...
80101818:	e8 a8 26 00 00       	call   80103ec5 <memmove>
    brelse(bp);
...
80101915:	e8 ab 25 00 00       	call   80103ec5 <memmove>
    log_write(bp);
...
80101998:	e8 94 25 00 00       	call   80103f31 <strncmp>
}
8010199d:	c9                   	leave  
8010199e:	c3                   	ret    
...
801019bf:	68 47 69 10 80       	push   $0x80106947
801019c4:	e8 7f e9 ff ff       	call   80100348 <panic>
      panic("dirlookup read");
801019c9:	83 ec 0c             	sub    $0xc,%esp
801019cc:	68 59 69 10 80       	push   $0x80106959
...
80101b7e:	68 68 69 10 80       	push   $0x80106968
...
80101bc3:	68 60 6f 10 80       	push   $0x80106f60
...
80101cc5:	68 cb 69 10 80       	push   $0x801069cb
80101cca:	e8 79 e6 ff ff       	call   80100348 <panic>
    panic("incorrect blockno");
80101ccf:	83 ec 0c             	sub    $0xc,%esp
80101cd2:	68 d4 69 10 80       	push   $0x801069d4
...
80101cef:	68 e6 69 10 80       	push   $0x801069e6
80101cf4:	68 00 16 11 80       	push   $0x80111600
80101cf9:	e8 67 1f 00 00       	call   80103c65 <initlock>
...
80101d69:	e8 33 20 00 00       	call   80103da1 <acquire>
...
80101d98:	e8 b0 1b 00 00       	call   8010394d <wakeup>
...
80101db6:	e8 4b 20 00 00       	call   80103e06 <release>
...
80101dcd:	e8 34 20 00 00       	call   80103e06 <release>
    return;
...
80101e05:	e8 0d 1e 00 00       	call   80103c17 <holdingsleep>
...
80101e32:	e8 6a 1f 00 00       	call   80103da1 <acquire>
...
80101e94:	e8 37 19 00 00       	call   801037d0 <sleep>
...
80101eae:	e8 53 1f 00 00       	call   80103e06 <release>
}
...
80101f22:	68 34 6a 10 80       	push   $0x80106a34
...
80101fbe:	e8 8a 1e 00 00       	call   80103e4d <memset>
...
80102011:	e8 f0 1d 00 00       	call   80103e06 <release>
...
80102057:	68 6c 6a 10 80       	push   $0x80106a6c
8010205c:	68 40 16 11 80       	push   $0x80111640
80102061:	e8 ff 1b 00 00       	call   80103c65 <initlock>
  kmem.use_lock = 0;
...
80102131:	0f b6 91 a0 6b 10 80 	movzbl -0x7fef9460(%ecx),%edx
80102138:	0b 15 7c 16 11 80    	or     0x8011167c,%edx
8010213e:	89 15 7c 16 11 80    	mov    %edx,0x8011167c
  shift ^= togglecode[data];
80102144:	0f b6 81 a0 6a 10 80 	movzbl -0x7fef9560(%ecx),%eax
...
80102158:	8b 04 85 80 6a 10 80 	mov    -0x7fef9580(,%eax,4),%eax
...
8010218e:	83 e1 7f             	and    $0x7f,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102191:	0f b6 81 a0 6b 10 80 	movzbl -0x7fef9460(%ecx),%eax
...
80102478:	e8 13 1a 00 00       	call   80103e90 <memcmp>
...
801025d3:	e8 ed 18 00 00       	call   80103ec5 <memmove>
...
801026d2:	e8 ee 17 00 00       	call   80103ec5 <memmove>
...
8010273f:	68 a0 6c 10 80       	push   $0x80106ca0
80102744:	68 a0 16 11 80       	push   $0x801116a0
80102749:	e8 17 15 00 00       	call   80103c65 <initlock>
  readsb(dev, &sb);
...
80102789:	e8 13 16 00 00       	call   80103da1 <acquire>
...
801027a0:	e8 2b 10 00 00       	call   801037d0 <sleep>
...
801027d7:	e8 f4 0f 00 00       	call   801037d0 <sleep>
...
801027ee:	e8 13 16 00 00       	call   80103e06 <release>
}
...
80102804:	e8 98 15 00 00       	call   80103da1 <acquire>
  log.outstanding -= 1;
...
8010283e:	e8 c3 15 00 00       	call   80103e06 <release>
  if(do_commit){
...
801028d9:	e8 c3 14 00 00       	call   80103da1 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
801028eb:	68 b3 6c 10 80       	push   $0x80106cb3
801028f0:	e8 53 da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
801028f5:	83 ec 0c             	sub    $0xc,%esp
801028f8:	68 c9 6c 10 80       	push   $0x80106cc9
...
80102934:	e8 cd 14 00 00       	call   80103e06 <release>
}
...
80102962:	e8 5e 15 00 00       	call   80103ec5 <memmove>
...
801029f3:	68 e4 6c 10 80       	push   $0x80106ce4
801029f8:	e8 0a dc ff ff       	call   80100607 <cprintf>
  idtinit();       // load idt register
801029fd:	e8 27 26 00 00       	call   80105029 <idtinit>
...
80102a1d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a20:	e8 30 37 00 00       	call   80106155 <switchkvm>
  seginit();
80102a25:	e8 b6 34 00 00       	call   80105ee0 <seginit>
  lapicinit();
...
80102a77:	e8 54 28 00 00       	call   801052d0 <uartinit>
  pinit();         // process table
80102a7c:	e8 be 06 00 00       	call   8010313f <pinit>
  tvinit();        // trap vectors
80102a81:	e8 9e 24 00 00       	call   80104f24 <tvinit>
  binit();         // buffer cache
...
80102af7:	68 f8 6c 10 80       	push   $0x80106cf8
80102afc:	53                   	push   %ebx
80102afd:	e8 8e 13 00 00       	call   80103e90 <memcmp>
...
80102bba:	68 fd 6c 10 80       	push   $0x80106cfd
80102bbf:	57                   	push   %edi
80102bc0:	e8 cb 12 00 00       	call   80103e90 <memcmp>
...
80102c50:	68 02 6d 10 80       	push   $0x80106d02
...
80102ceb:	68 1c 6d 10 80       	push   $0x80106d1c
...
80102d72:	68 3b 6d 10 80       	push   $0x80106d3b
80102d77:	50                   	push   %eax
80102d78:	e8 e8 0e 00 00       	call   80103c65 <initlock>
  (*f0)->type = FD_PIPE;
...
80102dfc:	e8 a0 0f 00 00       	call   80103da1 <acquire>
  if(writable){
...
80102e1e:	e8 2a 0b 00 00       	call   8010394d <wakeup>
...
80102e3c:	e8 c5 0f 00 00       	call   80103e06 <release>
...
80102e5d:	e8 eb 0a 00 00       	call   8010394d <wakeup>
...
80102e6b:	e8 96 0f 00 00       	call   80103e06 <release>
    kfree((char*)p);
...
80102e8d:	e8 0f 0f 00 00       	call   80103da1 <acquire>
  for(i = 0; i < n; i++){
...
80102ea8:	e8 a0 0a 00 00       	call   8010394d <wakeup>
  release(&p->lock);
80102ead:	89 1c 24             	mov    %ebx,(%esp)
80102eb0:	e8 51 0f 00 00       	call   80103e06 <release>
  return n;
...
80102f0b:	e8 f6 0e 00 00       	call   80103e06 <release>
        return -1;
...
80102f52:	e8 4a 0e 00 00       	call   80103da1 <acquire>
...
80102f67:	e8 64 08 00 00       	call   801037d0 <sleep>
...
80102f96:	e8 6b 0e 00 00       	call   80103e06 <release>
      return -1;
...
80102fdb:	e8 6d 09 00 00       	call   8010394d <wakeup>
  release(&p->lock);
80102fe0:	89 1c 24             	mov    %ebx,(%esp)
80102fe3:	e8 1e 0e 00 00       	call   80103e06 <release>
  return i;
...
80103032:	e8 6a 0d 00 00       	call   80103da1 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
8010308a:	e8 77 0d 00 00       	call   80103e06 <release>
...
801030a7:	c7 80 b0 0f 00 00 19 	movl   $0x80104f19,0xfb0(%eax)
801030ae:	4f 10 80 
  sp -= sizeof *p->context;
...
801030c1:	e8 87 0d 00 00       	call   80103e4d <memset>
...
801030e2:	e8 1f 0d 00 00       	call   80103e06 <release>
  return 0;
...
80103107:	e8 fa 0c 00 00       	call   80103e06 <release>
  if (first) {
...
80103145:	68 40 6d 10 80       	push   $0x80106d40
8010314a:	68 20 1d 11 80       	push   $0x80111d20
8010314f:	e8 11 0b 00 00       	call   80103c65 <initlock>
}
...
80103191:	68 24 6e 10 80       	push   $0x80106e24
80103196:	e8 ad d1 ff ff       	call   80100348 <panic>
  panic("unknown apicid\n");
8010319b:	83 ec 0c             	sub    $0xc,%esp
8010319e:	68 47 6d 10 80       	push   $0x80106d47
...
801031d4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801031d7:	e8 ea 0a 00 00       	call   80103cc6 <pushcli>
  c = mycpu();
801031dc:	e8 78 ff ff ff       	call   80103159 <mycpu>
  p = c->proc;
801031e1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801031e7:	e8 16 0b 00 00       	call   80103d02 <popcli>
}
...
80103206:	e8 a8 33 00 00       	call   801065b3 <setupkvm>
...
80103224:	e8 9a 30 00 00       	call   801062c3 <inituvm>
  p->sz = PGSIZE;
...
8010323a:	e8 0e 0c 00 00       	call   80103e4d <memset>
...
8010328d:	68 70 6d 10 80       	push   $0x80106d70
80103292:	50                   	push   %eax
80103293:	e8 21 0d 00 00       	call   80103fb9 <safestrcpy>
  p->cwd = namei("/");
80103298:	c7 04 24 79 6d 10 80 	movl   $0x80106d79,(%esp)
...
801032ae:	e8 ee 0a 00 00       	call   80103da1 <acquire>
  p->state = RUNNABLE;
...
801032d2:	e8 2f 0b 00 00       	call   80103e06 <release>
}
...
801032e2:	68 57 6d 10 80       	push   $0x80106d57
...
80103309:	e8 55 2e 00 00       	call   80106163 <switchuvm>
  return 0;
...
80103327:	e8 2d 31 00 00       	call   80106459 <allocuvm>
...
80103344:	e8 7e 30 00 00       	call   801063c7 <deallocuvm>
...
80103381:	e8 de 32 00 00       	call   80106664 <copyuvm>
...
80103433:	e8 81 0b 00 00       	call   80103fb9 <safestrcpy>
  pid = np->pid;
80103438:	8b 77 10             	mov    0x10(%edi),%esi
  acquire(&ptable.lock);
8010343b:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103442:	e8 5a 09 00 00       	call   80103da1 <acquire>
  np->state = RUNNABLE;
...
8010345b:	e8 a6 09 00 00       	call   80103e06 <release>
  return pid;
...
8010348b:	00 00 00 
8010348e:	e9 d7 00 00 00       	jmp    8010356a <scheduler+0xf6>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103493:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103499:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
8010349f:	0f 83 af 00 00 00    	jae    80103554 <scheduler+0xe0>
...
801034bb:	e8 e1 08 00 00       	call   80103da1 <acquire>
      int initial = p->ticks;
...
801034d0:	e8 31 09 00 00       	call   80103e06 <release>
      c->proc = p;
801034d5:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
      switchuvm(p);
801034db:	89 1c 24             	mov    %ebx,(%esp)
801034de:	e8 80 2c 00 00       	call   80106163 <switchuvm>
      p->state = RUNNING;
...
801034fe:	e8 0b 0b 00 00       	call   8010400e <swtch>
      p->inuse = 0;
80103503:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
8010350a:	00 00 00 
      switchkvm();
8010350d:	e8 43 2c 00 00       	call   80106155 <switchkvm>
      acquire(&tickslock);
80103512:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
80103519:	e8 83 08 00 00       	call   80103da1 <acquire>
      int final = p->ticks;
8010351e:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80103524:	89 45 e0             	mov    %eax,-0x20(%ebp)
      release(&tickslock);
80103527:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
8010352e:	e8 d3 08 00 00       	call   80103e06 <release>
      p->ticks += final-initial;
80103533:	8b 45 e0             	mov    -0x20(%ebp),%eax
80103536:	2b 45 e4             	sub    -0x1c(%ebp),%eax
80103539:	01 83 80 00 00 00    	add    %eax,0x80(%ebx)
      c->proc = 0;
8010353f:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103546:	00 00 00 
80103549:	83 c4 10             	add    $0x10,%esp
      high_priority = 1;
8010354c:	89 75 e4             	mov    %esi,-0x1c(%ebp)
8010354f:	e9 3f ff ff ff       	jmp    80103493 <scheduler+0x1f>
    release(&ptable.lock);
80103554:	83 ec 0c             	sub    $0xc,%esp
80103557:	68 20 1d 11 80       	push   $0x80111d20
8010355c:	e8 a5 08 00 00       	call   80103e06 <release>
    if(high_priority == 1)
80103561:	83 c4 10             	add    $0x10,%esp
80103564:	83 7d e4 01          	cmpl   $0x1,-0x1c(%ebp)
80103568:	75 22                	jne    8010358c <scheduler+0x118>
  asm volatile("sti");
8010356a:	fb                   	sti    
    acquire(&ptable.lock);
8010356b:	83 ec 0c             	sub    $0xc,%esp
8010356e:	68 20 1d 11 80       	push   $0x80111d20
80103573:	e8 29 08 00 00       	call   80103da1 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103578:	83 c4 10             	add    $0x10,%esp
    int high_priority = 0;
8010357b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103582:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80103587:	e9 0d ff ff ff       	jmp    80103499 <scheduler+0x25>
    acquire(&ptable.lock);
8010358c:	83 ec 0c             	sub    $0xc,%esp
8010358f:	68 20 1d 11 80       	push   $0x80111d20
80103594:	e8 08 08 00 00       	call   80103da1 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103599:	83 c4 10             	add    $0x10,%esp
8010359c:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801035a1:	eb 06                	jmp    801035a9 <scheduler+0x135>
801035a3:	81 c3 88 00 00 00    	add    $0x88,%ebx
801035a9:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
801035af:	73 6c                	jae    8010361d <scheduler+0x1a9>
      if(p->state != RUNNABLE || p->tickets != 0)
801035b1:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
801035b5:	75 ec                	jne    801035a3 <scheduler+0x12f>
801035b7:	83 7b 7c 00          	cmpl   $0x0,0x7c(%ebx)
801035bb:	75 e6                	jne    801035a3 <scheduler+0x12f>
      c->proc = p;
801035bd:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
      switchuvm(p);
801035c3:	83 ec 0c             	sub    $0xc,%esp
801035c6:	53                   	push   %ebx
801035c7:	e8 97 2b 00 00       	call   80106163 <switchuvm>
      p->state = RUNNING;
801035cc:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      p->inuse = 1;
801035d3:	c7 83 84 00 00 00 01 	movl   $0x1,0x84(%ebx)
801035da:	00 00 00 
      int temp = ticks;
801035dd:	8b 35 60 3f 11 80    	mov    0x80113f60,%esi
      swtch(&(c->scheduler), p->context);
801035e3:	83 c4 08             	add    $0x8,%esp
801035e6:	ff 73 1c             	push   0x1c(%ebx)
801035e9:	8d 47 04             	lea    0x4(%edi),%eax
801035ec:	50                   	push   %eax
801035ed:	e8 1c 0a 00 00       	call   8010400e <swtch>
      p->ticks += ticks - temp;
801035f2:	a1 60 3f 11 80       	mov    0x80113f60,%eax
801035f7:	29 f0                	sub    %esi,%eax
801035f9:	01 83 80 00 00 00    	add    %eax,0x80(%ebx)
      p->inuse = 0;
801035ff:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103606:	00 00 00 
      switchkvm();
80103609:	e8 47 2b 00 00       	call   80106155 <switchkvm>
      c->proc = 0;
8010360e:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103615:	00 00 00 
80103618:	83 c4 10             	add    $0x10,%esp
8010361b:	eb 86                	jmp    801035a3 <scheduler+0x12f>
    release(&ptable.lock);
8010361d:	83 ec 0c             	sub    $0xc,%esp
80103620:	68 20 1d 11 80       	push   $0x80111d20
80103625:	e8 dc 07 00 00       	call   80103e06 <release>
8010362a:	83 c4 10             	add    $0x10,%esp
8010362d:	e9 38 ff ff ff       	jmp    8010356a <scheduler+0xf6>

80103632 <sched>:
{
80103632:	55                   	push   %ebp
80103633:	89 e5                	mov    %esp,%ebp
80103635:	56                   	push   %esi
80103636:	53                   	push   %ebx
  struct proc *p = myproc();
80103637:	e8 94 fb ff ff       	call   801031d0 <myproc>
8010363c:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
8010363e:	83 ec 0c             	sub    $0xc,%esp
80103641:	68 20 1d 11 80       	push   $0x80111d20
80103646:	e8 17 07 00 00       	call   80103d62 <holding>
8010364b:	83 c4 10             	add    $0x10,%esp
8010364e:	85 c0                	test   %eax,%eax
80103650:	74 4f                	je     801036a1 <sched+0x6f>
  if(mycpu()->ncli != 1)
80103652:	e8 02 fb ff ff       	call   80103159 <mycpu>
80103657:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
8010365e:	75 4e                	jne    801036ae <sched+0x7c>
  if(p->state == RUNNING)
80103660:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103664:	74 55                	je     801036bb <sched+0x89>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103666:	9c                   	pushf  
80103667:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103668:	f6 c4 02             	test   $0x2,%ah
8010366b:	75 5b                	jne    801036c8 <sched+0x96>
  intena = mycpu()->intena;
8010366d:	e8 e7 fa ff ff       	call   80103159 <mycpu>
80103672:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103678:	e8 dc fa ff ff       	call   80103159 <mycpu>
8010367d:	83 ec 08             	sub    $0x8,%esp
80103680:	ff 70 04             	push   0x4(%eax)
80103683:	83 c3 1c             	add    $0x1c,%ebx
80103686:	53                   	push   %ebx
80103687:	e8 82 09 00 00       	call   8010400e <swtch>
  mycpu()->intena = intena;
8010368c:	e8 c8 fa ff ff       	call   80103159 <mycpu>
80103691:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
...
801036a4:	68 7b 6d 10 80       	push   $0x80106d7b
801036a9:	e8 9a cc ff ff       	call   80100348 <panic>
    panic("sched locks");
801036ae:	83 ec 0c             	sub    $0xc,%esp
801036b1:	68 8d 6d 10 80       	push   $0x80106d8d
801036b6:	e8 8d cc ff ff       	call   80100348 <panic>
    panic("sched running");
801036bb:	83 ec 0c             	sub    $0xc,%esp
801036be:	68 99 6d 10 80       	push   $0x80106d99
801036c3:	e8 80 cc ff ff       	call   80100348 <panic>
    panic("sched interruptible");
801036c8:	83 ec 0c             	sub    $0xc,%esp
801036cb:	68 a7 6d 10 80       	push   $0x80106da7
801036d0:	e8 73 cc ff ff       	call   80100348 <panic>
...
801036d9:	53                   	push   %ebx
  struct proc *curproc = myproc();
801036da:	e8 f1 fa ff ff       	call   801031d0 <myproc>
  if(curproc == initproc)
801036df:	39 05 54 3f 11 80    	cmp    %eax,0x80113f54
801036e5:	74 09                	je     801036f0 <exit+0x1b>
801036e7:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
801036e9:	bb 00 00 00 00       	mov    $0x0,%ebx
801036ee:	eb 24                	jmp    80103714 <exit+0x3f>
    panic("init exiting");
801036f0:	83 ec 0c             	sub    $0xc,%esp
801036f3:	68 bb 6d 10 80       	push   $0x80106dbb
801036f8:	e8 4b cc ff ff       	call   80100348 <panic>
      fileclose(curproc->ofile[fd]);
801036fd:	83 ec 0c             	sub    $0xc,%esp
80103700:	50                   	push   %eax
80103701:	e8 bd d5 ff ff       	call   80100cc3 <fileclose>
      curproc->ofile[fd] = 0;
80103706:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
8010370d:	00 
8010370e:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103711:	83 c3 01             	add    $0x1,%ebx
80103714:	83 fb 0f             	cmp    $0xf,%ebx
80103717:	7f 0a                	jg     80103723 <exit+0x4e>
    if(curproc->ofile[fd]){
80103719:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
8010371d:	85 c0                	test   %eax,%eax
8010371f:	75 dc                	jne    801036fd <exit+0x28>
80103721:	eb ee                	jmp    80103711 <exit+0x3c>
  begin_op();
80103723:	e8 56 f0 ff ff       	call   8010277e <begin_op>
  iput(curproc->cwd);
80103728:	83 ec 0c             	sub    $0xc,%esp
8010372b:	ff 76 68             	push   0x68(%esi)
8010372e:	e8 43 df ff ff       	call   80101676 <iput>
  end_op();
80103733:	e8 c0 f0 ff ff       	call   801027f8 <end_op>
  curproc->cwd = 0;
80103738:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
8010373f:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103746:	e8 56 06 00 00       	call   80103da1 <acquire>
  wakeup1(curproc->parent);
8010374b:	8b 46 14             	mov    0x14(%esi),%eax
8010374e:	e8 a9 f8 ff ff       	call   80102ffc <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103753:	83 c4 10             	add    $0x10,%esp
80103756:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
8010375b:	eb 06                	jmp    80103763 <exit+0x8e>
8010375d:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103763:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
80103769:	73 1a                	jae    80103785 <exit+0xb0>
    if(p->parent == curproc){
8010376b:	39 73 14             	cmp    %esi,0x14(%ebx)
8010376e:	75 ed                	jne    8010375d <exit+0x88>
      p->parent = initproc;
80103770:	a1 54 3f 11 80       	mov    0x80113f54,%eax
80103775:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80103778:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010377c:	75 df                	jne    8010375d <exit+0x88>
        wakeup1(initproc);
8010377e:	e8 79 f8 ff ff       	call   80102ffc <wakeup1>
80103783:	eb d8                	jmp    8010375d <exit+0x88>
  curproc->state = ZOMBIE;
80103785:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
8010378c:	e8 a1 fe ff ff       	call   80103632 <sched>
  panic("zombie exit");
80103791:	83 ec 0c             	sub    $0xc,%esp
80103794:	68 c8 6d 10 80       	push   $0x80106dc8
80103799:	e8 aa cb ff ff       	call   80100348 <panic>

8010379e <yield>:
{
8010379e:	55                   	push   %ebp
8010379f:	89 e5                	mov    %esp,%ebp
801037a1:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
801037a4:	68 20 1d 11 80       	push   $0x80111d20
801037a9:	e8 f3 05 00 00       	call   80103da1 <acquire>
  myproc()->state = RUNNABLE;
801037ae:	e8 1d fa ff ff       	call   801031d0 <myproc>
801037b3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
801037ba:	e8 73 fe ff ff       	call   80103632 <sched>
  release(&ptable.lock);
801037bf:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801037c6:	e8 3b 06 00 00       	call   80103e06 <release>
}
...
801037d5:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
801037d8:	e8 f3 f9 ff ff       	call   801031d0 <myproc>
  if(p == 0)
801037dd:	85 c0                	test   %eax,%eax
801037df:	74 66                	je     80103847 <sleep+0x77>
801037e1:	89 c3                	mov    %eax,%ebx
  if(lk == 0)
801037e3:	85 f6                	test   %esi,%esi
801037e5:	74 6d                	je     80103854 <sleep+0x84>
  if(lk != &ptable.lock){  //DOC: sleeplock0
801037e7:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
801037ed:	74 18                	je     80103807 <sleep+0x37>
    acquire(&ptable.lock);  //DOC: sleeplock1
801037ef:	83 ec 0c             	sub    $0xc,%esp
801037f2:	68 20 1d 11 80       	push   $0x80111d20
801037f7:	e8 a5 05 00 00       	call   80103da1 <acquire>
    release(lk);
801037fc:	89 34 24             	mov    %esi,(%esp)
801037ff:	e8 02 06 00 00       	call   80103e06 <release>
80103804:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
80103807:	8b 45 08             	mov    0x8(%ebp),%eax
8010380a:	89 43 20             	mov    %eax,0x20(%ebx)
  p->state = SLEEPING;
8010380d:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103814:	e8 19 fe ff ff       	call   80103632 <sched>
  p->chan = 0;
80103819:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
80103820:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
80103826:	74 18                	je     80103840 <sleep+0x70>
    release(&ptable.lock);
80103828:	83 ec 0c             	sub    $0xc,%esp
8010382b:	68 20 1d 11 80       	push   $0x80111d20
80103830:	e8 d1 05 00 00       	call   80103e06 <release>
    acquire(lk);
80103835:	89 34 24             	mov    %esi,(%esp)
80103838:	e8 64 05 00 00       	call   80103da1 <acquire>
...
8010384a:	68 d4 6d 10 80       	push   $0x80106dd4
8010384f:	e8 f4 ca ff ff       	call   80100348 <panic>
    panic("sleep without lk");
80103854:	83 ec 0c             	sub    $0xc,%esp
80103857:	68 da 6d 10 80       	push   $0x80106dda
8010385c:	e8 e7 ca ff ff       	call   80100348 <panic>
...
80103865:	53                   	push   %ebx
  struct proc *curproc = myproc();
80103866:	e8 65 f9 ff ff       	call   801031d0 <myproc>
8010386b:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
8010386d:	83 ec 0c             	sub    $0xc,%esp
80103870:	68 20 1d 11 80       	push   $0x80111d20
80103875:	e8 27 05 00 00       	call   80103da1 <acquire>
8010387a:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010387d:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103882:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80103887:	eb 6f                	jmp    801038f8 <wait+0x97>
        pid = p->pid;
80103889:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010388c:	83 ec 0c             	sub    $0xc,%esp
8010388f:	ff 73 08             	push   0x8(%ebx)
80103892:	e8 f5 e6 ff ff       	call   80101f8c <kfree>
        p->kstack = 0;
80103897:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010389e:	83 c4 04             	add    $0x4,%esp
801038a1:	ff 73 04             	push   0x4(%ebx)
801038a4:	e8 9a 2c 00 00       	call   80106543 <freevm>
        p->pid = 0;
801038a9:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801038b0:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801038b7:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801038bb:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801038c2:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        p->tickets = 0;
801038c9:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->ticks = 0;
801038d0:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801038d7:	00 00 00 
        release(&ptable.lock);
801038da:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801038e1:	e8 20 05 00 00       	call   80103e06 <release>
        return pid;
...
801038f1:	c3                   	ret    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038f2:	81 c3 88 00 00 00    	add    $0x88,%ebx
801038f8:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
801038fe:	73 16                	jae    80103916 <wait+0xb5>
      if(p->parent != curproc)
80103900:	39 73 14             	cmp    %esi,0x14(%ebx)
80103903:	75 ed                	jne    801038f2 <wait+0x91>
      if(p->state == ZOMBIE){
80103905:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103909:	0f 84 7a ff ff ff    	je     80103889 <wait+0x28>
      havekids = 1;
8010390f:	b8 01 00 00 00       	mov    $0x1,%eax
80103914:	eb dc                	jmp    801038f2 <wait+0x91>
    if(!havekids || curproc->killed){
80103916:	85 c0                	test   %eax,%eax
80103918:	74 06                	je     80103920 <wait+0xbf>
8010391a:	83 7e 24 00          	cmpl   $0x0,0x24(%esi)
8010391e:	74 17                	je     80103937 <wait+0xd6>
      release(&ptable.lock);
80103920:	83 ec 0c             	sub    $0xc,%esp
80103923:	68 20 1d 11 80       	push   $0x80111d20
80103928:	e8 d9 04 00 00       	call   80103e06 <release>
      return -1;
8010392d:	83 c4 10             	add    $0x10,%esp
80103930:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103935:	eb b2                	jmp    801038e9 <wait+0x88>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103937:	83 ec 08             	sub    $0x8,%esp
8010393a:	68 20 1d 11 80       	push   $0x80111d20
8010393f:	56                   	push   %esi
80103940:	e8 8b fe ff ff       	call   801037d0 <sleep>
    havekids = 0;
80103945:	83 c4 10             	add    $0x10,%esp
80103948:	e9 30 ff ff ff       	jmp    8010387d <wait+0x1c>
...
80103950:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80103953:	68 20 1d 11 80       	push   $0x80111d20
80103958:	e8 44 04 00 00       	call   80103da1 <acquire>
  wakeup1(chan);
8010395d:	8b 45 08             	mov    0x8(%ebp),%eax
80103960:	e8 97 f6 ff ff       	call   80102ffc <wakeup1>
  release(&ptable.lock);
80103965:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010396c:	e8 95 04 00 00       	call   80103e06 <release>
}
...
80103985:	e8 17 04 00 00       	call   80103da1 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010398a:	83 c4 10             	add    $0x10,%esp
8010398d:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103992:	eb 0e                	jmp    801039a2 <kill+0x2c>
    if(p->pid == pid){
      p->killed = 1;
...
8010399b:	eb 1e                	jmp    801039bb <kill+0x45>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010399d:	05 88 00 00 00       	add    $0x88,%eax
801039a2:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
801039a7:	73 2c                	jae    801039d5 <kill+0x5f>
    if(p->pid == pid){
801039a9:	39 58 10             	cmp    %ebx,0x10(%eax)
801039ac:	75 ef                	jne    8010399d <kill+0x27>
      p->killed = 1;
801039ae:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801039b5:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801039b9:	74 d9                	je     80103994 <kill+0x1e>
      release(&ptable.lock);
801039bb:	83 ec 0c             	sub    $0xc,%esp
801039be:	68 20 1d 11 80       	push   $0x80111d20
801039c3:	e8 3e 04 00 00       	call   80103e06 <release>
      return 0;
801039c8:	83 c4 10             	add    $0x10,%esp
801039cb:	b8 00 00 00 00       	mov    $0x0,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
801039d8:	68 20 1d 11 80       	push   $0x80111d20
801039dd:	e8 24 04 00 00       	call   80103e06 <release>
  return -1;
801039e2:	83 c4 10             	add    $0x10,%esp
801039e5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801039ea:	eb e4                	jmp    801039d0 <kill+0x5a>
...
801039f1:	83 ec 30             	sub    $0x30,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039f4:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801039f9:	eb 36                	jmp    80103a31 <procdump+0x45>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
801039fb:	b8 eb 6d 10 80       	mov    $0x80106deb,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
80103a00:	8d 53 6c             	lea    0x6c(%ebx),%edx
80103a03:	52                   	push   %edx
80103a04:	50                   	push   %eax
80103a05:	ff 73 10             	push   0x10(%ebx)
80103a08:	68 ef 6d 10 80       	push   $0x80106def
80103a0d:	e8 f5 cb ff ff       	call   80100607 <cprintf>
    if(p->state == SLEEPING){
80103a12:	83 c4 10             	add    $0x10,%esp
80103a15:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80103a19:	74 3c                	je     80103a57 <procdump+0x6b>
...
80103a1e:	68 67 71 10 80       	push   $0x80107167
80103a23:	e8 df cb ff ff       	call   80100607 <cprintf>
80103a28:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a2b:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103a31:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
80103a37:	73 61                	jae    80103a9a <procdump+0xae>
    if(p->state == UNUSED)
80103a39:	8b 43 0c             	mov    0xc(%ebx),%eax
80103a3c:	85 c0                	test   %eax,%eax
80103a3e:	74 eb                	je     80103a2b <procdump+0x3f>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103a40:	83 f8 05             	cmp    $0x5,%eax
80103a43:	77 b6                	ja     801039fb <procdump+0xf>
80103a45:	8b 04 85 4c 6e 10 80 	mov    -0x7fef91b4(,%eax,4),%eax
80103a4c:	85 c0                	test   %eax,%eax
80103a4e:	75 b0                	jne    80103a00 <procdump+0x14>
      state = "???";
80103a50:	b8 eb 6d 10 80       	mov    $0x80106deb,%eax
80103a55:	eb a9                	jmp    80103a00 <procdump+0x14>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103a57:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a5a:	8b 40 0c             	mov    0xc(%eax),%eax
80103a5d:	83 c0 08             	add    $0x8,%eax
80103a60:	83 ec 08             	sub    $0x8,%esp
80103a63:	8d 55 d0             	lea    -0x30(%ebp),%edx
80103a66:	52                   	push   %edx
80103a67:	50                   	push   %eax
80103a68:	e8 13 02 00 00       	call   80103c80 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80103a6d:	83 c4 10             	add    $0x10,%esp
80103a70:	be 00 00 00 00       	mov    $0x0,%esi
80103a75:	eb 14                	jmp    80103a8b <procdump+0x9f>
        cprintf(" %p", pc[i]);
80103a77:	83 ec 08             	sub    $0x8,%esp
80103a7a:	50                   	push   %eax
80103a7b:	68 41 68 10 80       	push   $0x80106841
80103a80:	e8 82 cb ff ff       	call   80100607 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80103a85:	83 c6 01             	add    $0x1,%esi
80103a88:	83 c4 10             	add    $0x10,%esp
80103a8b:	83 fe 09             	cmp    $0x9,%esi
80103a8e:	7f 8b                	jg     80103a1b <procdump+0x2f>
80103a90:	8b 44 b5 d0          	mov    -0x30(%ebp,%esi,4),%eax
80103a94:	85 c0                	test   %eax,%eax
80103a96:	75 df                	jne    80103a77 <procdump+0x8b>
80103a98:	eb 81                	jmp    80103a1b <procdump+0x2f>
  }
}
...
80103aab:	83 fb 01             	cmp    $0x1,%ebx
80103aae:	77 12                	ja     80103ac2 <settickets+0x21>
    return -1;

  myproc()->tickets = number;
80103ab0:	e8 1b f7 ff ff       	call   801031d0 <myproc>
80103ab5:	89 58 7c             	mov    %ebx,0x7c(%eax)
...
80103ac1:	c3                   	ret    
    return -1;
80103ac2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ac7:	eb f4                	jmp    80103abd <settickets+0x1c>
...
80103acd:	83 ec 04             	sub    $0x4,%esp
80103ad0:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!pstat)
80103ad3:	85 db                	test   %ebx,%ebx
80103ad5:	74 7c                	je     80103b53 <getpinfo+0x8a>
    return -1;
...
80103ada:	68 20 1d 11 80       	push   $0x80111d20
80103adf:	e8 bd 02 00 00       	call   80103da1 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ae4:	83 c4 10             	add    $0x10,%esp
80103ae7:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103aec:	eb 06                	jmp    80103af4 <getpinfo+0x2b>
80103aee:	81 c2 88 00 00 00    	add    $0x88,%edx
80103af4:	81 fa 54 3f 11 80    	cmp    $0x80113f54,%edx
80103afa:	73 3d                	jae    80103b39 <getpinfo+0x70>
    int i = p - ptable.proc;
80103afc:	89 d0                	mov    %edx,%eax
80103afe:	2d 54 1d 11 80       	sub    $0x80111d54,%eax
80103b03:	c1 f8 03             	sar    $0x3,%eax
80103b06:	69 c0 f1 f0 f0 f0    	imul   $0xf0f0f0f1,%eax,%eax
    if(p-> state == UNUSED) {
80103b0c:	8b 4a 0c             	mov    0xc(%edx),%ecx
80103b0f:	85 c9                	test   %ecx,%ecx
80103b11:	75 db                	jne    80103aee <getpinfo+0x25>
      pstat->inuse[i] = p->state;
80103b13:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
      pstat->tickets[i] = p->tickets;
80103b16:	8b 4a 7c             	mov    0x7c(%edx),%ecx
80103b19:	89 8c 83 00 01 00 00 	mov    %ecx,0x100(%ebx,%eax,4)
      pstat->pid[i] = p->pid;
80103b20:	8b 4a 10             	mov    0x10(%edx),%ecx
80103b23:	89 8c 83 00 02 00 00 	mov    %ecx,0x200(%ebx,%eax,4)
      pstat->ticks[i] = p->ticks;
80103b2a:	8b 8a 80 00 00 00    	mov    0x80(%edx),%ecx
80103b30:	89 8c 83 00 03 00 00 	mov    %ecx,0x300(%ebx,%eax,4)
80103b37:	eb b5                	jmp    80103aee <getpinfo+0x25>
    }
  }
  release(&ptable.lock);
80103b39:	83 ec 0c             	sub    $0xc,%esp
80103b3c:	68 20 1d 11 80       	push   $0x80111d20
80103b41:	e8 c0 02 00 00       	call   80103e06 <release>
...
80103b58:	eb f4                	jmp    80103b4e <getpinfo+0x85>

80103b5a <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80103b64:	68 64 6e 10 80       	push   $0x80106e64
80103b69:	8d 43 04             	lea    0x4(%ebx),%eax
80103b6c:	50                   	push   %eax
80103b6d:	e8 f3 00 00 00       	call   80103c65 <initlock>
  lk->name = name;
80103b72:	8b 45 0c             	mov    0xc(%ebp),%eax
80103b75:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
80103b78:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103b7e:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
...
80103b92:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103b95:	8d 73 04             	lea    0x4(%ebx),%esi
80103b98:	83 ec 0c             	sub    $0xc,%esp
80103b9b:	56                   	push   %esi
80103b9c:	e8 00 02 00 00       	call   80103da1 <acquire>
  while (lk->locked) {
80103ba1:	83 c4 10             	add    $0x10,%esp
80103ba4:	eb 0d                	jmp    80103bb3 <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103ba6:	83 ec 08             	sub    $0x8,%esp
80103ba9:	56                   	push   %esi
80103baa:	53                   	push   %ebx
80103bab:	e8 20 fc ff ff       	call   801037d0 <sleep>
80103bb0:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103bb3:	83 3b 00             	cmpl   $0x0,(%ebx)
80103bb6:	75 ee                	jne    80103ba6 <acquiresleep+0x19>
  }
  lk->locked = 1;
80103bb8:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103bbe:	e8 0d f6 ff ff       	call   801031d0 <myproc>
80103bc3:	8b 40 10             	mov    0x10(%eax),%eax
80103bc6:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103bc9:	83 ec 0c             	sub    $0xc,%esp
80103bcc:	56                   	push   %esi
80103bcd:	e8 34 02 00 00       	call   80103e06 <release>
}
...
80103beb:	e8 b1 01 00 00       	call   80103da1 <acquire>
  lk->locked = 0;
80103bf0:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103bf6:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103bfd:	89 1c 24             	mov    %ebx,(%esp)
80103c00:	e8 48 fd ff ff       	call   8010394d <wakeup>
  release(&lk->lk);
80103c05:	89 34 24             	mov    %esi,(%esp)
80103c08:	e8 f9 01 00 00       	call   80103e06 <release>
}
...
80103c1c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&lk->lk);
80103c1f:	8d 73 04             	lea    0x4(%ebx),%esi
80103c22:	83 ec 0c             	sub    $0xc,%esp
80103c25:	56                   	push   %esi
80103c26:	e8 76 01 00 00       	call   80103da1 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103c2b:	83 c4 10             	add    $0x10,%esp
80103c2e:	83 3b 00             	cmpl   $0x0,(%ebx)
80103c31:	75 17                	jne    80103c4a <holdingsleep+0x33>
80103c33:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103c38:	83 ec 0c             	sub    $0xc,%esp
80103c3b:	56                   	push   %esi
80103c3c:	e8 c5 01 00 00       	call   80103e06 <release>
  return r;
}
80103c41:	89 d8                	mov    %ebx,%eax
...
80103c49:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103c4a:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103c4d:	e8 7e f5 ff ff       	call   801031d0 <myproc>
80103c52:	3b 58 10             	cmp    0x10(%eax),%ebx
80103c55:	74 07                	je     80103c5e <holdingsleep+0x47>
80103c57:	bb 00 00 00 00       	mov    $0x0,%ebx
80103c5c:	eb da                	jmp    80103c38 <holdingsleep+0x21>
80103c5e:	bb 01 00 00 00       	mov    $0x1,%ebx
80103c63:	eb d3                	jmp    80103c38 <holdingsleep+0x21>
...
80103c6e:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103c71:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103c77:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103c7e:	5d                   	pop    %ebp
80103c7f:	c3                   	ret    

80103c80 <getcallerpcs>:
}
...
80103c84:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80103c87:	8b 45 08             	mov    0x8(%ebp),%eax
80103c8a:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103c8d:	b8 00 00 00 00       	mov    $0x0,%eax
80103c92:	83 f8 09             	cmp    $0x9,%eax
80103c95:	7f 25                	jg     80103cbc <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103c97:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103c9d:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103ca3:	77 17                	ja     80103cbc <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103ca5:	8b 5a 04             	mov    0x4(%edx),%ebx
80103ca8:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103cab:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103cad:	83 c0 01             	add    $0x1,%eax
80103cb0:	eb e0                	jmp    80103c92 <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103cb2:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103cb9:	83 c0 01             	add    $0x1,%eax
80103cbc:	83 f8 09             	cmp    $0x9,%eax
80103cbf:	7e f1                	jle    80103cb2 <getcallerpcs+0x32>
}
...
80103ccf:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103cd0:	e8 84 f4 ff ff       	call   80103159 <mycpu>
80103cd5:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103cdc:	74 11                	je     80103cef <pushcli+0x29>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103cde:	e8 76 f4 ff ff       	call   80103159 <mycpu>
80103ce3:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103cea:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103ced:	c9                   	leave  
80103cee:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103cef:	e8 65 f4 ff ff       	call   80103159 <mycpu>
80103cf4:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103cfa:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103d00:	eb dc                	jmp    80103cde <pushcli+0x18>
...
80103d09:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103d0a:	f6 c4 02             	test   $0x2,%ah
80103d0d:	75 28                	jne    80103d37 <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103d0f:	e8 45 f4 ff ff       	call   80103159 <mycpu>
80103d14:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80103d1a:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103d1d:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80103d23:	85 d2                	test   %edx,%edx
80103d25:	78 1d                	js     80103d44 <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103d27:	e8 2d f4 ff ff       	call   80103159 <mycpu>
80103d2c:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103d33:	74 1c                	je     80103d51 <popcli+0x4f>
    sti();
}
80103d35:	c9                   	leave  
80103d36:	c3                   	ret    
...
80103d3a:	68 6f 6e 10 80       	push   $0x80106e6f
80103d3f:	e8 04 c6 ff ff       	call   80100348 <panic>
    panic("popcli");
80103d44:	83 ec 0c             	sub    $0xc,%esp
80103d47:	68 86 6e 10 80       	push   $0x80106e86
80103d4c:	e8 f7 c5 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103d51:	e8 03 f4 ff ff       	call   80103159 <mycpu>
80103d56:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103d5d:	74 d6                	je     80103d35 <popcli+0x33>
  asm volatile("sti");
80103d5f:	fb                   	sti    
}
80103d60:	eb d3                	jmp    80103d35 <popcli+0x33>
...
80103d69:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103d6c:	e8 55 ff ff ff       	call   80103cc6 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103d71:	83 3b 00             	cmpl   $0x0,(%ebx)
80103d74:	75 11                	jne    80103d87 <holding+0x25>
80103d76:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103d7b:	e8 82 ff ff ff       	call   80103d02 <popcli>
}
...
80103d86:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103d87:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103d8a:	e8 ca f3 ff ff       	call   80103159 <mycpu>
80103d8f:	39 c3                	cmp    %eax,%ebx
80103d91:	74 07                	je     80103d9a <holding+0x38>
80103d93:	bb 00 00 00 00       	mov    $0x0,%ebx
80103d98:	eb e1                	jmp    80103d7b <holding+0x19>
80103d9a:	bb 01 00 00 00       	mov    $0x1,%ebx
80103d9f:	eb da                	jmp    80103d7b <holding+0x19>
...
80103da8:	e8 19 ff ff ff       	call   80103cc6 <pushcli>
  if(holding(lk))
80103dad:	83 ec 0c             	sub    $0xc,%esp
80103db0:	ff 75 08             	push   0x8(%ebp)
80103db3:	e8 aa ff ff ff       	call   80103d62 <holding>
80103db8:	83 c4 10             	add    $0x10,%esp
80103dbb:	85 c0                	test   %eax,%eax
80103dbd:	75 3a                	jne    80103df9 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103dbf:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103dc2:	b8 01 00 00 00       	mov    $0x1,%eax
80103dc7:	f0 87 02             	lock xchg %eax,(%edx)
80103dca:	85 c0                	test   %eax,%eax
80103dcc:	75 f1                	jne    80103dbf <acquire+0x1e>
  __sync_synchronize();
80103dce:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103dd3:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103dd6:	e8 7e f3 ff ff       	call   80103159 <mycpu>
80103ddb:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103dde:	8b 45 08             	mov    0x8(%ebp),%eax
80103de1:	83 c0 0c             	add    $0xc,%eax
80103de4:	83 ec 08             	sub    $0x8,%esp
80103de7:	50                   	push   %eax
80103de8:	8d 45 08             	lea    0x8(%ebp),%eax
80103deb:	50                   	push   %eax
80103dec:	e8 8f fe ff ff       	call   80103c80 <getcallerpcs>
}
...
80103dfc:	68 8d 6e 10 80       	push   $0x80106e8d
80103e01:	e8 42 c5 ff ff       	call   80100348 <panic>
...
80103e0a:	83 ec 10             	sub    $0x10,%esp
80103e0d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
80103e10:	53                   	push   %ebx
80103e11:	e8 4c ff ff ff       	call   80103d62 <holding>
80103e16:	83 c4 10             	add    $0x10,%esp
80103e19:	85 c0                	test   %eax,%eax
80103e1b:	74 23                	je     80103e40 <release+0x3a>
  lk->pcs[0] = 0;
80103e1d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103e24:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103e2b:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103e30:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103e36:	e8 c7 fe ff ff       	call   80103d02 <popcli>
}
...
80103e43:	68 95 6e 10 80       	push   $0x80106e95
80103e48:	e8 fb c4 ff ff       	call   80100348 <panic>
...
80103e50:	57                   	push   %edi
80103e51:	53                   	push   %ebx
80103e52:	8b 55 08             	mov    0x8(%ebp),%edx
80103e55:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e58:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103e5b:	f6 c2 03             	test   $0x3,%dl
80103e5e:	75 25                	jne    80103e85 <memset+0x38>
80103e60:	f6 c1 03             	test   $0x3,%cl
80103e63:	75 20                	jne    80103e85 <memset+0x38>
    c &= 0xFF;
80103e65:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103e68:	c1 e9 02             	shr    $0x2,%ecx
80103e6b:	c1 e0 18             	shl    $0x18,%eax
80103e6e:	89 fb                	mov    %edi,%ebx
80103e70:	c1 e3 10             	shl    $0x10,%ebx
80103e73:	09 d8                	or     %ebx,%eax
80103e75:	89 fb                	mov    %edi,%ebx
80103e77:	c1 e3 08             	shl    $0x8,%ebx
80103e7a:	09 d8                	or     %ebx,%eax
80103e7c:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103e7e:	89 d7                	mov    %edx,%edi
80103e80:	fc                   	cld    
80103e81:	f3 ab                	rep stos %eax,%es:(%edi)
}
80103e83:	eb 05                	jmp    80103e8a <memset+0x3d>
  asm volatile("cld; rep stosb" :
80103e85:	89 d7                	mov    %edx,%edi
80103e87:	fc                   	cld    
80103e88:	f3 aa                	rep stos %al,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
...
80103e95:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103e98:	8b 55 0c             	mov    0xc(%ebp),%edx
80103e9b:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103e9e:	eb 08                	jmp    80103ea8 <memcmp+0x18>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
...
80103ea3:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103ea6:	89 f0                	mov    %esi,%eax
80103ea8:	8d 70 ff             	lea    -0x1(%eax),%esi
80103eab:	85 c0                	test   %eax,%eax
80103ead:	74 12                	je     80103ec1 <memcmp+0x31>
    if(*s1 != *s2)
80103eaf:	0f b6 01             	movzbl (%ecx),%eax
80103eb2:	0f b6 1a             	movzbl (%edx),%ebx
80103eb5:	38 d8                	cmp    %bl,%al
80103eb7:	74 e7                	je     80103ea0 <memcmp+0x10>
      return *s1 - *s2;
80103eb9:	0f b6 c0             	movzbl %al,%eax
80103ebc:	0f b6 db             	movzbl %bl,%ebx
80103ebf:	29 d8                	sub    %ebx,%eax
  }
...
80103eca:	8b 75 08             	mov    0x8(%ebp),%esi
80103ecd:	8b 55 0c             	mov    0xc(%ebp),%edx
80103ed0:	8b 45 10             	mov    0x10(%ebp),%eax
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80103ed3:	39 f2                	cmp    %esi,%edx
80103ed5:	73 3c                	jae    80103f13 <memmove+0x4e>
80103ed7:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80103eda:	39 f1                	cmp    %esi,%ecx
80103edc:	76 39                	jbe    80103f17 <memmove+0x52>
    s += n;
    d += n;
80103ede:	8d 14 06             	lea    (%esi,%eax,1),%edx
    while(n-- > 0)
80103ee1:	eb 0d                	jmp    80103ef0 <memmove+0x2b>
      *--d = *--s;
80103ee3:	83 e9 01             	sub    $0x1,%ecx
80103ee6:	83 ea 01             	sub    $0x1,%edx
80103ee9:	0f b6 01             	movzbl (%ecx),%eax
80103eec:	88 02                	mov    %al,(%edx)
    while(n-- > 0)
80103eee:	89 d8                	mov    %ebx,%eax
80103ef0:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103ef3:	85 c0                	test   %eax,%eax
80103ef5:	75 ec                	jne    80103ee3 <memmove+0x1e>
80103ef7:	eb 14                	jmp    80103f0d <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103ef9:	0f b6 02             	movzbl (%edx),%eax
80103efc:	88 01                	mov    %al,(%ecx)
80103efe:	8d 49 01             	lea    0x1(%ecx),%ecx
80103f01:	8d 52 01             	lea    0x1(%edx),%edx
    while(n-- > 0)
80103f04:	89 d8                	mov    %ebx,%eax
80103f06:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103f09:	85 c0                	test   %eax,%eax
80103f0b:	75 ec                	jne    80103ef9 <memmove+0x34>

  return dst;
}
80103f0d:	89 f0                	mov    %esi,%eax
80103f0f:	5b                   	pop    %ebx
80103f10:	5e                   	pop    %esi
80103f11:	5d                   	pop    %ebp
80103f12:	c3                   	ret    
80103f13:	89 f1                	mov    %esi,%ecx
80103f15:	eb ef                	jmp    80103f06 <memmove+0x41>
80103f17:	89 f1                	mov    %esi,%ecx
80103f19:	eb eb                	jmp    80103f06 <memmove+0x41>
...
80103f21:	ff 75 10             	push   0x10(%ebp)
80103f24:	ff 75 0c             	push   0xc(%ebp)
80103f27:	ff 75 08             	push   0x8(%ebp)
80103f2a:	e8 96 ff ff ff       	call   80103ec5 <memmove>
}
80103f2f:	c9                   	leave  
80103f30:	c3                   	ret    
...
80103f38:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103f3b:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103f3e:	eb 09                	jmp    80103f49 <strncmp+0x18>
    n--, p++, q++;
80103f40:	83 e8 01             	sub    $0x1,%eax
80103f43:	83 c2 01             	add    $0x1,%edx
80103f46:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103f49:	85 c0                	test   %eax,%eax
80103f4b:	74 0b                	je     80103f58 <strncmp+0x27>
80103f4d:	0f b6 1a             	movzbl (%edx),%ebx
80103f50:	84 db                	test   %bl,%bl
80103f52:	74 04                	je     80103f58 <strncmp+0x27>
80103f54:	3a 19                	cmp    (%ecx),%bl
80103f56:	74 e8                	je     80103f40 <strncmp+0xf>
  if(n == 0)
80103f58:	85 c0                	test   %eax,%eax
80103f5a:	74 0d                	je     80103f69 <strncmp+0x38>
    return 0;
  return (uchar)*p - (uchar)*q;
80103f5c:	0f b6 02             	movzbl (%edx),%eax
80103f5f:	0f b6 11             	movzbl (%ecx),%edx
80103f62:	29 d0                	sub    %edx,%eax
}
...
80103f6e:	eb f4                	jmp    80103f64 <strncmp+0x33>
...
80103f76:	8b 7d 08             	mov    0x8(%ebp),%edi
80103f79:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103f7c:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80103f7f:	89 fa                	mov    %edi,%edx
80103f81:	eb 04                	jmp    80103f87 <strncpy+0x17>
80103f83:	89 f1                	mov    %esi,%ecx
80103f85:	89 da                	mov    %ebx,%edx
80103f87:	89 c3                	mov    %eax,%ebx
80103f89:	83 e8 01             	sub    $0x1,%eax
80103f8c:	85 db                	test   %ebx,%ebx
80103f8e:	7e 11                	jle    80103fa1 <strncpy+0x31>
80103f90:	8d 71 01             	lea    0x1(%ecx),%esi
80103f93:	8d 5a 01             	lea    0x1(%edx),%ebx
80103f96:	0f b6 09             	movzbl (%ecx),%ecx
80103f99:	88 0a                	mov    %cl,(%edx)
80103f9b:	84 c9                	test   %cl,%cl
80103f9d:	75 e4                	jne    80103f83 <strncpy+0x13>
80103f9f:	89 da                	mov    %ebx,%edx
    ;
  while(n-- > 0)
80103fa1:	8d 48 ff             	lea    -0x1(%eax),%ecx
80103fa4:	85 c0                	test   %eax,%eax
80103fa6:	7e 0a                	jle    80103fb2 <strncpy+0x42>
    *s++ = 0;
80103fa8:	c6 02 00             	movb   $0x0,(%edx)
  while(n-- > 0)
80103fab:	89 c8                	mov    %ecx,%eax
    *s++ = 0;
80103fad:	8d 52 01             	lea    0x1(%edx),%edx
80103fb0:	eb ef                	jmp    80103fa1 <strncpy+0x31>
  return os;
}
...
80103fbc:	57                   	push   %edi
80103fbd:	56                   	push   %esi
80103fbe:	53                   	push   %ebx
80103fbf:	8b 7d 08             	mov    0x8(%ebp),%edi
80103fc2:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103fc5:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  if(n <= 0)
80103fc8:	85 c0                	test   %eax,%eax
80103fca:	7e 23                	jle    80103fef <safestrcpy+0x36>
80103fcc:	89 fa                	mov    %edi,%edx
80103fce:	eb 04                	jmp    80103fd4 <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103fd0:	89 f1                	mov    %esi,%ecx
80103fd2:	89 da                	mov    %ebx,%edx
80103fd4:	83 e8 01             	sub    $0x1,%eax
80103fd7:	85 c0                	test   %eax,%eax
80103fd9:	7e 11                	jle    80103fec <safestrcpy+0x33>
80103fdb:	8d 71 01             	lea    0x1(%ecx),%esi
80103fde:	8d 5a 01             	lea    0x1(%edx),%ebx
80103fe1:	0f b6 09             	movzbl (%ecx),%ecx
80103fe4:	88 0a                	mov    %cl,(%edx)
80103fe6:	84 c9                	test   %cl,%cl
80103fe8:	75 e6                	jne    80103fd0 <safestrcpy+0x17>
80103fea:	89 da                	mov    %ebx,%edx
    ;
  *s = 0;
80103fec:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
80103fef:	89 f8                	mov    %edi,%eax
80103ff1:	5b                   	pop    %ebx
80103ff2:	5e                   	pop    %esi
80103ff3:	5f                   	pop    %edi
80103ff4:	5d                   	pop    %ebp
...
80104001:	eb 03                	jmp    80104006 <strlen+0x10>
80104003:	83 c0 01             	add    $0x1,%eax
80104006:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
8010400a:	75 f7                	jne    80104003 <strlen+0xd>
    ;
  return n;
}
8010400c:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
8010400e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104012:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104018:	56                   	push   %esi
  pushl %edi
80104019:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
8010401a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010401c:	89 d4                	mov    %edx,%esp
...
8010402a:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010402d:	e8 9e f1 ff ff       	call   801031d0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104032:	8b 00                	mov    (%eax),%eax
80104034:	39 d8                	cmp    %ebx,%eax
80104036:	76 18                	jbe    80104050 <fetchint+0x2d>
80104038:	8d 53 04             	lea    0x4(%ebx),%edx
8010403b:	39 d0                	cmp    %edx,%eax
8010403d:	72 18                	jb     80104057 <fetchint+0x34>
    return -1;
  *ip = *(int*)(addr);
8010403f:	8b 13                	mov    (%ebx),%edx
80104041:	8b 45 0c             	mov    0xc(%ebp),%eax
80104044:	89 10                	mov    %edx,(%eax)
  return 0;
80104046:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010404b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010404e:	c9                   	leave  
8010404f:	c3                   	ret    
    return -1;
80104050:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104055:	eb f4                	jmp    8010404b <fetchint+0x28>
80104057:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010405c:	eb ed                	jmp    8010404b <fetchint+0x28>
...
8010406f:	76 25                	jbe    80104096 <fetchstr+0x38>
    return -1;
  *pp = (char*)addr;
...
8010407a:	eb 03                	jmp    8010407f <fetchstr+0x21>
8010407c:	83 c0 01             	add    $0x1,%eax
8010407f:	39 d0                	cmp    %edx,%eax
80104081:	73 09                	jae    8010408c <fetchstr+0x2e>
    if(*s == 0)
80104083:	80 38 00             	cmpb   $0x0,(%eax)
80104086:	75 f4                	jne    8010407c <fetchstr+0x1e>
      return s - *pp;
80104088:	29 d8                	sub    %ebx,%eax
8010408a:	eb 05                	jmp    80104091 <fetchstr+0x33>
  }
  return -1;
...
8010409b:	eb f4                	jmp    80104091 <fetchstr+0x33>
...
801040a3:	e8 28 f1 ff ff       	call   801031d0 <myproc>
801040a8:	8b 50 18             	mov    0x18(%eax),%edx
801040ab:	8b 45 08             	mov    0x8(%ebp),%eax
801040ae:	c1 e0 02             	shl    $0x2,%eax
801040b1:	03 42 44             	add    0x44(%edx),%eax
801040b4:	83 ec 08             	sub    $0x8,%esp
801040b7:	ff 75 0c             	push   0xc(%ebp)
801040ba:	83 c0 04             	add    $0x4,%eax
801040bd:	50                   	push   %eax
801040be:	e8 60 ff ff ff       	call   80104023 <fetchint>
}
801040c3:	c9                   	leave  
801040c4:	c3                   	ret    
...
801040cd:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801040d0:	e8 fb f0 ff ff       	call   801031d0 <myproc>
801040d5:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
801040d7:	83 ec 08             	sub    $0x8,%esp
801040da:	8d 45 f4             	lea    -0xc(%ebp),%eax
801040dd:	50                   	push   %eax
801040de:	ff 75 08             	push   0x8(%ebp)
801040e1:	e8 b7 ff ff ff       	call   8010409d <argint>
801040e6:	83 c4 10             	add    $0x10,%esp
801040e9:	85 c0                	test   %eax,%eax
801040eb:	78 24                	js     80104111 <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
801040ed:	85 db                	test   %ebx,%ebx
801040ef:	78 27                	js     80104118 <argptr+0x53>
801040f1:	8b 16                	mov    (%esi),%edx
801040f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040f6:	39 c2                	cmp    %eax,%edx
801040f8:	76 25                	jbe    8010411f <argptr+0x5a>
801040fa:	01 c3                	add    %eax,%ebx
801040fc:	39 da                	cmp    %ebx,%edx
801040fe:	72 26                	jb     80104126 <argptr+0x61>
    return -1;
  *pp = (char*)i;
80104100:	8b 55 0c             	mov    0xc(%ebp),%edx
80104103:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104116:	eb f2                	jmp    8010410a <argptr+0x45>
    return -1;
80104118:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010411d:	eb eb                	jmp    8010410a <argptr+0x45>
8010411f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104124:	eb e4                	jmp    8010410a <argptr+0x45>
80104126:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010412b:	eb dd                	jmp    8010410a <argptr+0x45>
...
80104130:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80104133:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104136:	50                   	push   %eax
80104137:	ff 75 08             	push   0x8(%ebp)
8010413a:	e8 5e ff ff ff       	call   8010409d <argint>
8010413f:	83 c4 10             	add    $0x10,%esp
80104142:	85 c0                	test   %eax,%eax
80104144:	78 13                	js     80104159 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
80104146:	83 ec 08             	sub    $0x8,%esp
80104149:	ff 75 0c             	push   0xc(%ebp)
8010414c:	ff 75 f4             	push   -0xc(%ebp)
8010414f:	e8 0a ff ff ff       	call   8010405e <fetchstr>
...
8010415e:	eb f7                	jmp    80104157 <argstr+0x2a>
...
80104164:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104167:	e8 64 f0 ff ff       	call   801031d0 <myproc>
8010416c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
8010416e:	8b 40 18             	mov    0x18(%eax),%eax
80104171:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104174:	8d 50 ff             	lea    -0x1(%eax),%edx
80104177:	83 fa 18             	cmp    $0x18,%edx
8010417a:	77 17                	ja     80104193 <syscall+0x33>
8010417c:	8b 14 85 c0 6e 10 80 	mov    -0x7fef9140(,%eax,4),%edx
80104183:	85 d2                	test   %edx,%edx
80104185:	74 0c                	je     80104193 <syscall+0x33>
    curproc->tf->eax = syscalls[num]();
80104187:	ff d2                	call   *%edx
80104189:	89 c2                	mov    %eax,%edx
8010418b:	8b 43 18             	mov    0x18(%ebx),%eax
8010418e:	89 50 1c             	mov    %edx,0x1c(%eax)
80104191:	eb 1f                	jmp    801041b2 <syscall+0x52>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80104193:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
80104196:	50                   	push   %eax
80104197:	52                   	push   %edx
80104198:	ff 73 10             	push   0x10(%ebx)
8010419b:	68 9d 6e 10 80       	push   $0x80106e9d
801041a0:	e8 62 c4 ff ff       	call   80100607 <cprintf>
    curproc->tf->eax = -1;
801041a5:	8b 43 18             	mov    0x18(%ebx),%eax
801041a8:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
...
801041bc:	83 ec 18             	sub    $0x18,%esp
801041bf:	89 d6                	mov    %edx,%esi
801041c1:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
801041c3:	8d 55 f4             	lea    -0xc(%ebp),%edx
801041c6:	52                   	push   %edx
801041c7:	50                   	push   %eax
801041c8:	e8 d0 fe ff ff       	call   8010409d <argint>
801041cd:	83 c4 10             	add    $0x10,%esp
801041d0:	85 c0                	test   %eax,%eax
801041d2:	78 35                	js     80104209 <argfd+0x52>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801041d4:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801041d8:	77 28                	ja     80104202 <argfd+0x4b>
801041da:	e8 f1 ef ff ff       	call   801031d0 <myproc>
801041df:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041e2:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
801041e6:	85 c0                	test   %eax,%eax
801041e8:	74 18                	je     80104202 <argfd+0x4b>
    return -1;
  if(pfd)
801041ea:	85 f6                	test   %esi,%esi
801041ec:	74 02                	je     801041f0 <argfd+0x39>
    *pfd = fd;
801041ee:	89 16                	mov    %edx,(%esi)
  if(pf)
801041f0:	85 db                	test   %ebx,%ebx
801041f2:	74 1c                	je     80104210 <argfd+0x59>
    *pf = f;
801041f4:	89 03                	mov    %eax,(%ebx)
  return 0;
801041f6:	b8 00 00 00 00       	mov    $0x0,%eax
}
801041fb:	8d 65 f8             	lea    -0x8(%ebp),%esp
801041fe:	5b                   	pop    %ebx
801041ff:	5e                   	pop    %esi
80104200:	5d                   	pop    %ebp
80104201:	c3                   	ret    
...
80104207:	eb f2                	jmp    801041fb <argfd+0x44>
    return -1;
80104209:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010420e:	eb eb                	jmp    801041fb <argfd+0x44>
  return 0;
80104210:	b8 00 00 00 00       	mov    $0x0,%eax
80104215:	eb e4                	jmp    801041fb <argfd+0x44>
...
8010421e:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
80104220:	e8 ab ef ff ff       	call   801031d0 <myproc>
80104225:	89 c2                	mov    %eax,%edx

  for(fd = 0; fd < NOFILE; fd++){
80104227:	b8 00 00 00 00       	mov    $0x0,%eax
8010422c:	83 f8 0f             	cmp    $0xf,%eax
8010422f:	7f 12                	jg     80104243 <fdalloc+0x2c>
    if(curproc->ofile[fd] == 0){
80104231:	83 7c 82 28 00       	cmpl   $0x0,0x28(%edx,%eax,4)
80104236:	74 05                	je     8010423d <fdalloc+0x26>
  for(fd = 0; fd < NOFILE; fd++){
80104238:	83 c0 01             	add    $0x1,%eax
8010423b:	eb ef                	jmp    8010422c <fdalloc+0x15>
      curproc->ofile[fd] = f;
8010423d:	89 5c 82 28          	mov    %ebx,0x28(%edx,%eax,4)
      return fd;
80104241:	eb 05                	jmp    80104248 <fdalloc+0x31>
    }
  }
  return -1;
...
80104252:	83 ec 10             	sub    $0x10,%esp
80104255:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80104257:	b8 20 00 00 00       	mov    $0x20,%eax
8010425c:	89 c6                	mov    %eax,%esi
8010425e:	39 43 58             	cmp    %eax,0x58(%ebx)
80104261:	76 2e                	jbe    80104291 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104263:	6a 10                	push   $0x10
80104265:	50                   	push   %eax
80104266:	8d 45 e8             	lea    -0x18(%ebp),%eax
80104269:	50                   	push   %eax
8010426a:	53                   	push   %ebx
8010426b:	e8 f1 d4 ff ff       	call   80101761 <readi>
80104270:	83 c4 10             	add    $0x10,%esp
80104273:	83 f8 10             	cmp    $0x10,%eax
80104276:	75 0c                	jne    80104284 <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
80104278:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
8010427d:	75 1e                	jne    8010429d <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010427f:	8d 46 10             	lea    0x10(%esi),%eax
80104282:	eb d8                	jmp    8010425c <isdirempty+0xf>
      panic("isdirempty: readi");
80104284:	83 ec 0c             	sub    $0xc,%esp
80104287:	68 28 6f 10 80       	push   $0x80106f28
...
801042a2:	eb f2                	jmp    80104296 <isdirempty+0x49>
...
801042aa:	83 ec 34             	sub    $0x34,%esp
801042ad:	89 55 d4             	mov    %edx,-0x2c(%ebp)
801042b0:	89 4d d0             	mov    %ecx,-0x30(%ebp)
801042b3:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801042b6:	8d 55 da             	lea    -0x26(%ebp),%edx
801042b9:	52                   	push   %edx
801042ba:	50                   	push   %eax
801042bb:	e8 25 d9 ff ff       	call   80101be5 <nameiparent>
801042c0:	89 c6                	mov    %eax,%esi
801042c2:	83 c4 10             	add    $0x10,%esp
801042c5:	85 c0                	test   %eax,%eax
801042c7:	0f 84 33 01 00 00    	je     80104400 <create+0x15c>
    return 0;
  ilock(dp);
801042cd:	83 ec 0c             	sub    $0xc,%esp
801042d0:	50                   	push   %eax
801042d1:	e8 99 d2 ff ff       	call   8010156f <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
801042d6:	83 c4 0c             	add    $0xc,%esp
801042d9:	6a 00                	push   $0x0
801042db:	8d 45 da             	lea    -0x26(%ebp),%eax
801042de:	50                   	push   %eax
801042df:	56                   	push   %esi
801042e0:	e8 ba d6 ff ff       	call   8010199f <dirlookup>
801042e5:	89 c3                	mov    %eax,%ebx
801042e7:	83 c4 10             	add    $0x10,%esp
801042ea:	85 c0                	test   %eax,%eax
801042ec:	74 3d                	je     8010432b <create+0x87>
    iunlockput(dp);
...
801042fa:	e8 70 d2 ff ff       	call   8010156f <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801042ff:	83 c4 10             	add    $0x10,%esp
80104302:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104307:	75 07                	jne    80104310 <create+0x6c>
80104309:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
8010430e:	74 11                	je     80104321 <create+0x7d>
      return ip;
    iunlockput(ip);
80104310:	83 ec 0c             	sub    $0xc,%esp
80104313:	53                   	push   %ebx
80104314:	e8 fd d3 ff ff       	call   80101716 <iunlockput>
    return 0;
80104319:	83 c4 10             	add    $0x10,%esp
8010431c:	bb 00 00 00 00       	mov    $0x0,%ebx
...
8010432e:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
80104332:	50                   	push   %eax
80104333:	ff 36                	push   (%esi)
80104335:	e8 32 d0 ff ff       	call   8010136c <ialloc>
8010433a:	89 c3                	mov    %eax,%ebx
8010433c:	83 c4 10             	add    $0x10,%esp
8010433f:	85 c0                	test   %eax,%eax
80104341:	74 52                	je     80104395 <create+0xf1>
  ilock(ip);
80104343:	83 ec 0c             	sub    $0xc,%esp
80104346:	50                   	push   %eax
80104347:	e8 23 d2 ff ff       	call   8010156f <ilock>
  ip->major = major;
8010434c:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104350:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
80104354:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
80104358:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
8010435e:	89 1c 24             	mov    %ebx,(%esp)
80104361:	e8 a8 d0 ff ff       	call   8010140e <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104366:	83 c4 10             	add    $0x10,%esp
80104369:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010436e:	74 32                	je     801043a2 <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
80104370:	83 ec 04             	sub    $0x4,%esp
80104373:	ff 73 04             	push   0x4(%ebx)
80104376:	8d 45 da             	lea    -0x26(%ebp),%eax
80104379:	50                   	push   %eax
8010437a:	56                   	push   %esi
8010437b:	e8 9c d7 ff ff       	call   80101b1c <dirlink>
80104380:	83 c4 10             	add    $0x10,%esp
80104383:	85 c0                	test   %eax,%eax
80104385:	78 6c                	js     801043f3 <create+0x14f>
  iunlockput(dp);
80104387:	83 ec 0c             	sub    $0xc,%esp
8010438a:	56                   	push   %esi
8010438b:	e8 86 d3 ff ff       	call   80101716 <iunlockput>
  return ip;
80104390:	83 c4 10             	add    $0x10,%esp
80104393:	eb 8c                	jmp    80104321 <create+0x7d>
    panic("create: ialloc");
80104395:	83 ec 0c             	sub    $0xc,%esp
80104398:	68 3a 6f 10 80       	push   $0x80106f3a
8010439d:	e8 a6 bf ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
801043a2:	0f b7 46 56          	movzwl 0x56(%esi),%eax
801043a6:	83 c0 01             	add    $0x1,%eax
801043a9:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
801043ad:	83 ec 0c             	sub    $0xc,%esp
801043b0:	56                   	push   %esi
801043b1:	e8 58 d0 ff ff       	call   8010140e <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801043b6:	83 c4 0c             	add    $0xc,%esp
801043b9:	ff 73 04             	push   0x4(%ebx)
801043bc:	68 4a 6f 10 80       	push   $0x80106f4a
801043c1:	53                   	push   %ebx
801043c2:	e8 55 d7 ff ff       	call   80101b1c <dirlink>
801043c7:	83 c4 10             	add    $0x10,%esp
801043ca:	85 c0                	test   %eax,%eax
801043cc:	78 18                	js     801043e6 <create+0x142>
801043ce:	83 ec 04             	sub    $0x4,%esp
801043d1:	ff 76 04             	push   0x4(%esi)
801043d4:	68 49 6f 10 80       	push   $0x80106f49
801043d9:	53                   	push   %ebx
801043da:	e8 3d d7 ff ff       	call   80101b1c <dirlink>
801043df:	83 c4 10             	add    $0x10,%esp
801043e2:	85 c0                	test   %eax,%eax
801043e4:	79 8a                	jns    80104370 <create+0xcc>
      panic("create dots");
801043e6:	83 ec 0c             	sub    $0xc,%esp
801043e9:	68 4c 6f 10 80       	push   $0x80106f4c
801043ee:	e8 55 bf ff ff       	call   80100348 <panic>
    panic("create: dirlink");
801043f3:	83 ec 0c             	sub    $0xc,%esp
801043f6:	68 58 6f 10 80       	push   $0x80106f58
801043fb:	e8 48 bf ff ff       	call   80100348 <panic>
    return 0;
80104400:	89 c3                	mov    %eax,%ebx
80104402:	e9 1a ff ff ff       	jmp    80104321 <create+0x7d>
...
8010440b:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
8010440e:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104411:	ba 00 00 00 00       	mov    $0x0,%edx
80104416:	b8 00 00 00 00       	mov    $0x0,%eax
8010441b:	e8 97 fd ff ff       	call   801041b7 <argfd>
80104420:	85 c0                	test   %eax,%eax
80104422:	78 23                	js     80104447 <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
80104424:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104427:	e8 eb fd ff ff       	call   80104217 <fdalloc>
8010442c:	89 c3                	mov    %eax,%ebx
8010442e:	85 c0                	test   %eax,%eax
80104430:	78 1c                	js     8010444e <sys_dup+0x47>
  filedup(f);
80104432:	83 ec 0c             	sub    $0xc,%esp
80104435:	ff 75 f4             	push   -0xc(%ebp)
80104438:	e8 41 c8 ff ff       	call   80100c7e <filedup>
  return fd;
...
80104446:	c3                   	ret    
    return -1;
80104447:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010444c:	eb f2                	jmp    80104440 <sys_dup+0x39>
    return -1;
8010444e:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104453:	eb eb                	jmp    80104440 <sys_dup+0x39>
...
80104468:	e8 4a fd ff ff       	call   801041b7 <argfd>
...
8010447a:	e8 1e fc ff ff       	call   8010409d <argint>
...
80104492:	e8 2e fc ff ff       	call   801040c5 <argptr>
...
801044aa:	e8 21 c9 ff ff       	call   80100dd0 <fileread>
...
801044ce:	e8 e4 fc ff ff       	call   801041b7 <argfd>
...
801044e0:	e8 b8 fb ff ff       	call   8010409d <argint>
...
801044f8:	e8 c8 fb ff ff       	call   801040c5 <argptr>
...
80104510:	e8 40 c9 ff ff       	call   80100e55 <filewrite>
...
80104532:	e8 80 fc ff ff       	call   801041b7 <argfd>
80104537:	85 c0                	test   %eax,%eax
80104539:	78 25                	js     80104560 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
8010453b:	e8 90 ec ff ff       	call   801031d0 <myproc>
80104540:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104543:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
8010454a:	00 
  fileclose(f);
8010454b:	83 ec 0c             	sub    $0xc,%esp
8010454e:	ff 75 f0             	push   -0x10(%ebp)
80104551:	e8 6d c7 ff ff       	call   80100cc3 <fileclose>
  return 0;
...
8010457a:	e8 38 fc ff ff       	call   801041b7 <argfd>
...
8010458e:	e8 32 fb ff ff       	call   801040c5 <argptr>
...
801045a3:	e8 e1 c7 ff ff       	call   80100d89 <filestat>
...
801045c2:	e8 66 fb ff ff       	call   8010412d <argstr>
801045c7:	83 c4 10             	add    $0x10,%esp
801045ca:	85 c0                	test   %eax,%eax
801045cc:	0f 88 d3 00 00 00    	js     801046a5 <sys_link+0xf1>
801045d2:	83 ec 08             	sub    $0x8,%esp
801045d5:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801045d8:	50                   	push   %eax
801045d9:	6a 01                	push   $0x1
801045db:	e8 4d fb ff ff       	call   8010412d <argstr>
801045e0:	83 c4 10             	add    $0x10,%esp
801045e3:	85 c0                	test   %eax,%eax
801045e5:	0f 88 ba 00 00 00    	js     801046a5 <sys_link+0xf1>
  begin_op();
801045eb:	e8 8e e1 ff ff       	call   8010277e <begin_op>
  if((ip = namei(old)) == 0){
801045f0:	83 ec 0c             	sub    $0xc,%esp
801045f3:	ff 75 e0             	push   -0x20(%ebp)
801045f6:	e8 d2 d5 ff ff       	call   80101bcd <namei>
801045fb:	89 c3                	mov    %eax,%ebx
801045fd:	83 c4 10             	add    $0x10,%esp
80104600:	85 c0                	test   %eax,%eax
80104602:	0f 84 a4 00 00 00    	je     801046ac <sys_link+0xf8>
  ilock(ip);
80104608:	83 ec 0c             	sub    $0xc,%esp
8010460b:	50                   	push   %eax
8010460c:	e8 5e cf ff ff       	call   8010156f <ilock>
  if(ip->type == T_DIR){
80104611:	83 c4 10             	add    $0x10,%esp
80104614:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104619:	0f 84 99 00 00 00    	je     801046b8 <sys_link+0x104>
  ip->nlink++;
8010461f:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104623:	83 c0 01             	add    $0x1,%eax
80104626:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010462a:	83 ec 0c             	sub    $0xc,%esp
8010462d:	53                   	push   %ebx
8010462e:	e8 db cd ff ff       	call   8010140e <iupdate>
  iunlock(ip);
80104633:	89 1c 24             	mov    %ebx,(%esp)
80104636:	e8 f6 cf ff ff       	call   80101631 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
8010463b:	83 c4 08             	add    $0x8,%esp
8010463e:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104641:	50                   	push   %eax
80104642:	ff 75 e4             	push   -0x1c(%ebp)
80104645:	e8 9b d5 ff ff       	call   80101be5 <nameiparent>
8010464a:	89 c6                	mov    %eax,%esi
8010464c:	83 c4 10             	add    $0x10,%esp
8010464f:	85 c0                	test   %eax,%eax
80104651:	0f 84 85 00 00 00    	je     801046dc <sys_link+0x128>
  ilock(dp);
80104657:	83 ec 0c             	sub    $0xc,%esp
8010465a:	50                   	push   %eax
8010465b:	e8 0f cf ff ff       	call   8010156f <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104660:	83 c4 10             	add    $0x10,%esp
80104663:	8b 03                	mov    (%ebx),%eax
80104665:	39 06                	cmp    %eax,(%esi)
80104667:	75 67                	jne    801046d0 <sys_link+0x11c>
80104669:	83 ec 04             	sub    $0x4,%esp
8010466c:	ff 73 04             	push   0x4(%ebx)
8010466f:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104672:	50                   	push   %eax
80104673:	56                   	push   %esi
80104674:	e8 a3 d4 ff ff       	call   80101b1c <dirlink>
80104679:	83 c4 10             	add    $0x10,%esp
8010467c:	85 c0                	test   %eax,%eax
8010467e:	78 50                	js     801046d0 <sys_link+0x11c>
  iunlockput(dp);
...
8010468c:	e8 e5 cf ff ff       	call   80101676 <iput>
  end_op();
...
801046aa:	eb f2                	jmp    8010469e <sys_link+0xea>
    end_op();
801046ac:	e8 47 e1 ff ff       	call   801027f8 <end_op>
    return -1;
801046b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046b6:	eb e6                	jmp    8010469e <sys_link+0xea>
    iunlockput(ip);
801046b8:	83 ec 0c             	sub    $0xc,%esp
801046bb:	53                   	push   %ebx
801046bc:	e8 55 d0 ff ff       	call   80101716 <iunlockput>
    end_op();
801046c1:	e8 32 e1 ff ff       	call   801027f8 <end_op>
    return -1;
801046c6:	83 c4 10             	add    $0x10,%esp
801046c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046ce:	eb ce                	jmp    8010469e <sys_link+0xea>
    iunlockput(dp);
801046d0:	83 ec 0c             	sub    $0xc,%esp
801046d3:	56                   	push   %esi
801046d4:	e8 3d d0 ff ff       	call   80101716 <iunlockput>
    goto bad;
801046d9:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
801046dc:	83 ec 0c             	sub    $0xc,%esp
801046df:	53                   	push   %ebx
801046e0:	e8 8a ce ff ff       	call   8010156f <ilock>
  ip->nlink--;
801046e5:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801046e9:	83 e8 01             	sub    $0x1,%eax
801046ec:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801046f0:	89 1c 24             	mov    %ebx,(%esp)
801046f3:	e8 16 cd ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
801046f8:	89 1c 24             	mov    %ebx,(%esp)
801046fb:	e8 16 d0 ff ff       	call   80101716 <iunlockput>
  end_op();
80104700:	e8 f3 e0 ff ff       	call   801027f8 <end_op>
  return -1;
80104705:	83 c4 10             	add    $0x10,%esp
80104708:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010470d:	eb 8f                	jmp    8010469e <sys_link+0xea>
...
80104715:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
80104718:	8d 45 c4             	lea    -0x3c(%ebp),%eax
8010471b:	50                   	push   %eax
8010471c:	6a 00                	push   $0x0
8010471e:	e8 0a fa ff ff       	call   8010412d <argstr>
80104723:	83 c4 10             	add    $0x10,%esp
80104726:	85 c0                	test   %eax,%eax
80104728:	0f 88 83 01 00 00    	js     801048b1 <sys_unlink+0x1a2>
  begin_op();
8010472e:	e8 4b e0 ff ff       	call   8010277e <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104733:	83 ec 08             	sub    $0x8,%esp
80104736:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104739:	50                   	push   %eax
8010473a:	ff 75 c4             	push   -0x3c(%ebp)
8010473d:	e8 a3 d4 ff ff       	call   80101be5 <nameiparent>
80104742:	89 c6                	mov    %eax,%esi
80104744:	83 c4 10             	add    $0x10,%esp
80104747:	85 c0                	test   %eax,%eax
80104749:	0f 84 ed 00 00 00    	je     8010483c <sys_unlink+0x12d>
  ilock(dp);
8010474f:	83 ec 0c             	sub    $0xc,%esp
80104752:	50                   	push   %eax
80104753:	e8 17 ce ff ff       	call   8010156f <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104758:	83 c4 08             	add    $0x8,%esp
8010475b:	68 4a 6f 10 80       	push   $0x80106f4a
80104760:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104763:	50                   	push   %eax
80104764:	e8 21 d2 ff ff       	call   8010198a <namecmp>
80104769:	83 c4 10             	add    $0x10,%esp
8010476c:	85 c0                	test   %eax,%eax
8010476e:	0f 84 fc 00 00 00    	je     80104870 <sys_unlink+0x161>
80104774:	83 ec 08             	sub    $0x8,%esp
80104777:	68 49 6f 10 80       	push   $0x80106f49
8010477c:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010477f:	50                   	push   %eax
80104780:	e8 05 d2 ff ff       	call   8010198a <namecmp>
80104785:	83 c4 10             	add    $0x10,%esp
80104788:	85 c0                	test   %eax,%eax
8010478a:	0f 84 e0 00 00 00    	je     80104870 <sys_unlink+0x161>
...
8010479c:	e8 fe d1 ff ff       	call   8010199f <dirlookup>
801047a1:	89 c3                	mov    %eax,%ebx
801047a3:	83 c4 10             	add    $0x10,%esp
801047a6:	85 c0                	test   %eax,%eax
801047a8:	0f 84 c2 00 00 00    	je     80104870 <sys_unlink+0x161>
  ilock(ip);
801047ae:	83 ec 0c             	sub    $0xc,%esp
801047b1:	50                   	push   %eax
801047b2:	e8 b8 cd ff ff       	call   8010156f <ilock>
  if(ip->nlink < 1)
801047b7:	83 c4 10             	add    $0x10,%esp
801047ba:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801047bf:	0f 8e 83 00 00 00    	jle    80104848 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
801047c5:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801047ca:	0f 84 85 00 00 00    	je     80104855 <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
801047d0:	83 ec 04             	sub    $0x4,%esp
801047d3:	6a 10                	push   $0x10
801047d5:	6a 00                	push   $0x0
801047d7:	8d 7d d8             	lea    -0x28(%ebp),%edi
801047da:	57                   	push   %edi
801047db:	e8 6d f6 ff ff       	call   80103e4d <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801047e0:	6a 10                	push   $0x10
801047e2:	ff 75 c0             	push   -0x40(%ebp)
801047e5:	57                   	push   %edi
801047e6:	56                   	push   %esi
801047e7:	e8 72 d0 ff ff       	call   8010185e <writei>
801047ec:	83 c4 20             	add    $0x20,%esp
801047ef:	83 f8 10             	cmp    $0x10,%eax
801047f2:	0f 85 90 00 00 00    	jne    80104888 <sys_unlink+0x179>
  if(ip->type == T_DIR){
801047f8:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801047fd:	0f 84 92 00 00 00    	je     80104895 <sys_unlink+0x186>
  iunlockput(dp);
80104803:	83 ec 0c             	sub    $0xc,%esp
80104806:	56                   	push   %esi
80104807:	e8 0a cf ff ff       	call   80101716 <iunlockput>
  ip->nlink--;
8010480c:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104810:	83 e8 01             	sub    $0x1,%eax
80104813:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104817:	89 1c 24             	mov    %ebx,(%esp)
8010481a:	e8 ef cb ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
8010481f:	89 1c 24             	mov    %ebx,(%esp)
80104822:	e8 ef ce ff ff       	call   80101716 <iunlockput>
  end_op();
80104827:	e8 cc df ff ff       	call   801027f8 <end_op>
  return 0;
8010482c:	83 c4 10             	add    $0x10,%esp
8010482f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104834:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104837:	5b                   	pop    %ebx
80104838:	5e                   	pop    %esi
80104839:	5f                   	pop    %edi
8010483a:	5d                   	pop    %ebp
...
80104846:	eb ec                	jmp    80104834 <sys_unlink+0x125>
    panic("unlink: nlink < 1");
80104848:	83 ec 0c             	sub    $0xc,%esp
8010484b:	68 68 6f 10 80       	push   $0x80106f68
80104850:	e8 f3 ba ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104855:	89 d8                	mov    %ebx,%eax
80104857:	e8 f1 f9 ff ff       	call   8010424d <isdirempty>
8010485c:	85 c0                	test   %eax,%eax
8010485e:	0f 85 6c ff ff ff    	jne    801047d0 <sys_unlink+0xc1>
    iunlockput(ip);
...
80104886:	eb ac                	jmp    80104834 <sys_unlink+0x125>
    panic("unlink: writei");
80104888:	83 ec 0c             	sub    $0xc,%esp
8010488b:	68 7a 6f 10 80       	push   $0x80106f7a
80104890:	e8 b3 ba ff ff       	call   80100348 <panic>
    dp->nlink--;
80104895:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104899:	83 e8 01             	sub    $0x1,%eax
8010489c:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
801048a0:	83 ec 0c             	sub    $0xc,%esp
801048a3:	56                   	push   %esi
801048a4:	e8 65 cb ff ff       	call   8010140e <iupdate>
801048a9:	83 c4 10             	add    $0x10,%esp
801048ac:	e9 52 ff ff ff       	jmp    80104803 <sys_unlink+0xf4>
    return -1;
801048b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801048b6:	e9 79 ff ff ff       	jmp    80104834 <sys_unlink+0x125>
...
801048c1:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
801048c4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801048c7:	50                   	push   %eax
801048c8:	6a 00                	push   $0x0
801048ca:	e8 5e f8 ff ff       	call   8010412d <argstr>
801048cf:	83 c4 10             	add    $0x10,%esp
801048d2:	85 c0                	test   %eax,%eax
801048d4:	0f 88 a0 00 00 00    	js     8010497a <sys_open+0xbf>
801048da:	83 ec 08             	sub    $0x8,%esp
801048dd:	8d 45 e0             	lea    -0x20(%ebp),%eax
801048e0:	50                   	push   %eax
801048e1:	6a 01                	push   $0x1
801048e3:	e8 b5 f7 ff ff       	call   8010409d <argint>
801048e8:	83 c4 10             	add    $0x10,%esp
801048eb:	85 c0                	test   %eax,%eax
801048ed:	0f 88 87 00 00 00    	js     8010497a <sys_open+0xbf>
    return -1;

  begin_op();
801048f3:	e8 86 de ff ff       	call   8010277e <begin_op>

  if(omode & O_CREATE){
801048f8:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
801048fc:	0f 84 8b 00 00 00    	je     8010498d <sys_open+0xd2>
    ip = create(path, T_FILE, 0, 0);
80104902:	83 ec 0c             	sub    $0xc,%esp
80104905:	6a 00                	push   $0x0
80104907:	b9 00 00 00 00       	mov    $0x0,%ecx
8010490c:	ba 02 00 00 00       	mov    $0x2,%edx
80104911:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104914:	e8 8b f9 ff ff       	call   801042a4 <create>
80104919:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010491b:	83 c4 10             	add    $0x10,%esp
8010491e:	85 c0                	test   %eax,%eax
80104920:	74 5f                	je     80104981 <sys_open+0xc6>
      end_op();
      return -1;
    }
  }
...
80104922:	e8 f6 c2 ff ff       	call   80100c1d <filealloc>
80104927:	89 c3                	mov    %eax,%ebx
80104929:	85 c0                	test   %eax,%eax
8010492b:	0f 84 b5 00 00 00    	je     801049e6 <sys_open+0x12b>
80104931:	e8 e1 f8 ff ff       	call   80104217 <fdalloc>
80104936:	89 c7                	mov    %eax,%edi
80104938:	85 c0                	test   %eax,%eax
8010493a:	0f 88 a6 00 00 00    	js     801049e6 <sys_open+0x12b>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
80104944:	e8 e8 cc ff ff       	call   80101631 <iunlock>
  end_op();
80104949:	e8 aa de ff ff       	call   801027f8 <end_op>

  f->type = FD_INODE;
8010494e:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
80104954:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104957:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
8010495e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104961:	83 c4 10             	add    $0x10,%esp
80104964:	a8 01                	test   $0x1,%al
80104966:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010496a:	a8 03                	test   $0x3,%al
8010496c:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104970:	89 f8                	mov    %edi,%eax
...
80104979:	c3                   	ret    
    return -1;
8010497a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010497f:	eb ef                	jmp    80104970 <sys_open+0xb5>
      end_op();
80104981:	e8 72 de ff ff       	call   801027f8 <end_op>
      return -1;
80104986:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010498b:	eb e3                	jmp    80104970 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
8010498d:	83 ec 0c             	sub    $0xc,%esp
80104990:	ff 75 e4             	push   -0x1c(%ebp)
80104993:	e8 35 d2 ff ff       	call   80101bcd <namei>
80104998:	89 c6                	mov    %eax,%esi
8010499a:	83 c4 10             	add    $0x10,%esp
8010499d:	85 c0                	test   %eax,%eax
8010499f:	74 39                	je     801049da <sys_open+0x11f>
    ilock(ip);
801049a1:	83 ec 0c             	sub    $0xc,%esp
801049a4:	50                   	push   %eax
801049a5:	e8 c5 cb ff ff       	call   8010156f <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801049aa:	83 c4 10             	add    $0x10,%esp
801049ad:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801049b2:	0f 85 6a ff ff ff    	jne    80104922 <sys_open+0x67>
801049b8:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801049bc:	0f 84 60 ff ff ff    	je     80104922 <sys_open+0x67>
      iunlockput(ip);
801049c2:	83 ec 0c             	sub    $0xc,%esp
801049c5:	56                   	push   %esi
801049c6:	e8 4b cd ff ff       	call   80101716 <iunlockput>
      end_op();
801049cb:	e8 28 de ff ff       	call   801027f8 <end_op>
      return -1;
801049d0:	83 c4 10             	add    $0x10,%esp
801049d3:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801049d8:	eb 96                	jmp    80104970 <sys_open+0xb5>
      end_op();
801049da:	e8 19 de ff ff       	call   801027f8 <end_op>
      return -1;
801049df:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801049e4:	eb 8a                	jmp    80104970 <sys_open+0xb5>
    if(f)
801049e6:	85 db                	test   %ebx,%ebx
801049e8:	74 0c                	je     801049f6 <sys_open+0x13b>
      fileclose(f);
801049ea:	83 ec 0c             	sub    $0xc,%esp
801049ed:	53                   	push   %ebx
801049ee:	e8 d0 c2 ff ff       	call   80100cc3 <fileclose>
801049f3:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801049f6:	83 ec 0c             	sub    $0xc,%esp
801049f9:	56                   	push   %esi
801049fa:	e8 17 cd ff ff       	call   80101716 <iunlockput>
    end_op();
801049ff:	e8 f4 dd ff ff       	call   801027f8 <end_op>
    return -1;
80104a04:	83 c4 10             	add    $0x10,%esp
80104a07:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104a0c:	e9 5f ff ff ff       	jmp    80104970 <sys_open+0xb5>
...
80104a14:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80104a17:	e8 62 dd ff ff       	call   8010277e <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80104a1c:	83 ec 08             	sub    $0x8,%esp
80104a1f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104a22:	50                   	push   %eax
80104a23:	6a 00                	push   $0x0
80104a25:	e8 03 f7 ff ff       	call   8010412d <argstr>
80104a2a:	83 c4 10             	add    $0x10,%esp
80104a2d:	85 c0                	test   %eax,%eax
80104a2f:	78 36                	js     80104a67 <sys_mkdir+0x56>
80104a31:	83 ec 0c             	sub    $0xc,%esp
80104a34:	6a 00                	push   $0x0
80104a36:	b9 00 00 00 00       	mov    $0x0,%ecx
80104a3b:	ba 01 00 00 00       	mov    $0x1,%edx
80104a40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a43:	e8 5c f8 ff ff       	call   801042a4 <create>
80104a48:	83 c4 10             	add    $0x10,%esp
80104a4b:	85 c0                	test   %eax,%eax
80104a4d:	74 18                	je     80104a67 <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104a53:	e8 be cc ff ff       	call   80101716 <iunlockput>
  end_op();
80104a58:	e8 9b dd ff ff       	call   801027f8 <end_op>
  return 0;
...
80104a71:	eb f2                	jmp    80104a65 <sys_mkdir+0x54>
...
80104a76:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80104a79:	e8 00 dd ff ff       	call   8010277e <begin_op>
  if((argstr(0, &path)) < 0 ||
80104a7e:	83 ec 08             	sub    $0x8,%esp
80104a81:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104a84:	50                   	push   %eax
80104a85:	6a 00                	push   $0x0
80104a87:	e8 a1 f6 ff ff       	call   8010412d <argstr>
80104a8c:	83 c4 10             	add    $0x10,%esp
80104a8f:	85 c0                	test   %eax,%eax
80104a91:	78 62                	js     80104af5 <sys_mknod+0x82>
     argint(1, &major) < 0 ||
80104a93:	83 ec 08             	sub    $0x8,%esp
80104a96:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104a99:	50                   	push   %eax
80104a9a:	6a 01                	push   $0x1
80104a9c:	e8 fc f5 ff ff       	call   8010409d <argint>
  if((argstr(0, &path)) < 0 ||
80104aa1:	83 c4 10             	add    $0x10,%esp
80104aa4:	85 c0                	test   %eax,%eax
80104aa6:	78 4d                	js     80104af5 <sys_mknod+0x82>
     argint(2, &minor) < 0 ||
80104aa8:	83 ec 08             	sub    $0x8,%esp
80104aab:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104aae:	50                   	push   %eax
80104aaf:	6a 02                	push   $0x2
80104ab1:	e8 e7 f5 ff ff       	call   8010409d <argint>
     argint(1, &major) < 0 ||
80104ab6:	83 c4 10             	add    $0x10,%esp
80104ab9:	85 c0                	test   %eax,%eax
80104abb:	78 38                	js     80104af5 <sys_mknod+0x82>
     (ip = create(path, T_DEV, major, minor)) == 0){
80104abd:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
80104ac1:	83 ec 0c             	sub    $0xc,%esp
80104ac4:	0f bf 45 ec          	movswl -0x14(%ebp),%eax
80104ac8:	50                   	push   %eax
80104ac9:	ba 03 00 00 00       	mov    $0x3,%edx
80104ace:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ad1:	e8 ce f7 ff ff       	call   801042a4 <create>
     argint(2, &minor) < 0 ||
80104ad6:	83 c4 10             	add    $0x10,%esp
80104ad9:	85 c0                	test   %eax,%eax
80104adb:	74 18                	je     80104af5 <sys_mknod+0x82>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104ae1:	e8 30 cc ff ff       	call   80101716 <iunlockput>
  end_op();
80104ae6:	e8 0d dd ff ff       	call   801027f8 <end_op>
  return 0;
...
80104af4:	c3                   	ret    
    end_op();
80104af5:	e8 fe dc ff ff       	call   801027f8 <end_op>
    return -1;
80104afa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104aff:	eb f2                	jmp    80104af3 <sys_mknod+0x80>
...
80104b06:	83 ec 10             	sub    $0x10,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80104b09:	e8 c2 e6 ff ff       	call   801031d0 <myproc>
80104b0e:	89 c6                	mov    %eax,%esi
  
  begin_op();
80104b10:	e8 69 dc ff ff       	call   8010277e <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80104b15:	83 ec 08             	sub    $0x8,%esp
80104b18:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b1b:	50                   	push   %eax
80104b1c:	6a 00                	push   $0x0
80104b1e:	e8 0a f6 ff ff       	call   8010412d <argstr>
80104b23:	83 c4 10             	add    $0x10,%esp
80104b26:	85 c0                	test   %eax,%eax
80104b28:	78 52                	js     80104b7c <sys_chdir+0x7b>
80104b2a:	83 ec 0c             	sub    $0xc,%esp
80104b2d:	ff 75 f4             	push   -0xc(%ebp)
80104b30:	e8 98 d0 ff ff       	call   80101bcd <namei>
80104b35:	89 c3                	mov    %eax,%ebx
80104b37:	83 c4 10             	add    $0x10,%esp
80104b3a:	85 c0                	test   %eax,%eax
80104b3c:	74 3e                	je     80104b7c <sys_chdir+0x7b>
    end_op();
    return -1;
  }
  ilock(ip);
...
80104b42:	e8 28 ca ff ff       	call   8010156f <ilock>
  if(ip->type != T_DIR){
80104b47:	83 c4 10             	add    $0x10,%esp
80104b4a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104b4f:	75 37                	jne    80104b88 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104b55:	e8 d7 ca ff ff       	call   80101631 <iunlock>
  iput(curproc->cwd);
80104b5a:	83 c4 04             	add    $0x4,%esp
80104b5d:	ff 76 68             	push   0x68(%esi)
80104b60:	e8 11 cb ff ff       	call   80101676 <iput>
  end_op();
80104b65:	e8 8e dc ff ff       	call   801027f8 <end_op>
  curproc->cwd = ip;
80104b6a:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
80104b6d:	83 c4 10             	add    $0x10,%esp
80104b70:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104b75:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104b78:	5b                   	pop    %ebx
80104b79:	5e                   	pop    %esi
80104b7a:	5d                   	pop    %ebp
80104b7b:	c3                   	ret    
    end_op();
80104b7c:	e8 77 dc ff ff       	call   801027f8 <end_op>
    return -1;
80104b81:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b86:	eb ed                	jmp    80104b75 <sys_chdir+0x74>
    iunlockput(ip);
80104b88:	83 ec 0c             	sub    $0xc,%esp
80104b8b:	53                   	push   %ebx
80104b8c:	e8 85 cb ff ff       	call   80101716 <iunlockput>
    end_op();
80104b91:	e8 62 dc ff ff       	call   801027f8 <end_op>
    return -1;
80104b96:	83 c4 10             	add    $0x10,%esp
80104b99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b9e:	eb d5                	jmp    80104b75 <sys_chdir+0x74>
...
80104ba4:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104bb0:	e8 78 f5 ff ff       	call   8010412d <argstr>
80104bb5:	83 c4 10             	add    $0x10,%esp
80104bb8:	85 c0                	test   %eax,%eax
80104bba:	78 38                	js     80104bf4 <sys_exec+0x54>
80104bbc:	83 ec 08             	sub    $0x8,%esp
80104bbf:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104bc5:	50                   	push   %eax
80104bc6:	6a 01                	push   $0x1
80104bc8:	e8 d0 f4 ff ff       	call   8010409d <argint>
80104bcd:	83 c4 10             	add    $0x10,%esp
80104bd0:	85 c0                	test   %eax,%eax
80104bd2:	78 20                	js     80104bf4 <sys_exec+0x54>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104bd4:	83 ec 04             	sub    $0x4,%esp
80104bd7:	68 80 00 00 00       	push   $0x80
80104bdc:	6a 00                	push   $0x0
80104bde:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104be4:	50                   	push   %eax
80104be5:	e8 63 f2 ff ff       	call   80103e4d <memset>
80104bea:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104bed:	bb 00 00 00 00       	mov    $0x0,%ebx
80104bf2:	eb 2c                	jmp    80104c20 <sys_exec+0x80>
    return -1;
80104bf4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bf9:	eb 78                	jmp    80104c73 <sys_exec+0xd3>
    if(i >= NELEM(argv))
      return -1;
    ...
    if(uarg == 0){
      argv[i] = 0;
80104bfb:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104c02:	00 00 00 00 
      break;
    }
...
80104c09:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104c0f:	50                   	push   %eax
80104c10:	ff 75 f4             	push   -0xc(%ebp)
80104c13:	e8 b6 bc ff ff       	call   801008ce <exec>
80104c18:	83 c4 10             	add    $0x10,%esp
80104c1b:	eb 56                	jmp    80104c73 <sys_exec+0xd3>
  for(i=0;; i++){
80104c1d:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104c20:	83 fb 1f             	cmp    $0x1f,%ebx
80104c23:	77 49                	ja     80104c6e <sys_exec+0xce>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104c25:	83 ec 08             	sub    $0x8,%esp
80104c28:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104c2e:	50                   	push   %eax
80104c2f:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104c35:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104c38:	50                   	push   %eax
80104c39:	e8 e5 f3 ff ff       	call   80104023 <fetchint>
80104c3e:	83 c4 10             	add    $0x10,%esp
80104c41:	85 c0                	test   %eax,%eax
80104c43:	78 33                	js     80104c78 <sys_exec+0xd8>
    if(uarg == 0){
80104c45:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104c4b:	85 c0                	test   %eax,%eax
80104c4d:	74 ac                	je     80104bfb <sys_exec+0x5b>
    if(fetchstr(uarg, &argv[i]) < 0)
80104c4f:	83 ec 08             	sub    $0x8,%esp
80104c52:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104c59:	52                   	push   %edx
80104c5a:	50                   	push   %eax
80104c5b:	e8 fe f3 ff ff       	call   8010405e <fetchstr>
80104c60:	83 c4 10             	add    $0x10,%esp
80104c63:	85 c0                	test   %eax,%eax
80104c65:	79 b6                	jns    80104c1d <sys_exec+0x7d>
      return -1;
80104c67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c6c:	eb 05                	jmp    80104c73 <sys_exec+0xd3>
      return -1;
...
80104c7d:	eb f4                	jmp    80104c73 <sys_exec+0xd3>
...
80104c86:	6a 08                	push   $0x8
80104c88:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104c8b:	50                   	push   %eax
80104c8c:	6a 00                	push   $0x0
80104c8e:	e8 32 f4 ff ff       	call   801040c5 <argptr>
80104c93:	83 c4 10             	add    $0x10,%esp
80104c96:	85 c0                	test   %eax,%eax
80104c98:	78 79                	js     80104d13 <sys_pipe+0x94>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104c9a:	83 ec 08             	sub    $0x8,%esp
80104c9d:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104ca0:	50                   	push   %eax
80104ca1:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104ca4:	50                   	push   %eax
80104ca5:	e8 5d e0 ff ff       	call   80102d07 <pipealloc>
80104caa:	83 c4 10             	add    $0x10,%esp
80104cad:	85 c0                	test   %eax,%eax
80104caf:	78 69                	js     80104d1a <sys_pipe+0x9b>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104cb1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cb4:	e8 5e f5 ff ff       	call   80104217 <fdalloc>
80104cb9:	89 c3                	mov    %eax,%ebx
80104cbb:	85 c0                	test   %eax,%eax
80104cbd:	78 21                	js     80104ce0 <sys_pipe+0x61>
80104cbf:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104cc2:	e8 50 f5 ff ff       	call   80104217 <fdalloc>
80104cc7:	85 c0                	test   %eax,%eax
80104cc9:	78 15                	js     80104ce0 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104cce:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104cd0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104cd3:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
80104cd6:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104cdb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104cde:	c9                   	leave  
80104cdf:	c3                   	ret    
    if(fd0 >= 0)
80104ce0:	85 db                	test   %ebx,%ebx
80104ce2:	79 20                	jns    80104d04 <sys_pipe+0x85>
    fileclose(rf);
80104ce4:	83 ec 0c             	sub    $0xc,%esp
80104ce7:	ff 75 f0             	push   -0x10(%ebp)
80104cea:	e8 d4 bf ff ff       	call   80100cc3 <fileclose>
    fileclose(wf);
80104cef:	83 c4 04             	add    $0x4,%esp
80104cf2:	ff 75 ec             	push   -0x14(%ebp)
80104cf5:	e8 c9 bf ff ff       	call   80100cc3 <fileclose>
    return -1;
80104cfa:	83 c4 10             	add    $0x10,%esp
80104cfd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d02:	eb d7                	jmp    80104cdb <sys_pipe+0x5c>
      myproc()->ofile[fd0] = 0;
80104d04:	e8 c7 e4 ff ff       	call   801031d0 <myproc>
80104d09:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104d10:	00 
80104d11:	eb d1                	jmp    80104ce4 <sys_pipe+0x65>
    return -1;
80104d13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d18:	eb c1                	jmp    80104cdb <sys_pipe+0x5c>
    return -1;
80104d1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d1f:	eb ba                	jmp    80104cdb <sys_pipe+0x5c>
...
80104d24:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104d27:	e8 2b e6 ff ff       	call   80103357 <fork>
}
80104d2c:	c9                   	leave  
80104d2d:	c3                   	ret    
...
80104d31:	83 ec 08             	sub    $0x8,%esp
  exit();
80104d34:	e8 9c e9 ff ff       	call   801036d5 <exit>
...
80104d43:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104d46:	e8 16 eb ff ff       	call   80103861 <wait>
}
80104d4b:	c9                   	leave  
80104d4c:	c3                   	ret    
...
80104d50:	83 ec 20             	sub    $0x20,%esp
  int pid;

  if(argint(0, &pid) < 0)
80104d53:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d56:	50                   	push   %eax
80104d57:	6a 00                	push   $0x0
80104d59:	e8 3f f3 ff ff       	call   8010409d <argint>
80104d5e:	83 c4 10             	add    $0x10,%esp
80104d61:	85 c0                	test   %eax,%eax
80104d63:	78 10                	js     80104d75 <sys_kill+0x28>
    return -1;
  return kill(pid);
80104d65:	83 ec 0c             	sub    $0xc,%esp
80104d68:	ff 75 f4             	push   -0xc(%ebp)
80104d6b:	e8 06 ec ff ff       	call   80103976 <kill>
...
80104d7a:	eb f7                	jmp    80104d73 <sys_kill+0x26>
...
80104d7f:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104d82:	e8 49 e4 ff ff       	call   801031d0 <myproc>
80104d87:	8b 40 10             	mov    0x10(%eax),%eax
}
80104d8a:	c9                   	leave  
80104d8b:	c3                   	ret    
...
80104d90:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  int n;
...
80104d99:	e8 ff f2 ff ff       	call   8010409d <argint>
80104d9e:	83 c4 10             	add    $0x10,%esp
80104da1:	85 c0                	test   %eax,%eax
80104da3:	78 20                	js     80104dc5 <sys_sbrk+0x39>
    return -1;
  addr = myproc()->sz;
80104da5:	e8 26 e4 ff ff       	call   801031d0 <myproc>
80104daa:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104dac:	83 ec 0c             	sub    $0xc,%esp
80104daf:	ff 75 f4             	push   -0xc(%ebp)
80104db2:	e8 35 e5 ff ff       	call   801032ec <growproc>
80104db7:	83 c4 10             	add    $0x10,%esp
80104dba:	85 c0                	test   %eax,%eax
80104dbc:	78 0e                	js     80104dcc <sys_sbrk+0x40>
    return -1;
  return addr;
}
...
80104dc4:	c3                   	ret    
    return -1;
80104dc5:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104dca:	eb f2                	jmp    80104dbe <sys_sbrk+0x32>
    return -1;
80104dcc:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104dd1:	eb eb                	jmp    80104dbe <sys_sbrk+0x32>
...
80104dd7:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;

  if(argint(0, &n) < 0)
80104dda:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ddd:	50                   	push   %eax
80104dde:	6a 00                	push   $0x0
80104de0:	e8 b8 f2 ff ff       	call   8010409d <argint>
80104de5:	83 c4 10             	add    $0x10,%esp
80104de8:	85 c0                	test   %eax,%eax
80104dea:	78 75                	js     80104e61 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104dec:	83 ec 0c             	sub    $0xc,%esp
80104def:	68 80 3f 11 80       	push   $0x80113f80
80104df4:	e8 a8 ef ff ff       	call   80103da1 <acquire>
  ticks0 = ticks;
80104df9:	8b 1d 60 3f 11 80    	mov    0x80113f60,%ebx
  while(ticks - ticks0 < n){
80104dff:	83 c4 10             	add    $0x10,%esp
80104e02:	a1 60 3f 11 80       	mov    0x80113f60,%eax
80104e07:	29 d8                	sub    %ebx,%eax
80104e09:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104e0c:	73 39                	jae    80104e47 <sys_sleep+0x74>
    if(myproc()->killed){
80104e0e:	e8 bd e3 ff ff       	call   801031d0 <myproc>
80104e13:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104e17:	75 17                	jne    80104e30 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104e19:	83 ec 08             	sub    $0x8,%esp
80104e1c:	68 80 3f 11 80       	push   $0x80113f80
80104e21:	68 60 3f 11 80       	push   $0x80113f60
80104e26:	e8 a5 e9 ff ff       	call   801037d0 <sleep>
80104e2b:	83 c4 10             	add    $0x10,%esp
80104e2e:	eb d2                	jmp    80104e02 <sys_sleep+0x2f>
      release(&tickslock);
80104e30:	83 ec 0c             	sub    $0xc,%esp
80104e33:	68 80 3f 11 80       	push   $0x80113f80
80104e38:	e8 c9 ef ff ff       	call   80103e06 <release>
      return -1;
80104e3d:	83 c4 10             	add    $0x10,%esp
80104e40:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e45:	eb 15                	jmp    80104e5c <sys_sleep+0x89>
  }
  release(&tickslock);
80104e47:	83 ec 0c             	sub    $0xc,%esp
80104e4a:	68 80 3f 11 80       	push   $0x80113f80
80104e4f:	e8 b2 ef ff ff       	call   80103e06 <release>
  return 0;
80104e54:	83 c4 10             	add    $0x10,%esp
80104e57:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104e5c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104e5f:	c9                   	leave  
80104e60:	c3                   	ret    
    return -1;
80104e61:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e66:	eb f4                	jmp    80104e5c <sys_sleep+0x89>
...
80104e6c:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104e6f:	68 80 3f 11 80       	push   $0x80113f80
80104e74:	e8 28 ef ff ff       	call   80103da1 <acquire>
  xticks = ticks;
80104e79:	8b 1d 60 3f 11 80    	mov    0x80113f60,%ebx
  release(&tickslock);
80104e7f:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
80104e86:	e8 7b ef ff ff       	call   80103e06 <release>
  return xticks;
}
...
80104e95:	83 ec 20             	sub    $0x20,%esp
  int numtickets;
...
80104e9e:	e8 fa f1 ff ff       	call   8010409d <argint>
80104ea3:	83 c4 10             	add    $0x10,%esp
80104ea6:	85 c0                	test   %eax,%eax
80104ea8:	78 10                	js     80104eba <sys_settickets+0x28>
    return -1;
  
  return settickets(numtickets);
80104eaa:	83 ec 0c             	sub    $0xc,%esp
80104ead:	ff 75 f4             	push   -0xc(%ebp)
80104eb0:	e8 ec eb ff ff       	call   80103aa1 <settickets>
...
80104ebf:	eb f7                	jmp    80104eb8 <sys_settickets+0x26>

80104ec1 <sys_getpinfo>:
...
80104ec4:	83 ec 1c             	sub    $0x1c,%esp
  struct pstat *pstat;

  if(argptr(0, (void*)&pstat, sizeof(*pstat)) < 0)
80104ec7:	68 00 04 00 00       	push   $0x400
80104ecc:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ecf:	50                   	push   %eax
80104ed0:	6a 00                	push   $0x0
80104ed2:	e8 ee f1 ff ff       	call   801040c5 <argptr>
80104ed7:	83 c4 10             	add    $0x10,%esp
80104eda:	85 c0                	test   %eax,%eax
80104edc:	78 10                	js     80104eee <sys_getpinfo+0x2d>
    return -1;
    
  return getpinfo(pstat);
80104ede:	83 ec 0c             	sub    $0xc,%esp
80104ee1:	ff 75 f4             	push   -0xc(%ebp)
80104ee4:	e8 e0 eb ff ff       	call   80103ac9 <getpinfo>
...
80104ef3:	eb f7                	jmp    80104eec <sys_getpinfo+0x2b>

80104ef5 <sys_mprotect>:
...
80104f02:	06                   	push   %es
  pushl %fs
80104f03:	0f a0                	push   %fs
  pushl %gs
80104f05:	0f a8                	push   %gs
  pushal
80104f07:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104f08:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104f0c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104f0e:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104f10:	54                   	push   %esp
  call trap
80104f11:	e8 37 01 00 00       	call   8010504d <trap>
  addl $4, %esp
80104f16:	83 c4 04             	add    $0x4,%esp
...
80104f19:	61                   	popa   
  popl %gs
80104f1a:	0f a9                	pop    %gs
  popl %fs
80104f1c:	0f a1                	pop    %fs
  popl %es
80104f1e:	07                   	pop    %es
  popl %ds
80104f1f:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104f20:	83 c4 08             	add    $0x8,%esp
  iret
80104f23:	cf                   	iret   
...
80104f30:	eb 76                	jmp    80104fa8 <tvinit+0x84>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104f32:	8b 0c 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%ecx
80104f39:	66 89 0c c5 c0 3f 11 	mov    %cx,-0x7feec040(,%eax,8)
80104f40:	80 
80104f41:	66 c7 04 c5 c2 3f 11 	movw   $0x8,-0x7feec03e(,%eax,8)
80104f48:	80 08 00 
80104f4b:	0f b6 14 c5 c4 3f 11 	movzbl -0x7feec03c(,%eax,8),%edx
80104f52:	80 
80104f53:	83 e2 e0             	and    $0xffffffe0,%edx
80104f56:	88 14 c5 c4 3f 11 80 	mov    %dl,-0x7feec03c(,%eax,8)
80104f5d:	c6 04 c5 c4 3f 11 80 	movb   $0x0,-0x7feec03c(,%eax,8)
80104f64:	00 
80104f65:	0f b6 14 c5 c5 3f 11 	movzbl -0x7feec03b(,%eax,8),%edx
80104f6c:	80 
80104f6d:	83 e2 f0             	and    $0xfffffff0,%edx
80104f70:	83 ca 0e             	or     $0xe,%edx
80104f73:	88 14 c5 c5 3f 11 80 	mov    %dl,-0x7feec03b(,%eax,8)
80104f7a:	89 d3                	mov    %edx,%ebx
80104f7c:	83 e3 ef             	and    $0xffffffef,%ebx
80104f7f:	88 1c c5 c5 3f 11 80 	mov    %bl,-0x7feec03b(,%eax,8)
80104f86:	83 e2 8f             	and    $0xffffff8f,%edx
80104f89:	88 14 c5 c5 3f 11 80 	mov    %dl,-0x7feec03b(,%eax,8)
80104f90:	83 ca 80             	or     $0xffffff80,%edx
80104f93:	88 14 c5 c5 3f 11 80 	mov    %dl,-0x7feec03b(,%eax,8)
80104f9a:	c1 e9 10             	shr    $0x10,%ecx
80104f9d:	66 89 0c c5 c6 3f 11 	mov    %cx,-0x7feec03a(,%eax,8)
80104fa4:	80 
  for(i = 0; i < 256; i++)
80104fa5:	83 c0 01             	add    $0x1,%eax
80104fa8:	3d ff 00 00 00       	cmp    $0xff,%eax
80104fad:	7e 83                	jle    80104f32 <tvinit+0xe>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104faf:	8b 15 08 a1 10 80    	mov    0x8010a108,%edx
80104fb5:	66 89 15 c0 41 11 80 	mov    %dx,0x801141c0
80104fbc:	66 c7 05 c2 41 11 80 	movw   $0x8,0x801141c2
80104fc3:	08 00 
80104fc5:	0f b6 05 c4 41 11 80 	movzbl 0x801141c4,%eax
80104fcc:	83 e0 e0             	and    $0xffffffe0,%eax
80104fcf:	a2 c4 41 11 80       	mov    %al,0x801141c4
80104fd4:	c6 05 c4 41 11 80 00 	movb   $0x0,0x801141c4
80104fdb:	0f b6 05 c5 41 11 80 	movzbl 0x801141c5,%eax
80104fe2:	83 c8 0f             	or     $0xf,%eax
80104fe5:	a2 c5 41 11 80       	mov    %al,0x801141c5
80104fea:	83 e0 ef             	and    $0xffffffef,%eax
80104fed:	a2 c5 41 11 80       	mov    %al,0x801141c5
80104ff2:	89 c1                	mov    %eax,%ecx
80104ff4:	83 c9 60             	or     $0x60,%ecx
80104ff7:	88 0d c5 41 11 80    	mov    %cl,0x801141c5
80104ffd:	83 c8 e0             	or     $0xffffffe0,%eax
80105000:	a2 c5 41 11 80       	mov    %al,0x801141c5
80105005:	c1 ea 10             	shr    $0x10,%edx
80105008:	66 89 15 c6 41 11 80 	mov    %dx,0x801141c6

  initlock(&tickslock, "time");
8010500f:	83 ec 08             	sub    $0x8,%esp
80105012:	68 89 6f 10 80       	push   $0x80106f89
80105017:	68 80 3f 11 80       	push   $0x80113f80
8010501c:	e8 44 ec ff ff       	call   80103c65 <initlock>
}
...
8010502c:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
8010502f:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80105035:	b8 c0 3f 11 80       	mov    $0x80113fc0,%eax
8010503a:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010503e:	c1 e8 10             	shr    $0x10,%eax
80105041:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105045:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105048:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
8010504b:	c9                   	leave  
8010504c:	c3                   	ret    
...
8010505f:	74 13                	je     80105074 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105067:	0f 87 3a 01 00 00    	ja     801051a7 <trap+0x15a>
8010506d:	ff 24 85 30 70 10 80 	jmp    *-0x7fef8fd0(,%eax,4)
    if(myproc()->killed)
80105074:	e8 57 e1 ff ff       	call   801031d0 <myproc>
80105079:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
8010507d:	75 1f                	jne    8010509e <trap+0x51>
    myproc()->tf = tf;
8010507f:	e8 4c e1 ff ff       	call   801031d0 <myproc>
80105084:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105087:	e8 d4 f0 ff ff       	call   80104160 <syscall>
    if(myproc()->killed)
8010508c:	e8 3f e1 ff ff       	call   801031d0 <myproc>
80105091:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105095:	74 7e                	je     80105115 <trap+0xc8>
      exit();
80105097:	e8 39 e6 ff ff       	call   801036d5 <exit>
    return;
8010509c:	eb 77                	jmp    80105115 <trap+0xc8>
      exit();
8010509e:	e8 32 e6 ff ff       	call   801036d5 <exit>
801050a3:	eb da                	jmp    8010507f <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801050a5:	e8 0b e1 ff ff       	call   801031b5 <cpuid>
801050aa:	85 c0                	test   %eax,%eax
801050ac:	74 6f                	je     8010511d <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
801050ae:	e8 c3 d2 ff ff       	call   80102376 <lapiceoi>
  }
...
801050ba:	74 1c                	je     801050d8 <trap+0x8b>
801050bc:	e8 0f e1 ff ff       	call   801031d0 <myproc>
801050c1:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
801050c5:	74 11                	je     801050d8 <trap+0x8b>
801050c7:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801050cb:	83 e0 03             	and    $0x3,%eax
801050ce:	66 83 f8 03          	cmp    $0x3,%ax
801050d2:	0f 84 62 01 00 00    	je     8010523a <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801050d8:	e8 f3 e0 ff ff       	call   801031d0 <myproc>
801050dd:	85 c0                	test   %eax,%eax
801050df:	74 0f                	je     801050f0 <trap+0xa3>
801050e1:	e8 ea e0 ff ff       	call   801031d0 <myproc>
801050e6:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801050ea:	0f 84 54 01 00 00    	je     80105244 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801050f0:	e8 db e0 ff ff       	call   801031d0 <myproc>
801050f5:	85 c0                	test   %eax,%eax
801050f7:	74 1c                	je     80105115 <trap+0xc8>
801050f9:	e8 d2 e0 ff ff       	call   801031d0 <myproc>
801050fe:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105102:	74 11                	je     80105115 <trap+0xc8>
80105104:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105108:	83 e0 03             	and    $0x3,%eax
8010510b:	66 83 f8 03          	cmp    $0x3,%ax
8010510f:	0f 84 43 01 00 00    	je     80105258 <trap+0x20b>
    exit();
}
...
80105120:	68 80 3f 11 80       	push   $0x80113f80
80105125:	e8 77 ec ff ff       	call   80103da1 <acquire>
      ticks++;
8010512a:	83 05 60 3f 11 80 01 	addl   $0x1,0x80113f60
      wakeup(&ticks);
80105131:	c7 04 24 60 3f 11 80 	movl   $0x80113f60,(%esp)
80105138:	e8 10 e8 ff ff       	call   8010394d <wakeup>
      release(&tickslock);
8010513d:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
80105144:	e8 bd ec ff ff       	call   80103e06 <release>
80105149:	83 c4 10             	add    $0x10,%esp
8010514c:	e9 5d ff ff ff       	jmp    801050ae <trap+0x61>
    ideintr();
80105151:	e8 06 cc ff ff       	call   80101d5c <ideintr>
    lapiceoi();
80105156:	e8 1b d2 ff ff       	call   80102376 <lapiceoi>
    break;
8010515b:	e9 53 ff ff ff       	jmp    801050b3 <trap+0x66>
    kbdintr();
80105160:	e8 5b d0 ff ff       	call   801021c0 <kbdintr>
    lapiceoi();
80105165:	e8 0c d2 ff ff       	call   80102376 <lapiceoi>
    break;
8010516a:	e9 44 ff ff ff       	jmp    801050b3 <trap+0x66>
    uartintr();
8010516f:	e8 fe 01 00 00       	call   80105372 <uartintr>
    lapiceoi();
80105174:	e8 fd d1 ff ff       	call   80102376 <lapiceoi>
    break;
80105179:	e9 35 ff ff ff       	jmp    801050b3 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010517e:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105181:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105185:	e8 2b e0 ff ff       	call   801031b5 <cpuid>
8010518a:	57                   	push   %edi
8010518b:	0f b7 f6             	movzwl %si,%esi
8010518e:	56                   	push   %esi
8010518f:	50                   	push   %eax
80105190:	68 94 6f 10 80       	push   $0x80106f94
80105195:	e8 6d b4 ff ff       	call   80100607 <cprintf>
    lapiceoi();
8010519a:	e8 d7 d1 ff ff       	call   80102376 <lapiceoi>
    break;
8010519f:	83 c4 10             	add    $0x10,%esp
801051a2:	e9 0c ff ff ff       	jmp    801050b3 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
801051a7:	e8 24 e0 ff ff       	call   801031d0 <myproc>
801051ac:	85 c0                	test   %eax,%eax
801051ae:	74 5f                	je     8010520f <trap+0x1c2>
801051b0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801051b4:	74 59                	je     8010520f <trap+0x1c2>
...
801051b6:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801051b9:	8b 43 38             	mov    0x38(%ebx),%eax
801051bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801051bf:	e8 f1 df ff ff       	call   801031b5 <cpuid>
801051c4:	89 45 e0             	mov    %eax,-0x20(%ebp)
801051c7:	8b 53 34             	mov    0x34(%ebx),%edx
801051ca:	89 55 dc             	mov    %edx,-0x24(%ebp)
801051cd:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
801051d0:	e8 fb df ff ff       	call   801031d0 <myproc>
801051d5:	8d 48 6c             	lea    0x6c(%eax),%ecx
801051d8:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801051db:	e8 f0 df ff ff       	call   801031d0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801051e0:	57                   	push   %edi
801051e1:	ff 75 e4             	push   -0x1c(%ebp)
801051e4:	ff 75 e0             	push   -0x20(%ebp)
801051e7:	ff 75 dc             	push   -0x24(%ebp)
801051ea:	56                   	push   %esi
801051eb:	ff 75 d8             	push   -0x28(%ebp)
801051ee:	ff 70 10             	push   0x10(%eax)
801051f1:	68 ec 6f 10 80       	push   $0x80106fec
801051f6:	e8 0c b4 ff ff       	call   80100607 <cprintf>
    myproc()->killed = 1;
801051fb:	83 c4 20             	add    $0x20,%esp
801051fe:	e8 cd df ff ff       	call   801031d0 <myproc>
80105203:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010520a:	e9 a4 fe ff ff       	jmp    801050b3 <trap+0x66>
8010520f:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105212:	8b 73 38             	mov    0x38(%ebx),%esi
80105215:	e8 9b df ff ff       	call   801031b5 <cpuid>
8010521a:	83 ec 0c             	sub    $0xc,%esp
8010521d:	57                   	push   %edi
8010521e:	56                   	push   %esi
8010521f:	50                   	push   %eax
80105220:	ff 73 30             	push   0x30(%ebx)
80105223:	68 b8 6f 10 80       	push   $0x80106fb8
80105228:	e8 da b3 ff ff       	call   80100607 <cprintf>
      panic("trap");
8010522d:	83 c4 14             	add    $0x14,%esp
80105230:	68 8e 6f 10 80       	push   $0x80106f8e
80105235:	e8 0e b1 ff ff       	call   80100348 <panic>
    exit();
8010523a:	e8 96 e4 ff ff       	call   801036d5 <exit>
8010523f:	e9 94 fe ff ff       	jmp    801050d8 <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105244:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105248:	0f 85 a2 fe ff ff    	jne    801050f0 <trap+0xa3>
    yield();
8010524e:	e8 4b e5 ff ff       	call   8010379e <yield>
80105253:	e9 98 fe ff ff       	jmp    801050f0 <trap+0xa3>
    exit();
80105258:	e8 78 e4 ff ff       	call   801036d5 <exit>
8010525d:	e9 b3 fe ff ff       	jmp    80105115 <trap+0xc8>
...
{
  if(!uart)
80105262:	83 3d c0 47 11 80 00 	cmpl   $0x0,0x801147c0
80105269:	74 14                	je     8010527f <uartgetc+0x1d>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010526b:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105270:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105271:	a8 01                	test   $0x1,%al
80105273:	74 10                	je     80105285 <uartgetc+0x23>
80105275:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010527a:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
...
8010528b <uartputc>:
  if(!uart)
8010528b:	83 3d c0 47 11 80 00 	cmpl   $0x0,0x801147c0
80105292:	74 3b                	je     801052cf <uartputc+0x44>
{
...
8010529b:	bb 00 00 00 00       	mov    $0x0,%ebx
801052a0:	eb 10                	jmp    801052b2 <uartputc+0x27>
    microdelay(10);
801052a2:	83 ec 0c             	sub    $0xc,%esp
801052a5:	6a 0a                	push   $0xa
801052a7:	e8 eb d0 ff ff       	call   80102397 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801052ac:	83 c3 01             	add    $0x1,%ebx
801052af:	83 c4 10             	add    $0x10,%esp
801052b2:	83 fb 7f             	cmp    $0x7f,%ebx
801052b5:	7f 0a                	jg     801052c1 <uartputc+0x36>
801052b7:	ba fd 03 00 00       	mov    $0x3fd,%edx
801052bc:	ec                   	in     (%dx),%al
801052bd:	a8 20                	test   $0x20,%al
801052bf:	74 e1                	je     801052a2 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
801052d5:	b9 00 00 00 00       	mov    $0x0,%ecx
801052da:	ba fa 03 00 00       	mov    $0x3fa,%edx
801052df:	89 c8                	mov    %ecx,%eax
801052e1:	ee                   	out    %al,(%dx)
801052e2:	be fb 03 00 00       	mov    $0x3fb,%esi
801052e7:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801052ec:	89 f2                	mov    %esi,%edx
801052ee:	ee                   	out    %al,(%dx)
801052ef:	b8 0c 00 00 00       	mov    $0xc,%eax
801052f4:	ba f8 03 00 00       	mov    $0x3f8,%edx
801052f9:	ee                   	out    %al,(%dx)
801052fa:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801052ff:	89 c8                	mov    %ecx,%eax
80105301:	89 da                	mov    %ebx,%edx
80105303:	ee                   	out    %al,(%dx)
80105304:	b8 03 00 00 00       	mov    $0x3,%eax
80105309:	89 f2                	mov    %esi,%edx
8010530b:	ee                   	out    %al,(%dx)
8010530c:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105311:	89 c8                	mov    %ecx,%eax
80105313:	ee                   	out    %al,(%dx)
80105314:	b8 01 00 00 00       	mov    $0x1,%eax
80105319:	89 da                	mov    %ebx,%edx
8010531b:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010531c:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105321:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105322:	3c ff                	cmp    $0xff,%al
80105324:	74 45                	je     8010536b <uartinit+0x9b>
  uart = 1;
80105326:	c7 05 c0 47 11 80 01 	movl   $0x1,0x801147c0
8010532d:	00 00 00 
80105330:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105335:	ec                   	in     (%dx),%al
80105336:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010533b:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
8010533c:	83 ec 08             	sub    $0x8,%esp
8010533f:	6a 00                	push   $0x0
80105341:	6a 04                	push   $0x4
80105343:	e8 19 cc ff ff       	call   80101f61 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105348:	83 c4 10             	add    $0x10,%esp
8010534b:	bb b0 70 10 80       	mov    $0x801070b0,%ebx
80105350:	eb 12                	jmp    80105364 <uartinit+0x94>
    uartputc(*p);
80105352:	83 ec 0c             	sub    $0xc,%esp
80105355:	0f be c0             	movsbl %al,%eax
80105358:	50                   	push   %eax
80105359:	e8 2d ff ff ff       	call   8010528b <uartputc>
  for(p="xv6...\n"; *p; p++)
8010535e:	83 c3 01             	add    $0x1,%ebx
80105361:	83 c4 10             	add    $0x10,%esp
80105364:	0f b6 03             	movzbl (%ebx),%eax
80105367:	84 c0                	test   %al,%al
80105369:	75 e7                	jne    80105352 <uartinit+0x82>
}
8010536b:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010536e:	5b                   	pop    %ebx
8010536f:	5e                   	pop    %esi
80105370:	5d                   	pop    %ebp
80105371:	c3                   	ret    
...
80105375:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105378:	68 62 52 10 80       	push   $0x80105262
8010537d:	e8 b1 b3 ff ff       	call   80100733 <consoleintr>
}
...
80105389:	6a 00                	push   $0x0
  jmp alltraps
8010538b:	e9 71 fb ff ff       	jmp    80104f01 <alltraps>
...
80105390:	6a 00                	push   $0x0
  pushl $1
80105392:	6a 01                	push   $0x1
  jmp alltraps
80105394:	e9 68 fb ff ff       	jmp    80104f01 <alltraps>
...
8010539b:	6a 02                	push   $0x2
  jmp alltraps
8010539d:	e9 5f fb ff ff       	jmp    80104f01 <alltraps>
...
801053a2:	6a 00                	push   $0x0
  pushl $3
801053a4:	6a 03                	push   $0x3
  jmp alltraps
801053a6:	e9 56 fb ff ff       	jmp    80104f01 <alltraps>
...
801053ab:	6a 00                	push   $0x0
  pushl $4
801053ad:	6a 04                	push   $0x4
  jmp alltraps
801053af:	e9 4d fb ff ff       	jmp    80104f01 <alltraps>
...
801053b4:	6a 00                	push   $0x0
  pushl $5
801053b6:	6a 05                	push   $0x5
  jmp alltraps
801053b8:	e9 44 fb ff ff       	jmp    80104f01 <alltraps>
...
801053bd:	6a 00                	push   $0x0
  pushl $6
801053bf:	6a 06                	push   $0x6
  jmp alltraps
801053c1:	e9 3b fb ff ff       	jmp    80104f01 <alltraps>
...
801053c6:	6a 00                	push   $0x0
  pushl $7
801053c8:	6a 07                	push   $0x7
  jmp alltraps
801053ca:	e9 32 fb ff ff       	jmp    80104f01 <alltraps>

801053cf <vector8>:
.globl vector8
vector8:
  pushl $8
801053cf:	6a 08                	push   $0x8
  jmp alltraps
801053d1:	e9 2b fb ff ff       	jmp    80104f01 <alltraps>
...
801053d6:	6a 00                	push   $0x0
  pushl $9
801053d8:	6a 09                	push   $0x9
  jmp alltraps
801053da:	e9 22 fb ff ff       	jmp    80104f01 <alltraps>

801053df <vector10>:
.globl vector10
vector10:
  pushl $10
801053df:	6a 0a                	push   $0xa
  jmp alltraps
801053e1:	e9 1b fb ff ff       	jmp    80104f01 <alltraps>

801053e6 <vector11>:
.globl vector11
vector11:
  pushl $11
801053e6:	6a 0b                	push   $0xb
  jmp alltraps
801053e8:	e9 14 fb ff ff       	jmp    80104f01 <alltraps>

801053ed <vector12>:
.globl vector12
vector12:
  pushl $12
801053ed:	6a 0c                	push   $0xc
  jmp alltraps
801053ef:	e9 0d fb ff ff       	jmp    80104f01 <alltraps>

801053f4 <vector13>:
.globl vector13
vector13:
  pushl $13
801053f4:	6a 0d                	push   $0xd
  jmp alltraps
801053f6:	e9 06 fb ff ff       	jmp    80104f01 <alltraps>

801053fb <vector14>:
.globl vector14
vector14:
  pushl $14
801053fb:	6a 0e                	push   $0xe
  jmp alltraps
801053fd:	e9 ff fa ff ff       	jmp    80104f01 <alltraps>
...
80105402:	6a 00                	push   $0x0
  pushl $15
80105404:	6a 0f                	push   $0xf
  jmp alltraps
80105406:	e9 f6 fa ff ff       	jmp    80104f01 <alltraps>
...
8010540d:	6a 10                	push   $0x10
  jmp alltraps
8010540f:	e9 ed fa ff ff       	jmp    80104f01 <alltraps>

80105414 <vector17>:
.globl vector17
vector17:
  pushl $17
80105414:	6a 11                	push   $0x11
  jmp alltraps
80105416:	e9 e6 fa ff ff       	jmp    80104f01 <alltraps>
...
8010541b:	6a 00                	push   $0x0
  pushl $18
8010541d:	6a 12                	push   $0x12
  jmp alltraps
8010541f:	e9 dd fa ff ff       	jmp    80104f01 <alltraps>
...
80105424:	6a 00                	push   $0x0
  pushl $19
80105426:	6a 13                	push   $0x13
  jmp alltraps
80105428:	e9 d4 fa ff ff       	jmp    80104f01 <alltraps>
...
8010542d:	6a 00                	push   $0x0
  pushl $20
8010542f:	6a 14                	push   $0x14
  jmp alltraps
80105431:	e9 cb fa ff ff       	jmp    80104f01 <alltraps>
...
80105436:	6a 00                	push   $0x0
  pushl $21
80105438:	6a 15                	push   $0x15
  jmp alltraps
8010543a:	e9 c2 fa ff ff       	jmp    80104f01 <alltraps>
...
8010543f:	6a 00                	push   $0x0
  pushl $22
80105441:	6a 16                	push   $0x16
  jmp alltraps
80105443:	e9 b9 fa ff ff       	jmp    80104f01 <alltraps>
...
80105448:	6a 00                	push   $0x0
  pushl $23
8010544a:	6a 17                	push   $0x17
  jmp alltraps
8010544c:	e9 b0 fa ff ff       	jmp    80104f01 <alltraps>
...
80105451:	6a 00                	push   $0x0
  pushl $24
80105453:	6a 18                	push   $0x18
  jmp alltraps
80105455:	e9 a7 fa ff ff       	jmp    80104f01 <alltraps>
...
8010545a:	6a 00                	push   $0x0
  pushl $25
8010545c:	6a 19                	push   $0x19
  jmp alltraps
8010545e:	e9 9e fa ff ff       	jmp    80104f01 <alltraps>
...
80105463:	6a 00                	push   $0x0
  pushl $26
80105465:	6a 1a                	push   $0x1a
  jmp alltraps
80105467:	e9 95 fa ff ff       	jmp    80104f01 <alltraps>
...
8010546c:	6a 00                	push   $0x0
  pushl $27
8010546e:	6a 1b                	push   $0x1b
  jmp alltraps
80105470:	e9 8c fa ff ff       	jmp    80104f01 <alltraps>
...
80105475:	6a 00                	push   $0x0
  pushl $28
80105477:	6a 1c                	push   $0x1c
  jmp alltraps
80105479:	e9 83 fa ff ff       	jmp    80104f01 <alltraps>
...
8010547e:	6a 00                	push   $0x0
  pushl $29
80105480:	6a 1d                	push   $0x1d
  jmp alltraps
80105482:	e9 7a fa ff ff       	jmp    80104f01 <alltraps>
...
80105487:	6a 00                	push   $0x0
  pushl $30
80105489:	6a 1e                	push   $0x1e
  jmp alltraps
8010548b:	e9 71 fa ff ff       	jmp    80104f01 <alltraps>
...
80105490:	6a 00                	push   $0x0
  pushl $31
80105492:	6a 1f                	push   $0x1f
  jmp alltraps
80105494:	e9 68 fa ff ff       	jmp    80104f01 <alltraps>
...
80105499:	6a 00                	push   $0x0
  pushl $32
8010549b:	6a 20                	push   $0x20
  jmp alltraps
8010549d:	e9 5f fa ff ff       	jmp    80104f01 <alltraps>
...
801054a2:	6a 00                	push   $0x0
  pushl $33
801054a4:	6a 21                	push   $0x21
  jmp alltraps
801054a6:	e9 56 fa ff ff       	jmp    80104f01 <alltraps>
...
801054ab:	6a 00                	push   $0x0
  pushl $34
801054ad:	6a 22                	push   $0x22
  jmp alltraps
801054af:	e9 4d fa ff ff       	jmp    80104f01 <alltraps>
...
801054b4:	6a 00                	push   $0x0
  pushl $35
801054b6:	6a 23                	push   $0x23
  jmp alltraps
801054b8:	e9 44 fa ff ff       	jmp    80104f01 <alltraps>
...
801054bd:	6a 00                	push   $0x0
  pushl $36
801054bf:	6a 24                	push   $0x24
  jmp alltraps
801054c1:	e9 3b fa ff ff       	jmp    80104f01 <alltraps>
...
801054c6:	6a 00                	push   $0x0
  pushl $37
801054c8:	6a 25                	push   $0x25
  jmp alltraps
801054ca:	e9 32 fa ff ff       	jmp    80104f01 <alltraps>
...
801054cf:	6a 00                	push   $0x0
  pushl $38
801054d1:	6a 26                	push   $0x26
  jmp alltraps
801054d3:	e9 29 fa ff ff       	jmp    80104f01 <alltraps>
...
801054d8:	6a 00                	push   $0x0
  pushl $39
801054da:	6a 27                	push   $0x27
  jmp alltraps
801054dc:	e9 20 fa ff ff       	jmp    80104f01 <alltraps>
...
801054e1:	6a 00                	push   $0x0
  pushl $40
801054e3:	6a 28                	push   $0x28
  jmp alltraps
801054e5:	e9 17 fa ff ff       	jmp    80104f01 <alltraps>
...
801054ea:	6a 00                	push   $0x0
  pushl $41
801054ec:	6a 29                	push   $0x29
  jmp alltraps
801054ee:	e9 0e fa ff ff       	jmp    80104f01 <alltraps>
...
801054f3:	6a 00                	push   $0x0
  pushl $42
801054f5:	6a 2a                	push   $0x2a
  jmp alltraps
801054f7:	e9 05 fa ff ff       	jmp    80104f01 <alltraps>
...
801054fc:	6a 00                	push   $0x0
  pushl $43
801054fe:	6a 2b                	push   $0x2b
  jmp alltraps
80105500:	e9 fc f9 ff ff       	jmp    80104f01 <alltraps>
...
80105505:	6a 00                	push   $0x0
  pushl $44
80105507:	6a 2c                	push   $0x2c
  jmp alltraps
80105509:	e9 f3 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010550e:	6a 00                	push   $0x0
  pushl $45
80105510:	6a 2d                	push   $0x2d
  jmp alltraps
80105512:	e9 ea f9 ff ff       	jmp    80104f01 <alltraps>
...
80105517:	6a 00                	push   $0x0
  pushl $46
80105519:	6a 2e                	push   $0x2e
  jmp alltraps
8010551b:	e9 e1 f9 ff ff       	jmp    80104f01 <alltraps>
...
80105520:	6a 00                	push   $0x0
  pushl $47
80105522:	6a 2f                	push   $0x2f
  jmp alltraps
80105524:	e9 d8 f9 ff ff       	jmp    80104f01 <alltraps>
...
80105529:	6a 00                	push   $0x0
  pushl $48
8010552b:	6a 30                	push   $0x30
  jmp alltraps
8010552d:	e9 cf f9 ff ff       	jmp    80104f01 <alltraps>
...
80105532:	6a 00                	push   $0x0
  pushl $49
80105534:	6a 31                	push   $0x31
  jmp alltraps
80105536:	e9 c6 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010553b:	6a 00                	push   $0x0
  pushl $50
8010553d:	6a 32                	push   $0x32
  jmp alltraps
8010553f:	e9 bd f9 ff ff       	jmp    80104f01 <alltraps>
...
80105544:	6a 00                	push   $0x0
  pushl $51
80105546:	6a 33                	push   $0x33
  jmp alltraps
80105548:	e9 b4 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010554d:	6a 00                	push   $0x0
  pushl $52
8010554f:	6a 34                	push   $0x34
  jmp alltraps
80105551:	e9 ab f9 ff ff       	jmp    80104f01 <alltraps>
...
80105556:	6a 00                	push   $0x0
  pushl $53
80105558:	6a 35                	push   $0x35
  jmp alltraps
8010555a:	e9 a2 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010555f:	6a 00                	push   $0x0
  pushl $54
80105561:	6a 36                	push   $0x36
  jmp alltraps
80105563:	e9 99 f9 ff ff       	jmp    80104f01 <alltraps>
...
80105568:	6a 00                	push   $0x0
  pushl $55
8010556a:	6a 37                	push   $0x37
  jmp alltraps
8010556c:	e9 90 f9 ff ff       	jmp    80104f01 <alltraps>
...
80105571:	6a 00                	push   $0x0
  pushl $56
80105573:	6a 38                	push   $0x38
  jmp alltraps
80105575:	e9 87 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010557a:	6a 00                	push   $0x0
  pushl $57
8010557c:	6a 39                	push   $0x39
  jmp alltraps
8010557e:	e9 7e f9 ff ff       	jmp    80104f01 <alltraps>
...
80105583:	6a 00                	push   $0x0
  pushl $58
80105585:	6a 3a                	push   $0x3a
  jmp alltraps
80105587:	e9 75 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010558c:	6a 00                	push   $0x0
  pushl $59
8010558e:	6a 3b                	push   $0x3b
  jmp alltraps
80105590:	e9 6c f9 ff ff       	jmp    80104f01 <alltraps>
...
80105595:	6a 00                	push   $0x0
  pushl $60
80105597:	6a 3c                	push   $0x3c
  jmp alltraps
80105599:	e9 63 f9 ff ff       	jmp    80104f01 <alltraps>
...
8010559e:	6a 00                	push   $0x0
  pushl $61
801055a0:	6a 3d                	push   $0x3d
  jmp alltraps
801055a2:	e9 5a f9 ff ff       	jmp    80104f01 <alltraps>
...
801055a7:	6a 00                	push   $0x0
  pushl $62
801055a9:	6a 3e                	push   $0x3e
  jmp alltraps
801055ab:	e9 51 f9 ff ff       	jmp    80104f01 <alltraps>
...
801055b0:	6a 00                	push   $0x0
  pushl $63
801055b2:	6a 3f                	push   $0x3f
  jmp alltraps
801055b4:	e9 48 f9 ff ff       	jmp    80104f01 <alltraps>
...
801055b9:	6a 00                	push   $0x0
  pushl $64
801055bb:	6a 40                	push   $0x40
  jmp alltraps
801055bd:	e9 3f f9 ff ff       	jmp    80104f01 <alltraps>
...
801055c2:	6a 00                	push   $0x0
  pushl $65
801055c4:	6a 41                	push   $0x41
  jmp alltraps
801055c6:	e9 36 f9 ff ff       	jmp    80104f01 <alltraps>
...
801055cb:	6a 00                	push   $0x0
  pushl $66
801055cd:	6a 42                	push   $0x42
  jmp alltraps
801055cf:	e9 2d f9 ff ff       	jmp    80104f01 <alltraps>
...
801055d4:	6a 00                	push   $0x0
  pushl $67
801055d6:	6a 43                	push   $0x43
  jmp alltraps
801055d8:	e9 24 f9 ff ff       	jmp    80104f01 <alltraps>
...
801055dd:	6a 00                	push   $0x0
  pushl $68
801055df:	6a 44                	push   $0x44
  jmp alltraps
801055e1:	e9 1b f9 ff ff       	jmp    80104f01 <alltraps>
...
801055e6:	6a 00                	push   $0x0
  pushl $69
801055e8:	6a 45                	push   $0x45
  jmp alltraps
801055ea:	e9 12 f9 ff ff       	jmp    80104f01 <alltraps>
...
801055ef:	6a 00                	push   $0x0
  pushl $70
801055f1:	6a 46                	push   $0x46
  jmp alltraps
801055f3:	e9 09 f9 ff ff       	jmp    80104f01 <alltraps>
...
801055f8:	6a 00                	push   $0x0
  pushl $71
801055fa:	6a 47                	push   $0x47
  jmp alltraps
801055fc:	e9 00 f9 ff ff       	jmp    80104f01 <alltraps>
...
80105601:	6a 00                	push   $0x0
  pushl $72
80105603:	6a 48                	push   $0x48
  jmp alltraps
80105605:	e9 f7 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010560a:	6a 00                	push   $0x0
  pushl $73
8010560c:	6a 49                	push   $0x49
  jmp alltraps
8010560e:	e9 ee f8 ff ff       	jmp    80104f01 <alltraps>
...
80105613:	6a 00                	push   $0x0
  pushl $74
80105615:	6a 4a                	push   $0x4a
  jmp alltraps
80105617:	e9 e5 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010561c:	6a 00                	push   $0x0
  pushl $75
8010561e:	6a 4b                	push   $0x4b
  jmp alltraps
80105620:	e9 dc f8 ff ff       	jmp    80104f01 <alltraps>
...
80105625:	6a 00                	push   $0x0
  pushl $76
80105627:	6a 4c                	push   $0x4c
  jmp alltraps
80105629:	e9 d3 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010562e:	6a 00                	push   $0x0
  pushl $77
80105630:	6a 4d                	push   $0x4d
  jmp alltraps
80105632:	e9 ca f8 ff ff       	jmp    80104f01 <alltraps>
...
80105637:	6a 00                	push   $0x0
  pushl $78
80105639:	6a 4e                	push   $0x4e
  jmp alltraps
8010563b:	e9 c1 f8 ff ff       	jmp    80104f01 <alltraps>
...
80105640:	6a 00                	push   $0x0
  pushl $79
80105642:	6a 4f                	push   $0x4f
  jmp alltraps
80105644:	e9 b8 f8 ff ff       	jmp    80104f01 <alltraps>
...
80105649:	6a 00                	push   $0x0
  pushl $80
8010564b:	6a 50                	push   $0x50
  jmp alltraps
8010564d:	e9 af f8 ff ff       	jmp    80104f01 <alltraps>
...
80105652:	6a 00                	push   $0x0
  pushl $81
80105654:	6a 51                	push   $0x51
  jmp alltraps
80105656:	e9 a6 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010565b:	6a 00                	push   $0x0
  pushl $82
8010565d:	6a 52                	push   $0x52
  jmp alltraps
8010565f:	e9 9d f8 ff ff       	jmp    80104f01 <alltraps>
...
80105664:	6a 00                	push   $0x0
  pushl $83
80105666:	6a 53                	push   $0x53
  jmp alltraps
80105668:	e9 94 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010566d:	6a 00                	push   $0x0
  pushl $84
8010566f:	6a 54                	push   $0x54
  jmp alltraps
80105671:	e9 8b f8 ff ff       	jmp    80104f01 <alltraps>
...
80105676:	6a 00                	push   $0x0
  pushl $85
80105678:	6a 55                	push   $0x55
  jmp alltraps
8010567a:	e9 82 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010567f:	6a 00                	push   $0x0
  pushl $86
80105681:	6a 56                	push   $0x56
  jmp alltraps
80105683:	e9 79 f8 ff ff       	jmp    80104f01 <alltraps>
...
80105688:	6a 00                	push   $0x0
  pushl $87
8010568a:	6a 57                	push   $0x57
  jmp alltraps
8010568c:	e9 70 f8 ff ff       	jmp    80104f01 <alltraps>
...
80105691:	6a 00                	push   $0x0
  pushl $88
80105693:	6a 58                	push   $0x58
  jmp alltraps
80105695:	e9 67 f8 ff ff       	jmp    80104f01 <alltraps>
...
8010569a:	6a 00                	push   $0x0
  pushl $89
8010569c:	6a 59                	push   $0x59
  jmp alltraps
8010569e:	e9 5e f8 ff ff       	jmp    80104f01 <alltraps>
...
801056a3:	6a 00                	push   $0x0
  pushl $90
801056a5:	6a 5a                	push   $0x5a
  jmp alltraps
801056a7:	e9 55 f8 ff ff       	jmp    80104f01 <alltraps>
...
801056ac:	6a 00                	push   $0x0
  pushl $91
801056ae:	6a 5b                	push   $0x5b
  jmp alltraps
801056b0:	e9 4c f8 ff ff       	jmp    80104f01 <alltraps>
...
801056b5:	6a 00                	push   $0x0
  pushl $92
801056b7:	6a 5c                	push   $0x5c
  jmp alltraps
801056b9:	e9 43 f8 ff ff       	jmp    80104f01 <alltraps>
...
801056be:	6a 00                	push   $0x0
  pushl $93
801056c0:	6a 5d                	push   $0x5d
  jmp alltraps
801056c2:	e9 3a f8 ff ff       	jmp    80104f01 <alltraps>
...
801056c7:	6a 00                	push   $0x0
  pushl $94
801056c9:	6a 5e                	push   $0x5e
  jmp alltraps
801056cb:	e9 31 f8 ff ff       	jmp    80104f01 <alltraps>
...
801056d0:	6a 00                	push   $0x0
  pushl $95
801056d2:	6a 5f                	push   $0x5f
  jmp alltraps
801056d4:	e9 28 f8 ff ff       	jmp    80104f01 <alltraps>
...
801056d9:	6a 00                	push   $0x0
  pushl $96
801056db:	6a 60                	push   $0x60
  jmp alltraps
801056dd:	e9 1f f8 ff ff       	jmp    80104f01 <alltraps>
...
801056e2:	6a 00                	push   $0x0
  pushl $97
801056e4:	6a 61                	push   $0x61
  jmp alltraps
801056e6:	e9 16 f8 ff ff       	jmp    80104f01 <alltraps>
...
801056eb:	6a 00                	push   $0x0
  pushl $98
801056ed:	6a 62                	push   $0x62
  jmp alltraps
801056ef:	e9 0d f8 ff ff       	jmp    80104f01 <alltraps>
...
801056f4:	6a 00                	push   $0x0
  pushl $99
801056f6:	6a 63                	push   $0x63
  jmp alltraps
801056f8:	e9 04 f8 ff ff       	jmp    80104f01 <alltraps>
...
801056fd:	6a 00                	push   $0x0
  pushl $100
801056ff:	6a 64                	push   $0x64
  jmp alltraps
80105701:	e9 fb f7 ff ff       	jmp    80104f01 <alltraps>
...
80105706:	6a 00                	push   $0x0
  pushl $101
80105708:	6a 65                	push   $0x65
  jmp alltraps
8010570a:	e9 f2 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010570f:	6a 00                	push   $0x0
  pushl $102
80105711:	6a 66                	push   $0x66
  jmp alltraps
80105713:	e9 e9 f7 ff ff       	jmp    80104f01 <alltraps>
...
80105718:	6a 00                	push   $0x0
  pushl $103
8010571a:	6a 67                	push   $0x67
  jmp alltraps
8010571c:	e9 e0 f7 ff ff       	jmp    80104f01 <alltraps>
...
80105721:	6a 00                	push   $0x0
  pushl $104
80105723:	6a 68                	push   $0x68
  jmp alltraps
80105725:	e9 d7 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010572a:	6a 00                	push   $0x0
  pushl $105
8010572c:	6a 69                	push   $0x69
  jmp alltraps
8010572e:	e9 ce f7 ff ff       	jmp    80104f01 <alltraps>
...
80105733:	6a 00                	push   $0x0
  pushl $106
80105735:	6a 6a                	push   $0x6a
  jmp alltraps
80105737:	e9 c5 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010573c:	6a 00                	push   $0x0
  pushl $107
8010573e:	6a 6b                	push   $0x6b
  jmp alltraps
80105740:	e9 bc f7 ff ff       	jmp    80104f01 <alltraps>
...
80105745:	6a 00                	push   $0x0
  pushl $108
80105747:	6a 6c                	push   $0x6c
  jmp alltraps
80105749:	e9 b3 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010574e:	6a 00                	push   $0x0
  pushl $109
80105750:	6a 6d                	push   $0x6d
  jmp alltraps
80105752:	e9 aa f7 ff ff       	jmp    80104f01 <alltraps>
...
80105757:	6a 00                	push   $0x0
  pushl $110
80105759:	6a 6e                	push   $0x6e
  jmp alltraps
8010575b:	e9 a1 f7 ff ff       	jmp    80104f01 <alltraps>
...
80105760:	6a 00                	push   $0x0
  pushl $111
80105762:	6a 6f                	push   $0x6f
  jmp alltraps
80105764:	e9 98 f7 ff ff       	jmp    80104f01 <alltraps>
...
80105769:	6a 00                	push   $0x0
  pushl $112
8010576b:	6a 70                	push   $0x70
  jmp alltraps
8010576d:	e9 8f f7 ff ff       	jmp    80104f01 <alltraps>
...
80105772:	6a 00                	push   $0x0
  pushl $113
80105774:	6a 71                	push   $0x71
  jmp alltraps
80105776:	e9 86 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010577b:	6a 00                	push   $0x0
  pushl $114
8010577d:	6a 72                	push   $0x72
  jmp alltraps
8010577f:	e9 7d f7 ff ff       	jmp    80104f01 <alltraps>
...
80105784:	6a 00                	push   $0x0
  pushl $115
80105786:	6a 73                	push   $0x73
  jmp alltraps
80105788:	e9 74 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010578d:	6a 00                	push   $0x0
  pushl $116
8010578f:	6a 74                	push   $0x74
  jmp alltraps
80105791:	e9 6b f7 ff ff       	jmp    80104f01 <alltraps>
...
80105796:	6a 00                	push   $0x0
  pushl $117
80105798:	6a 75                	push   $0x75
  jmp alltraps
8010579a:	e9 62 f7 ff ff       	jmp    80104f01 <alltraps>
...
8010579f:	6a 00                	push   $0x0
  pushl $118
801057a1:	6a 76                	push   $0x76
  jmp alltraps
801057a3:	e9 59 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057a8:	6a 00                	push   $0x0
  pushl $119
801057aa:	6a 77                	push   $0x77
  jmp alltraps
801057ac:	e9 50 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057b1:	6a 00                	push   $0x0
  pushl $120
801057b3:	6a 78                	push   $0x78
  jmp alltraps
801057b5:	e9 47 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057ba:	6a 00                	push   $0x0
  pushl $121
801057bc:	6a 79                	push   $0x79
  jmp alltraps
801057be:	e9 3e f7 ff ff       	jmp    80104f01 <alltraps>
...
801057c3:	6a 00                	push   $0x0
  pushl $122
801057c5:	6a 7a                	push   $0x7a
  jmp alltraps
801057c7:	e9 35 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057cc:	6a 00                	push   $0x0
  pushl $123
801057ce:	6a 7b                	push   $0x7b
  jmp alltraps
801057d0:	e9 2c f7 ff ff       	jmp    80104f01 <alltraps>
...
801057d5:	6a 00                	push   $0x0
  pushl $124
801057d7:	6a 7c                	push   $0x7c
  jmp alltraps
801057d9:	e9 23 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057de:	6a 00                	push   $0x0
  pushl $125
801057e0:	6a 7d                	push   $0x7d
  jmp alltraps
801057e2:	e9 1a f7 ff ff       	jmp    80104f01 <alltraps>
...
801057e7:	6a 00                	push   $0x0
  pushl $126
801057e9:	6a 7e                	push   $0x7e
  jmp alltraps
801057eb:	e9 11 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057f0:	6a 00                	push   $0x0
  pushl $127
801057f2:	6a 7f                	push   $0x7f
  jmp alltraps
801057f4:	e9 08 f7 ff ff       	jmp    80104f01 <alltraps>
...
801057f9:	6a 00                	push   $0x0
  pushl $128
801057fb:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105800:	e9 fc f6 ff ff       	jmp    80104f01 <alltraps>
...
80105805:	6a 00                	push   $0x0
  pushl $129
80105807:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010580c:	e9 f0 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105811:	6a 00                	push   $0x0
  pushl $130
80105813:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105818:	e9 e4 f6 ff ff       	jmp    80104f01 <alltraps>
...
8010581d:	6a 00                	push   $0x0
  pushl $131
8010581f:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105824:	e9 d8 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105829:	6a 00                	push   $0x0
  pushl $132
8010582b:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105830:	e9 cc f6 ff ff       	jmp    80104f01 <alltraps>
...
80105835:	6a 00                	push   $0x0
  pushl $133
80105837:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010583c:	e9 c0 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105841:	6a 00                	push   $0x0
  pushl $134
80105843:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105848:	e9 b4 f6 ff ff       	jmp    80104f01 <alltraps>
...
8010584d:	6a 00                	push   $0x0
  pushl $135
8010584f:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105854:	e9 a8 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105859:	6a 00                	push   $0x0
  pushl $136
8010585b:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105860:	e9 9c f6 ff ff       	jmp    80104f01 <alltraps>
...
80105865:	6a 00                	push   $0x0
  pushl $137
80105867:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010586c:	e9 90 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105871:	6a 00                	push   $0x0
  pushl $138
80105873:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105878:	e9 84 f6 ff ff       	jmp    80104f01 <alltraps>
...
8010587d:	6a 00                	push   $0x0
  pushl $139
8010587f:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105884:	e9 78 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105889:	6a 00                	push   $0x0
  pushl $140
8010588b:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105890:	e9 6c f6 ff ff       	jmp    80104f01 <alltraps>
...
80105895:	6a 00                	push   $0x0
  pushl $141
80105897:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010589c:	e9 60 f6 ff ff       	jmp    80104f01 <alltraps>
...
801058a1:	6a 00                	push   $0x0
  pushl $142
801058a3:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801058a8:	e9 54 f6 ff ff       	jmp    80104f01 <alltraps>
...
801058ad:	6a 00                	push   $0x0
  pushl $143
801058af:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801058b4:	e9 48 f6 ff ff       	jmp    80104f01 <alltraps>
...
801058b9:	6a 00                	push   $0x0
  pushl $144
801058bb:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801058c0:	e9 3c f6 ff ff       	jmp    80104f01 <alltraps>
...
801058c5:	6a 00                	push   $0x0
  pushl $145
801058c7:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801058cc:	e9 30 f6 ff ff       	jmp    80104f01 <alltraps>
...
801058d1:	6a 00                	push   $0x0
  pushl $146
801058d3:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801058d8:	e9 24 f6 ff ff       	jmp    80104f01 <alltraps>
...
801058dd:	6a 00                	push   $0x0
  pushl $147
801058df:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801058e4:	e9 18 f6 ff ff       	jmp    80104f01 <alltraps>
...
801058e9:	6a 00                	push   $0x0
  pushl $148
801058eb:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801058f0:	e9 0c f6 ff ff       	jmp    80104f01 <alltraps>
...
801058f5:	6a 00                	push   $0x0
  pushl $149
801058f7:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801058fc:	e9 00 f6 ff ff       	jmp    80104f01 <alltraps>
...
80105901:	6a 00                	push   $0x0
  pushl $150
80105903:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105908:	e9 f4 f5 ff ff       	jmp    80104f01 <alltraps>
...
8010590d:	6a 00                	push   $0x0
  pushl $151
8010590f:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105914:	e9 e8 f5 ff ff       	jmp    80104f01 <alltraps>
...
80105919:	6a 00                	push   $0x0
  pushl $152
8010591b:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105920:	e9 dc f5 ff ff       	jmp    80104f01 <alltraps>
...
80105925:	6a 00                	push   $0x0
  pushl $153
80105927:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010592c:	e9 d0 f5 ff ff       	jmp    80104f01 <alltraps>
...
80105931:	6a 00                	push   $0x0
  pushl $154
80105933:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105938:	e9 c4 f5 ff ff       	jmp    80104f01 <alltraps>
...
8010593d:	6a 00                	push   $0x0
  pushl $155
8010593f:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105944:	e9 b8 f5 ff ff       	jmp    80104f01 <alltraps>
...
80105949:	6a 00                	push   $0x0
  pushl $156
8010594b:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105950:	e9 ac f5 ff ff       	jmp    80104f01 <alltraps>
...
80105955:	6a 00                	push   $0x0
  pushl $157
80105957:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010595c:	e9 a0 f5 ff ff       	jmp    80104f01 <alltraps>
...
80105961:	6a 00                	push   $0x0
  pushl $158
80105963:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105968:	e9 94 f5 ff ff       	jmp    80104f01 <alltraps>
...
8010596d:	6a 00                	push   $0x0
  pushl $159
8010596f:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105974:	e9 88 f5 ff ff       	jmp    80104f01 <alltraps>
...
80105979:	6a 00                	push   $0x0
  pushl $160
8010597b:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105980:	e9 7c f5 ff ff       	jmp    80104f01 <alltraps>
...
80105985:	6a 00                	push   $0x0
  pushl $161
80105987:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010598c:	e9 70 f5 ff ff       	jmp    80104f01 <alltraps>
...
80105991:	6a 00                	push   $0x0
  pushl $162
80105993:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105998:	e9 64 f5 ff ff       	jmp    80104f01 <alltraps>
...
8010599d:	6a 00                	push   $0x0
  pushl $163
8010599f:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801059a4:	e9 58 f5 ff ff       	jmp    80104f01 <alltraps>
...
801059a9:	6a 00                	push   $0x0
  pushl $164
801059ab:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801059b0:	e9 4c f5 ff ff       	jmp    80104f01 <alltraps>
...
801059b5:	6a 00                	push   $0x0
  pushl $165
801059b7:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801059bc:	e9 40 f5 ff ff       	jmp    80104f01 <alltraps>
...
801059c1:	6a 00                	push   $0x0
  pushl $166
801059c3:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801059c8:	e9 34 f5 ff ff       	jmp    80104f01 <alltraps>
...
801059cd:	6a 00                	push   $0x0
  pushl $167
801059cf:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801059d4:	e9 28 f5 ff ff       	jmp    80104f01 <alltraps>
...
801059d9:	6a 00                	push   $0x0
  pushl $168
801059db:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801059e0:	e9 1c f5 ff ff       	jmp    80104f01 <alltraps>
...
801059e5:	6a 00                	push   $0x0
  pushl $169
801059e7:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801059ec:	e9 10 f5 ff ff       	jmp    80104f01 <alltraps>
...
801059f1:	6a 00                	push   $0x0
  pushl $170
801059f3:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801059f8:	e9 04 f5 ff ff       	jmp    80104f01 <alltraps>
...
801059fd:	6a 00                	push   $0x0
  pushl $171
801059ff:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105a04:	e9 f8 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a09:	6a 00                	push   $0x0
  pushl $172
80105a0b:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105a10:	e9 ec f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a15:	6a 00                	push   $0x0
  pushl $173
80105a17:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105a1c:	e9 e0 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a21:	6a 00                	push   $0x0
  pushl $174
80105a23:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80105a28:	e9 d4 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a2d:	6a 00                	push   $0x0
  pushl $175
80105a2f:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105a34:	e9 c8 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a39:	6a 00                	push   $0x0
  pushl $176
80105a3b:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105a40:	e9 bc f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a45:	6a 00                	push   $0x0
  pushl $177
80105a47:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105a4c:	e9 b0 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a51:	6a 00                	push   $0x0
  pushl $178
80105a53:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105a58:	e9 a4 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a5d:	6a 00                	push   $0x0
  pushl $179
80105a5f:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105a64:	e9 98 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a69:	6a 00                	push   $0x0
  pushl $180
80105a6b:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105a70:	e9 8c f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a75:	6a 00                	push   $0x0
  pushl $181
80105a77:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105a7c:	e9 80 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a81:	6a 00                	push   $0x0
  pushl $182
80105a83:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105a88:	e9 74 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a8d:	6a 00                	push   $0x0
  pushl $183
80105a8f:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105a94:	e9 68 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105a99:	6a 00                	push   $0x0
  pushl $184
80105a9b:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105aa0:	e9 5c f4 ff ff       	jmp    80104f01 <alltraps>
...
80105aa5:	6a 00                	push   $0x0
  pushl $185
80105aa7:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105aac:	e9 50 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105ab1:	6a 00                	push   $0x0
  pushl $186
80105ab3:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105ab8:	e9 44 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105abd:	6a 00                	push   $0x0
  pushl $187
80105abf:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105ac4:	e9 38 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105ac9:	6a 00                	push   $0x0
  pushl $188
80105acb:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105ad0:	e9 2c f4 ff ff       	jmp    80104f01 <alltraps>
...
80105ad5:	6a 00                	push   $0x0
  pushl $189
80105ad7:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105adc:	e9 20 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105ae1:	6a 00                	push   $0x0
  pushl $190
80105ae3:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105ae8:	e9 14 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105aed:	6a 00                	push   $0x0
  pushl $191
80105aef:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105af4:	e9 08 f4 ff ff       	jmp    80104f01 <alltraps>
...
80105af9:	6a 00                	push   $0x0
  pushl $192
80105afb:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105b00:	e9 fc f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b05:	6a 00                	push   $0x0
  pushl $193
80105b07:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105b0c:	e9 f0 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b11:	6a 00                	push   $0x0
  pushl $194
80105b13:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105b18:	e9 e4 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b1d:	6a 00                	push   $0x0
  pushl $195
80105b1f:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105b24:	e9 d8 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b29:	6a 00                	push   $0x0
  pushl $196
80105b2b:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105b30:	e9 cc f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b35:	6a 00                	push   $0x0
  pushl $197
80105b37:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105b3c:	e9 c0 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b41:	6a 00                	push   $0x0
  pushl $198
80105b43:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105b48:	e9 b4 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b4d:	6a 00                	push   $0x0
  pushl $199
80105b4f:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105b54:	e9 a8 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b59:	6a 00                	push   $0x0
  pushl $200
80105b5b:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105b60:	e9 9c f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b65:	6a 00                	push   $0x0
  pushl $201
80105b67:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105b6c:	e9 90 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b71:	6a 00                	push   $0x0
  pushl $202
80105b73:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105b78:	e9 84 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b7d:	6a 00                	push   $0x0
  pushl $203
80105b7f:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105b84:	e9 78 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b89:	6a 00                	push   $0x0
  pushl $204
80105b8b:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105b90:	e9 6c f3 ff ff       	jmp    80104f01 <alltraps>
...
80105b95:	6a 00                	push   $0x0
  pushl $205
80105b97:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105b9c:	e9 60 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105ba1:	6a 00                	push   $0x0
  pushl $206
80105ba3:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105ba8:	e9 54 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105bad:	6a 00                	push   $0x0
  pushl $207
80105baf:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105bb4:	e9 48 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105bb9:	6a 00                	push   $0x0
  pushl $208
80105bbb:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105bc0:	e9 3c f3 ff ff       	jmp    80104f01 <alltraps>
...
80105bc5:	6a 00                	push   $0x0
  pushl $209
80105bc7:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105bcc:	e9 30 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105bd1:	6a 00                	push   $0x0
  pushl $210
80105bd3:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105bd8:	e9 24 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105bdd:	6a 00                	push   $0x0
  pushl $211
80105bdf:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105be4:	e9 18 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105be9:	6a 00                	push   $0x0
  pushl $212
80105beb:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105bf0:	e9 0c f3 ff ff       	jmp    80104f01 <alltraps>
...
80105bf5:	6a 00                	push   $0x0
  pushl $213
80105bf7:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105bfc:	e9 00 f3 ff ff       	jmp    80104f01 <alltraps>
...
80105c01:	6a 00                	push   $0x0
  pushl $214
80105c03:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105c08:	e9 f4 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c0d:	6a 00                	push   $0x0
  pushl $215
80105c0f:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105c14:	e9 e8 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c19:	6a 00                	push   $0x0
  pushl $216
80105c1b:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105c20:	e9 dc f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c25:	6a 00                	push   $0x0
  pushl $217
80105c27:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105c2c:	e9 d0 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c31:	6a 00                	push   $0x0
  pushl $218
80105c33:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105c38:	e9 c4 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c3d:	6a 00                	push   $0x0
  pushl $219
80105c3f:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105c44:	e9 b8 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c49:	6a 00                	push   $0x0
  pushl $220
80105c4b:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105c50:	e9 ac f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c55:	6a 00                	push   $0x0
  pushl $221
80105c57:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105c5c:	e9 a0 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c61:	6a 00                	push   $0x0
  pushl $222
80105c63:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105c68:	e9 94 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c6d:	6a 00                	push   $0x0
  pushl $223
80105c6f:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105c74:	e9 88 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c79:	6a 00                	push   $0x0
  pushl $224
80105c7b:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105c80:	e9 7c f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c85:	6a 00                	push   $0x0
  pushl $225
80105c87:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105c8c:	e9 70 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c91:	6a 00                	push   $0x0
  pushl $226
80105c93:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105c98:	e9 64 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105c9d:	6a 00                	push   $0x0
  pushl $227
80105c9f:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105ca4:	e9 58 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105ca9:	6a 00                	push   $0x0
  pushl $228
80105cab:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105cb0:	e9 4c f2 ff ff       	jmp    80104f01 <alltraps>
...
80105cb5:	6a 00                	push   $0x0
  pushl $229
80105cb7:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105cbc:	e9 40 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105cc1:	6a 00                	push   $0x0
  pushl $230
80105cc3:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105cc8:	e9 34 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105ccd:	6a 00                	push   $0x0
  pushl $231
80105ccf:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105cd4:	e9 28 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105cd9:	6a 00                	push   $0x0
  pushl $232
80105cdb:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105ce0:	e9 1c f2 ff ff       	jmp    80104f01 <alltraps>
...
80105ce5:	6a 00                	push   $0x0
  pushl $233
80105ce7:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105cec:	e9 10 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105cf1:	6a 00                	push   $0x0
  pushl $234
80105cf3:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105cf8:	e9 04 f2 ff ff       	jmp    80104f01 <alltraps>
...
80105cfd:	6a 00                	push   $0x0
  pushl $235
80105cff:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105d04:	e9 f8 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d09:	6a 00                	push   $0x0
  pushl $236
80105d0b:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105d10:	e9 ec f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d15:	6a 00                	push   $0x0
  pushl $237
80105d17:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105d1c:	e9 e0 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d21:	6a 00                	push   $0x0
  pushl $238
80105d23:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105d28:	e9 d4 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d2d:	6a 00                	push   $0x0
  pushl $239
80105d2f:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105d34:	e9 c8 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d39:	6a 00                	push   $0x0
  pushl $240
80105d3b:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105d40:	e9 bc f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d45:	6a 00                	push   $0x0
  pushl $241
80105d47:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105d4c:	e9 b0 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d51:	6a 00                	push   $0x0
  pushl $242
80105d53:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105d58:	e9 a4 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d5d:	6a 00                	push   $0x0
  pushl $243
80105d5f:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105d64:	e9 98 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d69:	6a 00                	push   $0x0
  pushl $244
80105d6b:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105d70:	e9 8c f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d75:	6a 00                	push   $0x0
  pushl $245
80105d77:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105d7c:	e9 80 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d81:	6a 00                	push   $0x0
  pushl $246
80105d83:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105d88:	e9 74 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d8d:	6a 00                	push   $0x0
  pushl $247
80105d8f:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105d94:	e9 68 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105d99:	6a 00                	push   $0x0
  pushl $248
80105d9b:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105da0:	e9 5c f1 ff ff       	jmp    80104f01 <alltraps>
...
80105da5:	6a 00                	push   $0x0
  pushl $249
80105da7:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105dac:	e9 50 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105db1:	6a 00                	push   $0x0
  pushl $250
80105db3:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105db8:	e9 44 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105dbd:	6a 00                	push   $0x0
  pushl $251
80105dbf:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105dc4:	e9 38 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105dc9:	6a 00                	push   $0x0
  pushl $252
80105dcb:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105dd0:	e9 2c f1 ff ff       	jmp    80104f01 <alltraps>
...
80105dd5:	6a 00                	push   $0x0
  pushl $253
80105dd7:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105ddc:	e9 20 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105de1:	6a 00                	push   $0x0
  pushl $254
80105de3:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105de8:	e9 14 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105ded:	6a 00                	push   $0x0
  pushl $255
80105def:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105df4:	e9 08 f1 ff ff       	jmp    80104f01 <alltraps>
...
80105e02:	89 d3                	mov    %edx,%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105e04:	c1 ea 16             	shr    $0x16,%edx
80105e07:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105e0a:	8b 37                	mov    (%edi),%esi
80105e0c:	f7 c6 01 00 00 00    	test   $0x1,%esi
80105e12:	74 20                	je     80105e34 <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105e14:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105e1a:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
80105e20:	c1 eb 0c             	shr    $0xc,%ebx
80105e23:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
80105e29:	8d 04 9e             	lea    (%esi,%ebx,4),%eax
}
...
80105e36:	74 2b                	je     80105e63 <walkpgdir+0x6a>
80105e38:	e8 66 c2 ff ff       	call   801020a3 <kalloc>
80105e3d:	89 c6                	mov    %eax,%esi
80105e3f:	85 c0                	test   %eax,%eax
80105e41:	74 20                	je     80105e63 <walkpgdir+0x6a>
    memset(pgtab, 0, PGSIZE);
80105e43:	83 ec 04             	sub    $0x4,%esp
80105e46:	68 00 10 00 00       	push   $0x1000
80105e4b:	6a 00                	push   $0x0
80105e4d:	50                   	push   %eax
80105e4e:	e8 fa df ff ff       	call   80103e4d <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105e53:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80105e59:	83 c8 07             	or     $0x7,%eax
80105e5c:	89 07                	mov    %eax,(%edi)
80105e5e:	83 c4 10             	add    $0x10,%esp
80105e61:	eb bd                	jmp    80105e20 <walkpgdir+0x27>
      return 0;
80105e63:	b8 00 00 00 00       	mov    $0x0,%eax
80105e68:	eb c2                	jmp    80105e2c <walkpgdir+0x33>
...
80105e6d:	57                   	push   %edi
80105e6e:	56                   	push   %esi
80105e6f:	53                   	push   %ebx
80105e70:	83 ec 1c             	sub    $0x1c,%esp
80105e73:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105e76:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105e79:	89 d3                	mov    %edx,%ebx
80105e7b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105e81:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105e85:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105e8b:	b9 01 00 00 00       	mov    $0x1,%ecx
80105e90:	89 da                	mov    %ebx,%edx
80105e92:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e95:	e8 5f ff ff ff       	call   80105df9 <walkpgdir>
80105e9a:	85 c0                	test   %eax,%eax
80105e9c:	74 2e                	je     80105ecc <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105e9e:	f6 00 01             	testb  $0x1,(%eax)
80105ea1:	75 1c                	jne    80105ebf <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105ea3:	89 f2                	mov    %esi,%edx
80105ea5:	0b 55 0c             	or     0xc(%ebp),%edx
80105ea8:	83 ca 01             	or     $0x1,%edx
80105eab:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105ead:	39 fb                	cmp    %edi,%ebx
80105eaf:	74 28                	je     80105ed9 <mappages+0x6f>
      break;
    a += PGSIZE;
80105eb1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105eb7:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105ebd:	eb cc                	jmp    80105e8b <mappages+0x21>
      panic("remap");
80105ebf:	83 ec 0c             	sub    $0xc,%esp
80105ec2:	68 b8 70 10 80       	push   $0x801070b8
80105ec7:	e8 7c a4 ff ff       	call   80100348 <panic>
      return -1;
...
80105ede:	eb f1                	jmp    80105ed1 <mappages+0x67>
...
80105ee6:	83 ec 1c             	sub    $0x1c,%esp
  c = &cpus[cpuid()];
80105ee9:	e8 c7 d2 ff ff       	call   801031b5 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105eee:	69 f8 b0 00 00 00    	imul   $0xb0,%eax,%edi
80105ef4:	66 c7 87 18 18 11 80 	movw   $0xffff,-0x7feee7e8(%edi)
80105efb:	ff ff 
80105efd:	66 c7 87 1a 18 11 80 	movw   $0x0,-0x7feee7e6(%edi)
80105f04:	00 00 
80105f06:	c6 87 1c 18 11 80 00 	movb   $0x0,-0x7feee7e4(%edi)
80105f0d:	0f b6 8f 1d 18 11 80 	movzbl -0x7feee7e3(%edi),%ecx
80105f14:	83 e1 f0             	and    $0xfffffff0,%ecx
80105f17:	89 ce                	mov    %ecx,%esi
80105f19:	83 ce 0a             	or     $0xa,%esi
80105f1c:	89 f2                	mov    %esi,%edx
80105f1e:	88 97 1d 18 11 80    	mov    %dl,-0x7feee7e3(%edi)
80105f24:	83 c9 1a             	or     $0x1a,%ecx
80105f27:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105f2d:	83 e1 9f             	and    $0xffffff9f,%ecx
80105f30:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105f36:	83 c9 80             	or     $0xffffff80,%ecx
80105f39:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105f3f:	0f b6 8f 1e 18 11 80 	movzbl -0x7feee7e2(%edi),%ecx
80105f46:	83 c9 0f             	or     $0xf,%ecx
80105f49:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f4f:	89 ce                	mov    %ecx,%esi
80105f51:	83 e6 ef             	and    $0xffffffef,%esi
80105f54:	89 f2                	mov    %esi,%edx
80105f56:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105f5c:	83 e1 cf             	and    $0xffffffcf,%ecx
80105f5f:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f65:	89 ce                	mov    %ecx,%esi
80105f67:	83 ce 40             	or     $0x40,%esi
80105f6a:	89 f2                	mov    %esi,%edx
80105f6c:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105f72:	83 c9 c0             	or     $0xffffffc0,%ecx
80105f75:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f7b:	c6 87 1f 18 11 80 00 	movb   $0x0,-0x7feee7e1(%edi)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105f82:	66 c7 87 20 18 11 80 	movw   $0xffff,-0x7feee7e0(%edi)
80105f89:	ff ff 
80105f8b:	66 c7 87 22 18 11 80 	movw   $0x0,-0x7feee7de(%edi)
80105f92:	00 00 
80105f94:	c6 87 24 18 11 80 00 	movb   $0x0,-0x7feee7dc(%edi)
80105f9b:	0f b6 8f 25 18 11 80 	movzbl -0x7feee7db(%edi),%ecx
80105fa2:	83 e1 f0             	and    $0xfffffff0,%ecx
80105fa5:	89 ce                	mov    %ecx,%esi
80105fa7:	83 ce 02             	or     $0x2,%esi
80105faa:	89 f2                	mov    %esi,%edx
80105fac:	88 97 25 18 11 80    	mov    %dl,-0x7feee7db(%edi)
80105fb2:	83 c9 12             	or     $0x12,%ecx
80105fb5:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105fbb:	83 e1 9f             	and    $0xffffff9f,%ecx
80105fbe:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105fc4:	83 c9 80             	or     $0xffffff80,%ecx
80105fc7:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105fcd:	0f b6 8f 26 18 11 80 	movzbl -0x7feee7da(%edi),%ecx
80105fd4:	83 c9 0f             	or     $0xf,%ecx
80105fd7:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105fdd:	89 ce                	mov    %ecx,%esi
80105fdf:	83 e6 ef             	and    $0xffffffef,%esi
80105fe2:	89 f2                	mov    %esi,%edx
80105fe4:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80105fea:	83 e1 cf             	and    $0xffffffcf,%ecx
80105fed:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105ff3:	89 ce                	mov    %ecx,%esi
80105ff5:	83 ce 40             	or     $0x40,%esi
80105ff8:	89 f2                	mov    %esi,%edx
80105ffa:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80106000:	83 c9 c0             	or     $0xffffffc0,%ecx
80106003:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80106009:	c6 87 27 18 11 80 00 	movb   $0x0,-0x7feee7d9(%edi)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106010:	66 c7 87 28 18 11 80 	movw   $0xffff,-0x7feee7d8(%edi)
80106017:	ff ff 
80106019:	66 c7 87 2a 18 11 80 	movw   $0x0,-0x7feee7d6(%edi)
80106020:	00 00 
80106022:	c6 87 2c 18 11 80 00 	movb   $0x0,-0x7feee7d4(%edi)
80106029:	0f b6 9f 2d 18 11 80 	movzbl -0x7feee7d3(%edi),%ebx
80106030:	83 e3 f0             	and    $0xfffffff0,%ebx
80106033:	89 de                	mov    %ebx,%esi
80106035:	83 ce 0a             	or     $0xa,%esi
80106038:	89 f2                	mov    %esi,%edx
8010603a:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
80106040:	89 de                	mov    %ebx,%esi
80106042:	83 ce 1a             	or     $0x1a,%esi
80106045:	89 f2                	mov    %esi,%edx
80106047:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
8010604d:	83 cb 7a             	or     $0x7a,%ebx
80106050:	88 9f 2d 18 11 80    	mov    %bl,-0x7feee7d3(%edi)
80106056:	c6 87 2d 18 11 80 fa 	movb   $0xfa,-0x7feee7d3(%edi)
8010605d:	0f b6 9f 2e 18 11 80 	movzbl -0x7feee7d2(%edi),%ebx
80106064:	83 cb 0f             	or     $0xf,%ebx
80106067:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
8010606d:	89 de                	mov    %ebx,%esi
8010606f:	83 e6 ef             	and    $0xffffffef,%esi
80106072:	89 f2                	mov    %esi,%edx
80106074:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
8010607a:	83 e3 cf             	and    $0xffffffcf,%ebx
8010607d:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80106083:	89 de                	mov    %ebx,%esi
80106085:	83 ce 40             	or     $0x40,%esi
80106088:	89 f2                	mov    %esi,%edx
8010608a:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
80106090:	83 cb c0             	or     $0xffffffc0,%ebx
80106093:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80106099:	c6 87 2f 18 11 80 00 	movb   $0x0,-0x7feee7d1(%edi)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801060a0:	66 c7 87 30 18 11 80 	movw   $0xffff,-0x7feee7d0(%edi)
801060a7:	ff ff 
801060a9:	66 c7 87 32 18 11 80 	movw   $0x0,-0x7feee7ce(%edi)
801060b0:	00 00 
801060b2:	c6 87 34 18 11 80 00 	movb   $0x0,-0x7feee7cc(%edi)
801060b9:	0f b6 9f 35 18 11 80 	movzbl -0x7feee7cb(%edi),%ebx
801060c0:	83 e3 f0             	and    $0xfffffff0,%ebx
801060c3:	89 de                	mov    %ebx,%esi
801060c5:	83 ce 02             	or     $0x2,%esi
801060c8:	89 f2                	mov    %esi,%edx
801060ca:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
801060d0:	89 de                	mov    %ebx,%esi
801060d2:	83 ce 12             	or     $0x12,%esi
801060d5:	89 f2                	mov    %esi,%edx
801060d7:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
801060dd:	83 cb 72             	or     $0x72,%ebx
801060e0:	88 9f 35 18 11 80    	mov    %bl,-0x7feee7cb(%edi)
801060e6:	c6 87 35 18 11 80 f2 	movb   $0xf2,-0x7feee7cb(%edi)
801060ed:	0f b6 9f 36 18 11 80 	movzbl -0x7feee7ca(%edi),%ebx
801060f4:	83 cb 0f             	or     $0xf,%ebx
801060f7:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
801060fd:	89 de                	mov    %ebx,%esi
801060ff:	83 e6 ef             	and    $0xffffffef,%esi
80106102:	89 f2                	mov    %esi,%edx
80106104:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
8010610a:	83 e3 cf             	and    $0xffffffcf,%ebx
8010610d:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
80106113:	89 de                	mov    %ebx,%esi
80106115:	83 ce 40             	or     $0x40,%esi
80106118:	89 f2                	mov    %esi,%edx
8010611a:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
80106120:	83 cb c0             	or     $0xffffffc0,%ebx
80106123:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
80106129:	c6 87 37 18 11 80 00 	movb   $0x0,-0x7feee7c9(%edi)
  lgdt(c->gdt, sizeof(c->gdt));
80106130:	8d 97 10 18 11 80    	lea    -0x7feee7f0(%edi),%edx
  pd[0] = size-1;
80106136:	66 c7 45 e2 2f 00    	movw   $0x2f,-0x1e(%ebp)
  pd[1] = (uint)p;
8010613c:	66 89 55 e4          	mov    %dx,-0x1c(%ebp)
  pd[2] = (uint)p >> 16;
80106140:	c1 ea 10             	shr    $0x10,%edx
80106143:	66 89 55 e6          	mov    %dx,-0x1a(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106147:	8d 45 e2             	lea    -0x1e(%ebp),%eax
8010614a:	0f 01 10             	lgdtl  (%eax)
}
8010614d:	83 c4 1c             	add    $0x1c,%esp
80106150:	5b                   	pop    %ebx
80106151:	5e                   	pop    %esi
80106152:	5f                   	pop    %edi
80106153:	5d                   	pop    %ebp
...
80106155:	a1 c4 47 11 80       	mov    0x801147c4,%eax
...
80106169:	83 ec 1c             	sub    $0x1c,%esp
8010616c:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
8010616f:	85 f6                	test   %esi,%esi
80106171:	0f 84 25 01 00 00    	je     8010629c <switchuvm+0x139>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106177:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
8010617b:	0f 84 28 01 00 00    	je     801062a9 <switchuvm+0x146>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106181:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80106185:	0f 84 2b 01 00 00    	je     801062b6 <switchuvm+0x153>
    panic("switchuvm: no pgdir");

  pushcli();
8010618b:	e8 36 db ff ff       	call   80103cc6 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106190:	e8 c4 cf ff ff       	call   80103159 <mycpu>
80106195:	89 c3                	mov    %eax,%ebx
80106197:	e8 bd cf ff ff       	call   80103159 <mycpu>
8010619c:	8d 78 08             	lea    0x8(%eax),%edi
8010619f:	e8 b5 cf ff ff       	call   80103159 <mycpu>
801061a4:	83 c0 08             	add    $0x8,%eax
801061a7:	c1 e8 10             	shr    $0x10,%eax
801061aa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801061ad:	e8 a7 cf ff ff       	call   80103159 <mycpu>
801061b2:	83 c0 08             	add    $0x8,%eax
801061b5:	c1 e8 18             	shr    $0x18,%eax
801061b8:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
801061bf:	67 00 
801061c1:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
801061c8:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
801061cc:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801061d2:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
801061d9:	83 e2 f0             	and    $0xfffffff0,%edx
801061dc:	89 d1                	mov    %edx,%ecx
801061de:	83 c9 09             	or     $0x9,%ecx
801061e1:	88 8b 9d 00 00 00    	mov    %cl,0x9d(%ebx)
801061e7:	83 ca 19             	or     $0x19,%edx
801061ea:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
801061f0:	83 e2 9f             	and    $0xffffff9f,%edx
801061f3:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
801061f9:	83 ca 80             	or     $0xffffff80,%edx
801061fc:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80106202:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80106209:	89 d1                	mov    %edx,%ecx
8010620b:	83 e1 f0             	and    $0xfffffff0,%ecx
8010620e:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
80106214:	89 d1                	mov    %edx,%ecx
80106216:	83 e1 e0             	and    $0xffffffe0,%ecx
80106219:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
8010621f:	83 e2 c0             	and    $0xffffffc0,%edx
80106222:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106228:	83 ca 40             	or     $0x40,%edx
8010622b:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106231:	83 e2 7f             	and    $0x7f,%edx
80106234:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
8010623a:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106240:	e8 14 cf ff ff       	call   80103159 <mycpu>
...
8010628c:	0f 22 d8             	mov    %eax,%cr3
  popcli();
8010628f:	e8 6e da ff ff       	call   80103d02 <popcli>
}
...
801062d1:	77 4c                	ja     8010631f <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
801062d3:	e8 cb bd ff ff       	call   801020a3 <kalloc>
...
801062e5:	e8 63 db ff ff       	call   80103e4d <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801062ea:	83 c4 08             	add    $0x8,%esp
801062ed:	6a 06                	push   $0x6
801062ef:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
...
80106322:	68 fd 70 10 80       	push   $0x801070fd
...
8010632f:	57                   	push   %edi
80106330:	56                   	push   %esi
80106331:	53                   	push   %ebx
80106332:	83 ec 0c             	sub    $0xc,%esp
80106335:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106338:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010633b:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106341:	74 3c                	je     8010637f <loaduvm+0x53>
    panic("loaduvm: addr must be page aligned");
80106343:	83 ec 0c             	sub    $0xc,%esp
80106346:	68 b8 71 10 80       	push   $0x801071b8
8010634b:	e8 f8 9f ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106350:	83 ec 0c             	sub    $0xc,%esp
80106353:	68 17 71 10 80       	push   $0x80107117
...
80106365:	03 55 14             	add    0x14(%ebp),%edx
80106368:	52                   	push   %edx
80106369:	50                   	push   %eax
8010636a:	ff 75 10             	push   0x10(%ebp)
8010636d:	e8 ef b3 ff ff       	call   80101761 <readi>
80106372:	83 c4 10             	add    $0x10,%esp
80106375:	39 f0                	cmp    %esi,%eax
80106377:	75 47                	jne    801063c0 <loaduvm+0x94>
  for(i = 0; i < sz; i += PGSIZE){
80106379:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010637f:	39 fb                	cmp    %edi,%ebx
80106381:	73 30                	jae    801063b3 <loaduvm+0x87>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106383:	89 da                	mov    %ebx,%edx
80106385:	03 55 0c             	add    0xc(%ebp),%edx
80106388:	b9 00 00 00 00       	mov    $0x0,%ecx
8010638d:	8b 45 08             	mov    0x8(%ebp),%eax
80106390:	e8 64 fa ff ff       	call   80105df9 <walkpgdir>
80106395:	85 c0                	test   %eax,%eax
80106397:	74 b7                	je     80106350 <loaduvm+0x24>
    pa = PTE_ADDR(*pte);
80106399:	8b 00                	mov    (%eax),%eax
8010639b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801063a0:	89 fe                	mov    %edi,%esi
801063a2:	29 de                	sub    %ebx,%esi
801063a4:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801063aa:	76 b1                	jbe    8010635d <loaduvm+0x31>
      n = PGSIZE;
801063ac:	be 00 10 00 00       	mov    $0x1000,%esi
801063b1:	eb aa                	jmp    8010635d <loaduvm+0x31>
      return -1;
  }
  return 0;
801063b3:	b8 00 00 00 00       	mov    $0x0,%eax
}
801063b8:	8d 65 f4             	lea    -0xc(%ebp),%esp
801063bb:	5b                   	pop    %ebx
801063bc:	5e                   	pop    %esi
801063bd:	5f                   	pop    %edi
801063be:	5d                   	pop    %ebp
...
801063c5:	eb f1                	jmp    801063b8 <loaduvm+0x8c>
...
801063d0:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801063d3:	39 7d 10             	cmp    %edi,0x10(%ebp)
801063d6:	73 11                	jae    801063e9 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
801063d8:	8b 45 10             	mov    0x10(%ebp),%eax
801063db:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801063e1:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801063e7:	eb 19                	jmp    80106402 <deallocuvm+0x3b>
    return oldsz;
801063e9:	89 f8                	mov    %edi,%eax
801063eb:	eb 64                	jmp    80106451 <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801063ed:	c1 eb 16             	shr    $0x16,%ebx
801063f0:	83 c3 01             	add    $0x1,%ebx
801063f3:	c1 e3 16             	shl    $0x16,%ebx
801063f6:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801063fc:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106402:	39 fb                	cmp    %edi,%ebx
80106404:	73 48                	jae    8010644e <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106406:	b9 00 00 00 00       	mov    $0x0,%ecx
8010640b:	89 da                	mov    %ebx,%edx
8010640d:	8b 45 08             	mov    0x8(%ebp),%eax
80106410:	e8 e4 f9 ff ff       	call   80105df9 <walkpgdir>
80106415:	89 c6                	mov    %eax,%esi
    if(!pte)
80106417:	85 c0                	test   %eax,%eax
80106419:	74 d2                	je     801063ed <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
8010641b:	8b 00                	mov    (%eax),%eax
8010641d:	a8 01                	test   $0x1,%al
8010641f:	74 db                	je     801063fc <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106421:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106426:	74 19                	je     80106441 <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
...
80106431:	e8 56 bb ff ff       	call   80101f8c <kfree>
      *pte = 0;
80106436:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010643c:	83 c4 10             	add    $0x10,%esp
8010643f:	eb bb                	jmp    801063fc <deallocuvm+0x35>
        panic("kfree");
80106441:	83 ec 0c             	sub    $0xc,%esp
80106444:	68 66 6a 10 80       	push   $0x80106a66
80106449:	e8 fa 9e ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
8010644e:	8b 45 10             	mov    0x10(%ebp),%eax
}
...
8010645f:	83 ec 1c             	sub    $0x1c,%esp
80106462:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
80106465:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106468:	85 ff                	test   %edi,%edi
8010646a:	0f 88 c1 00 00 00    	js     80106531 <allocuvm+0xd8>
  if(newsz < oldsz)
80106470:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106473:	72 5c                	jb     801064d1 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
80106475:	8b 45 0c             	mov    0xc(%ebp),%eax
80106478:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
8010647e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106484:	39 fe                	cmp    %edi,%esi
80106486:	0f 83 ac 00 00 00    	jae    80106538 <allocuvm+0xdf>
    mem = kalloc();
8010648c:	e8 12 bc ff ff       	call   801020a3 <kalloc>
80106491:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106493:	85 c0                	test   %eax,%eax
80106495:	74 42                	je     801064d9 <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
80106497:	83 ec 04             	sub    $0x4,%esp
8010649a:	68 00 10 00 00       	push   $0x1000
8010649f:	6a 00                	push   $0x0
801064a1:	50                   	push   %eax
801064a2:	e8 a6 d9 ff ff       	call   80103e4d <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801064a7:	83 c4 08             	add    $0x8,%esp
801064aa:	6a 06                	push   $0x6
801064ac:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801064b2:	50                   	push   %eax
801064b3:	b9 00 10 00 00       	mov    $0x1000,%ecx
801064b8:	89 f2                	mov    %esi,%edx
801064ba:	8b 45 08             	mov    0x8(%ebp),%eax
801064bd:	e8 a8 f9 ff ff       	call   80105e6a <mappages>
801064c2:	83 c4 10             	add    $0x10,%esp
801064c5:	85 c0                	test   %eax,%eax
801064c7:	78 38                	js     80106501 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
801064c9:	81 c6 00 10 00 00    	add    $0x1000,%esi
801064cf:	eb b3                	jmp    80106484 <allocuvm+0x2b>
    return oldsz;
801064d1:	8b 45 0c             	mov    0xc(%ebp),%eax
801064d4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801064d7:	eb 5f                	jmp    80106538 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
801064d9:	83 ec 0c             	sub    $0xc,%esp
801064dc:	68 35 71 10 80       	push   $0x80107135
801064e1:	e8 21 a1 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801064e6:	83 c4 0c             	add    $0xc,%esp
801064e9:	ff 75 0c             	push   0xc(%ebp)
801064ec:	57                   	push   %edi
801064ed:	ff 75 08             	push   0x8(%ebp)
801064f0:	e8 d2 fe ff ff       	call   801063c7 <deallocuvm>
      return 0;
801064f5:	83 c4 10             	add    $0x10,%esp
801064f8:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801064ff:	eb 37                	jmp    80106538 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
80106501:	83 ec 0c             	sub    $0xc,%esp
80106504:	68 4d 71 10 80       	push   $0x8010714d
80106509:	e8 f9 a0 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010650e:	83 c4 0c             	add    $0xc,%esp
80106511:	ff 75 0c             	push   0xc(%ebp)
80106514:	57                   	push   %edi
80106515:	ff 75 08             	push   0x8(%ebp)
80106518:	e8 aa fe ff ff       	call   801063c7 <deallocuvm>
      kfree(mem);
8010651d:	89 1c 24             	mov    %ebx,(%esp)
80106520:	e8 67 ba ff ff       	call   80101f8c <kfree>
      return 0;
80106525:	83 c4 10             	add    $0x10,%esp
80106528:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010652f:	eb 07                	jmp    80106538 <allocuvm+0xdf>
    return 0;
80106531:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
8010655a:	e8 68 fe ff ff       	call   801063c7 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010655f:	83 c4 10             	add    $0x10,%esp
80106562:	bb 00 00 00 00       	mov    $0x0,%ebx
80106567:	eb 10                	jmp    80106579 <freevm+0x36>
    panic("freevm: no pgdir");
80106569:	83 ec 0c             	sub    $0xc,%esp
8010656c:	68 69 71 10 80       	push   $0x80107169
80106571:	e8 d2 9d ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
80106576:	83 c3 01             	add    $0x1,%ebx
80106579:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
8010657f:	77 1f                	ja     801065a0 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
80106581:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106584:	a8 01                	test   $0x1,%al
80106586:	74 ee                	je     80106576 <freevm+0x33>
...
80106596:	e8 f1 b9 ff ff       	call   80101f8c <kfree>
8010659b:	83 c4 10             	add    $0x10,%esp
8010659e:	eb d6                	jmp    80106576 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
801065ac:	8d 65 f8             	lea    -0x8(%ebp),%esp
801065af:	5b                   	pop    %ebx
801065b0:	5e                   	pop    %esi
801065b1:	5d                   	pop    %ebp
801065b2:	c3                   	ret    
...
801065b7:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
801065b8:	e8 e6 ba ff ff       	call   801020a3 <kalloc>
801065bd:	89 c6                	mov    %eax,%esi
801065bf:	85 c0                	test   %eax,%eax
801065c1:	74 55                	je     80106618 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
801065c3:	83 ec 04             	sub    $0x4,%esp
801065c6:	68 00 10 00 00       	push   $0x1000
801065cb:	6a 00                	push   $0x0
801065cd:	50                   	push   %eax
801065ce:	e8 7a d8 ff ff       	call   80103e4d <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801065d3:	83 c4 10             	add    $0x10,%esp
801065d6:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
801065db:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
801065e1:	73 35                	jae    80106618 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
801065e3:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801065e6:	8b 4b 08             	mov    0x8(%ebx),%ecx
801065e9:	29 c1                	sub    %eax,%ecx
801065eb:	83 ec 08             	sub    $0x8,%esp
801065ee:	ff 73 0c             	push   0xc(%ebx)
801065f1:	50                   	push   %eax
801065f2:	8b 13                	mov    (%ebx),%edx
801065f4:	89 f0                	mov    %esi,%eax
801065f6:	e8 6f f8 ff ff       	call   80105e6a <mappages>
801065fb:	83 c4 10             	add    $0x10,%esp
801065fe:	85 c0                	test   %eax,%eax
80106600:	78 05                	js     80106607 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106602:	83 c3 10             	add    $0x10,%ebx
80106605:	eb d4                	jmp    801065db <setupkvm+0x28>
      freevm(pgdir);
80106607:	83 ec 0c             	sub    $0xc,%esp
8010660a:	56                   	push   %esi
8010660b:	e8 33 ff ff ff       	call   80106543 <freevm>
      return 0;
80106610:	83 c4 10             	add    $0x10,%esp
80106613:	be 00 00 00 00       	mov    $0x0,%esi
}
80106618:	89 f0                	mov    %esi,%eax
8010661a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010661d:	5b                   	pop    %ebx
8010661e:	5e                   	pop    %esi
8010661f:	5d                   	pop    %ebp
80106620:	c3                   	ret    
...
80106624:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106627:	e8 87 ff ff ff       	call   801065b3 <setupkvm>
8010662c:	a3 c4 47 11 80       	mov    %eax,0x801147c4
  switchkvm();
80106631:	e8 1f fb ff ff       	call   80106155 <switchkvm>
}
80106636:	c9                   	leave  
80106637:	c3                   	ret    
...
80106649:	e8 ab f7 ff ff       	call   80105df9 <walkpgdir>
  if(pte == 0)
8010664e:	85 c0                	test   %eax,%eax
80106650:	74 05                	je     80106657 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106652:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106655:	c9                   	leave  
80106656:	c3                   	ret    
    panic("clearpteu");
80106657:	83 ec 0c             	sub    $0xc,%esp
8010665a:	68 7a 71 10 80       	push   $0x8010717a
...
8010666a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010666d:	e8 41 ff ff ff       	call   801065b3 <setupkvm>
80106672:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106675:	85 c0                	test   %eax,%eax
80106677:	0f 84 c4 00 00 00    	je     80106741 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010667d:	bf 00 00 00 00       	mov    $0x0,%edi
80106682:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106685:	0f 83 b6 00 00 00    	jae    80106741 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010668b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010668e:	b9 00 00 00 00       	mov    $0x0,%ecx
80106693:	89 fa                	mov    %edi,%edx
80106695:	8b 45 08             	mov    0x8(%ebp),%eax
80106698:	e8 5c f7 ff ff       	call   80105df9 <walkpgdir>
8010669d:	85 c0                	test   %eax,%eax
8010669f:	74 65                	je     80106706 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801066a1:	8b 00                	mov    (%eax),%eax
801066a3:	a8 01                	test   $0x1,%al
801066a5:	74 6c                	je     80106713 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801066a7:	89 c6                	mov    %eax,%esi
801066a9:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
801066af:	25 ff 0f 00 00       	and    $0xfff,%eax
801066b4:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
801066b7:	e8 e7 b9 ff ff       	call   801020a3 <kalloc>
801066bc:	89 c3                	mov    %eax,%ebx
801066be:	85 c0                	test   %eax,%eax
801066c0:	74 6a                	je     8010672c <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801066c2:	81 c6 00 00 00 80    	add    $0x80000000,%esi
801066c8:	83 ec 04             	sub    $0x4,%esp
801066cb:	68 00 10 00 00       	push   $0x1000
801066d0:	56                   	push   %esi
801066d1:	50                   	push   %eax
801066d2:	e8 ee d7 ff ff       	call   80103ec5 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801066d7:	83 c4 08             	add    $0x8,%esp
801066da:	ff 75 e0             	push   -0x20(%ebp)
801066dd:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801066e3:	50                   	push   %eax
801066e4:	b9 00 10 00 00       	mov    $0x1000,%ecx
801066e9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801066ec:	8b 45 dc             	mov    -0x24(%ebp),%eax
801066ef:	e8 76 f7 ff ff       	call   80105e6a <mappages>
801066f4:	83 c4 10             	add    $0x10,%esp
801066f7:	85 c0                	test   %eax,%eax
801066f9:	78 25                	js     80106720 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
801066fb:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106701:	e9 7c ff ff ff       	jmp    80106682 <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
80106706:	83 ec 0c             	sub    $0xc,%esp
80106709:	68 84 71 10 80       	push   $0x80107184
8010670e:	e8 35 9c ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
80106713:	83 ec 0c             	sub    $0xc,%esp
80106716:	68 9e 71 10 80       	push   $0x8010719e
8010671b:	e8 28 9c ff ff       	call   80100348 <panic>
      kfree(mem);
80106720:	83 ec 0c             	sub    $0xc,%esp
80106723:	53                   	push   %ebx
80106724:	e8 63 b8 ff ff       	call   80101f8c <kfree>
      goto bad;
...
8010672f:	ff 75 dc             	push   -0x24(%ebp)
80106732:	e8 0c fe ff ff       	call   80106543 <freevm>
  return 0;
80106737:	83 c4 10             	add    $0x10,%esp
8010673a:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
80106741:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
8010674f:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80106752:	b9 00 00 00 00       	mov    $0x0,%ecx
80106757:	8b 55 0c             	mov    0xc(%ebp),%edx
8010675a:	8b 45 08             	mov    0x8(%ebp),%eax
8010675d:	e8 97 f6 ff ff       	call   80105df9 <walkpgdir>
  if((*pte & PTE_P) == 0)
80106762:	8b 00                	mov    (%eax),%eax
80106764:	a8 01                	test   $0x1,%al
80106766:	74 10                	je     80106778 <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
80106768:	a8 04                	test   $0x4,%al
8010676a:	74 13                	je     8010677f <uva2ka+0x33>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
8010676c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106771:	05 00 00 00 80       	add    $0x80000000,%eax
}
80106776:	c9                   	leave  
80106777:	c3                   	ret    
    return 0;
80106778:	b8 00 00 00 00       	mov    $0x0,%eax
8010677d:	eb f7                	jmp    80106776 <uva2ka+0x2a>
    return 0;
8010677f:	b8 00 00 00 00       	mov    $0x0,%eax
80106784:	eb f0                	jmp    80106776 <uva2ka+0x2a>
...
8010678f:	8b 7d 14             	mov    0x14(%ebp),%edi
  ...
  buf = (char*)p;
  while(len > 0){
80106792:	eb 25                	jmp    801067b9 <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106794:	8b 55 0c             	mov    0xc(%ebp),%edx
80106797:	29 f2                	sub    %esi,%edx
80106799:	01 d0                	add    %edx,%eax
8010679b:	83 ec 04             	sub    $0x4,%esp
8010679e:	53                   	push   %ebx
8010679f:	ff 75 10             	push   0x10(%ebp)
801067a2:	50                   	push   %eax
801067a3:	e8 1d d7 ff ff       	call   80103ec5 <memmove>
    len -= n;
801067a8:	29 df                	sub    %ebx,%edi
    buf += n;
801067aa:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
801067ad:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
801067b3:	89 45 0c             	mov    %eax,0xc(%ebp)
801067b6:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
801067b9:	85 ff                	test   %edi,%edi
801067bb:	74 2f                	je     801067ec <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
801067bd:	8b 75 0c             	mov    0xc(%ebp),%esi
801067c0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801067c6:	83 ec 08             	sub    $0x8,%esp
801067c9:	56                   	push   %esi
801067ca:	ff 75 08             	push   0x8(%ebp)
801067cd:	e8 7a ff ff ff       	call   8010674c <uva2ka>
    if(pa0 == 0)
801067d2:	83 c4 10             	add    $0x10,%esp
801067d5:	85 c0                	test   %eax,%eax
801067d7:	74 20                	je     801067f9 <copyout+0x73>
    n = PGSIZE - (va - va0);
801067d9:	89 f3                	mov    %esi,%ebx
801067db:	2b 5d 0c             	sub    0xc(%ebp),%ebx
801067de:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801067e4:	39 df                	cmp    %ebx,%edi
801067e6:	73 ac                	jae    80106794 <copyout+0xe>
      n = len;
801067e8:	89 fb                	mov    %edi,%ebx
801067ea:	eb a8                	jmp    80106794 <copyout+0xe>
  }
  return 0;
...
801067fe:	eb f1                	jmp    801067f1 <copyout+0x6b>
