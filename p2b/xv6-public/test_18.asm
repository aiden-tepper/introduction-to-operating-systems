...
main(void){
  ...
  17:	e8 2f 03 00 00       	call   34b <sbrk>
  ...
  21:	89 c3                	mov    %eax,%ebx
    mprotect(ptr, PAGES_NUM);
  23:	e8 4b 03 00 00       	call   373 <mprotect>

    if (fork() == 0) {
  28:	e8 8e 02 00 00       	call   2bb <fork>
  2d:	83 c4 10             	add    $0x10,%esp
  30:	85 c0                	test   %eax,%eax
  32:	75 24                	jne    58 <main+0x58>
  ...
  36:	6a 05                	push   $0x5
  38:	53                   	push   %ebx
  39:	e8 3d 03 00 00       	call   37b <munprotect>
        ptr[4 * PGSIZE] = 0xAA;
  3e:	c6 83 00 40 00 00 aa 	movb   $0xaa,0x4000(%ebx)
  ...
  53:	e8 6b 02 00 00       	call   2c3 <exit>
        ...
        wait();
  58:	e8 6e 02 00 00       	call   2cb <wait>
    }
    exit();
...
00000440 <printf>:
 ...
 5c7:	90                   	nop
 5c8:	ba 83 07 00 00       	mov    $0x783,%edx
