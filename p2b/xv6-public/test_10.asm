...
main(int argc, char *argv[])
{
  ...
  11:	81 ec 20 05 00 00    	sub    $0x520,%esp
   ...
   int pid[NPROC];
   printf(1,"Spinning...\n");
  17:	68 68 08 00 00       	push   $0x868
  1c:	6a 01                	push   $0x1
  1e:	e8 1d 05 00 00       	call   540 <printf>
   while(i < PROC)
